...
C...Electroweak couplings
              EI=KCHG(IA,1)*SIGN(1,I)/3D0
              AI=SIGN(1D0,KCHG(IA,1)+0.5D0)*SIGN(1,I)
              VI=AI-4D0*EI*XWV
              EJ=KCHG(JA,1)*SIGN(1,J)/3D0
              AJ=SIGN(1D0,KCHG(JA,1)+0.5D0)*SIGN(1,J)
              VJ=AJ-4D0*EJ*XWV
              EPSIJ=SIGN(1,I*J)
...
C...f + g -> f + gamma (q + g -> q + gamma only)
          ...
          DO 210 I=MMINA,MMAXA
            IF(I.EQ.0.OR.ABS(I).GT.MSTP(58)) GOTO 210
            EI=KCHG(ABS(I),1)/3D0
            FACGQ=FGQ*EI**2
            DO 200 ISDE=1,2
...
C...f + gamma -> f + g (q + gamma -> q + g only)
          ...
          DO 230 I=MMINA,MMAXA
            IF(I.EQ.0.OR.ABS(I).GT.MSTP(58)) GOTO 230
            EI=KCHG(ABS(I),1)/3D0
            FACGQ=FGQ*EI**2
            DO 220 ISDE=1,2
...
C...f + gamma* -> f.
     ...
     &        Q2GA**0.57D0)
          ...
          DO 390 I=MMINA,MMAXA
            ...
            IF(ABS(I).LT.10.AND.ABS(I).GT.MSTP(58)) GOTO 390
            EI=KCHG(ABS(I),1)/3D0
            NCHN=NCHN+1
            ISIG(NCHN,ISDE)=I
            ISIG(NCHN,3-ISDE)=22
...
C...f + gamma*_(T,L) -> f + g (q + gamma*_(T,L) -> q + g only)
     ...
     &      ((SH2+UH2-2D0*PH*TH)/(-SH*UH)-2D0*PH*TH/(SH+PH)**2)
          ...
          DO 430 I=MMINA,MMAXA
            IF(I.EQ.0.OR.ABS(I).GT.MSTP(58)) GOTO 430
            EI=KCHG(ABS(I),1)/3D0
            FACGQ=FGQ*EI**2
            DO 420 ISDE=1,2
