...
C unvar      DIMENSION NMUL(20),SIGM(20),KSTR(500,2),VINTSV(80),
      DIMENSION NMUL(20),SIGM(20),VINTSV(80),
...
C...Safety check that valence present; pi0/gamma/K0S/K0L special cases.
            ...
            IF(KFIVAL(JS,1).EQ.0) THEN
              IF(KFBEAM.EQ.111.AND.ABS(IFL).LE.2) IVNOW=1
              IF(KFBEAM.EQ.22.AND.ABS(IFL).LE.5) IVNOW=1
