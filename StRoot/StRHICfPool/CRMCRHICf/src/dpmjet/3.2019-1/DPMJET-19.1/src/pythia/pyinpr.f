...
C...Set up for DIS * p.
        ELSEIF(MINT(122).EQ.4.AND.(ABS(MINT(11)).GT.100.OR.
     &  ABS(MINT(12)).GT.100)) THEN
          MINT(123)=8
...
C...Set up for direct * direct gamma (switch off leptons).
        ELSEIF(MINT(122).EQ.4) THEN
          ...
          DO 110 II=MDCY(22,2),MDCY(22,2)+MDCY(22,3)-1
            IF(ABS(KFDP(II,1)).GE.10) MDME(II,1)=MIN(0,MDME(II,1))
  110     CONTINUE
          IF(IPTL.EQ.1) CKIN(3)=PTMDIR
...
C...Flavour information for individual beams.
      DO 140 I=1,2
        ...
        IF(ABS(MINT(10+I)).GT.100) MINT(40+I)=2
        MINT(44+I)=MINT(40+I)
        IF(MSTP(11).GE.1.AND.(ABS(MINT(10+I)).EQ.11.OR.
     &  ABS(MINT(10+I)).EQ.13.OR.ABS(MINT(10+I)).EQ.15)) MINT(44+I)=3
  140 CONTINUE
...
C...Initialize Generic Processes
      ...
      IF(KCGEN.GT.0) THEN
        ...
        IF(IDCY.GT.0) THEN
          ...
          KFF2=KFDP(IDCY+1,2)
          KCF1=PYCOMP(KFF1)
C unvar           KCF2=PYCOMP(KFF2)
          JCOL1=ABS(KCHG(KCF1,2))
          IF(JCOL1.EQ.1) THEN
            KF1=KFF1
            KF2=KFF2
          ELSE
