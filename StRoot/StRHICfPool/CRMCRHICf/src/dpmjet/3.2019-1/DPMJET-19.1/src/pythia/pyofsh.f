...
C...Local arrays.
C unvar      DIMENSION KFD(2),MBW(2),PMD(2),PGD(2),PMG(2),PML(2),PMU(2),
C unvar     &PMH(2),ATL(2),ATU(2),ATH(2),RMG(2),INX1(100),XPT1(100),
C unvar     &FPT1(100),INX2(100),XPT2(100),FPT2(100),WDTP(0:400),
C unvar     &WDTE(0:400,0:5)
...
C      IF((KFMO.EQ.25.OR.KFMO.EQ.35.OR.KFMO.EQ.36).AND.MEQL.EQ.1.AND.
     ...
     &(KFD(1).EQ.23.OR.KFD(1).EQ.24)) MMED=4
      IF((KFMO.EQ.32.OR.ABS(KFMO).EQ.34).AND.(KFD(1).EQ.23.OR.
     &KFD(1).EQ.24).AND.(KFD(2).EQ.23.OR.KFD(2).EQ.24)) MMED=2
      IF((KFMO.EQ.32.OR.ABS(KFMO).EQ.34).AND.(KFD(2).EQ.25.OR.
