// $Id: StSsdStrip.cc,v 1.1 2006/10/16 16:43:29 bouchet Exp $
//
// $Log: StSsdStrip.cc,v $
...
StSsdStrip::StSsdStrip(Int_t rNStrip, Int_t rDigitSig, Float_t rSigma, Int_t rPedestal, Int_t *rIdMcHit) {
