...
class St_sls_Maker : public StMaker {
 ...
 public: 
   ...
   virtual const char *GetCVS() const
     {static const char cvs[]="Tag $Name:  $ $Id: St_sls_Maker.h,v 1.5 2003/09/10 19:47:33 perev Exp $ built "__DATE__" "__TIME__ ; return cvs;}

   ClassDef(St_sls_Maker,0)   //StAF chain virtual base class for Makers
};
#endif
