...
//=================================================
//=================================================
L2etowCalAlgo09::L2etowCalAlgo09(const char* name, L2EmcDb* db, L2EmcGeom *geoX, char* outDir, int resOff)  :  L2VirtualAlgo2009( name,  db,  outDir, false, true, resOff) { 
  ...
  */
  ...
  for(k=0;k<L2eventStream2009::mxToken;k++){
    L2EtowCalibData09 & etowCalibData=globL2eventStream2009.etow[k];  
...
/* ========================================
  ======================================== */
int 
L2etowCalAlgo09::initRunUser( int runNo, int *rc_ints, float *rc_floats) {
...
/* ========================================
  ======================================== */
void 
L2etowCalAlgo09::calibrateEtow(int token, int eemcIn, unsigned short *rawAdc){
  // Etow calibration is a special case, must have one exit  at the end

  computeStart();
  token&=L2eventStream2009::tokenMask; // only to protect against a bad token, Gerard's trick
 
  //...... now token is valid  ........
  L2EtowCalibData09 & etowCalibData=globL2eventStream2009.etow[token];  
  ...
  if(eemcIn && par_gainType>kGainZero) { // EVEVEVEVEVE
    ...
    for(rdo=0; rdo<EtowGeom::mxRdo; rdo++){
      ...
      if(nTower>=L2EtowCalibData09::mxListSize) break; // overflow protection
    ...
    if(nTower>=L2EtowCalibData09::mxListSize) mhN->fill(5); // was overflow 
  } // EVEVEVEVEVE
...
void
L2etowCalAlgo09::clear(int token){
...
/* ========================================
  ======================================== */
void 
L2etowCalAlgo09::computeUser(int token ){
  ...
  criticalError("L2etowCalAlgo09::computeUser has been called and should not have been.  Serious problem in L2");
...
/* ========================================
  ======================================== */
void 
L2etowCalAlgo09::print0(){ // full raw input  ADC array
  // empty
 }
