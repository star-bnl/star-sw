...
/***********************************************************
 * $Id: L2jetAlgo2009.cxx,v 1.1 2010/04/17 16:42:14 pibero Exp $
...
L2jetAlgo2009::L2jetAlgo2009(const char* name, L2EmcDb* db, char* outDir, int resOff, bool writeHighResult) 
  :  L2VirtualAlgo2009( name,  db,  outDir, true, true, resOff) { 
  /* called one per days
...
rdtscl_macro(mEveTimeStart);
  ...
  //Ross says:  I will check how the following line is done in L2bemcGamma2009
  ...
  */
  ...
  //Ross says:  I've changed projectAdc to use the L2eventStream2009 class
...
//========================================
//========================================
float L2jetAlgo2009::true2Dscan(){
...
//========================================
//========================================
void L2jetAlgo2009::weightedEtaPhi(int iK){
  L2Jet *J=eve_Jet[iK];
