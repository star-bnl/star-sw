...
//=================================================
//=================================================
L2wBemc2009::L2wBemc2009(const char* name, L2EmcDb* db, L2EmcGeom *geoX, char* outDir, int resOff)  :  L2VirtualAlgo2009( name,  db, outDir, true, false, resOff) { 
  /* called one per day
...
/* ========================================
  ======================================== */
int 
L2wBemc2009::initRunUser( int runNo, int *rc_ints, float *rc_floats) {
...
/* ========================================
  ======================================== */
float
L2wBemc2009::sumET(int phi, int eta) {
...
/* ========================================
  ======================================== */
void 
L2wBemc2009::computeUser(int token){
  ...
  // preapre output list
  L2wBemcEvent2009 *btowEve=mBtow+token;
  ...
  float clustET=0;
  btowEve->isFresh=L2wBemcEvent2009::kDataFresh;
...
/* ========================================
  ======================================== */
bool 
L2wBemc2009::decisionUser(int token, int *myL2Result){
  ...
  if(btowEve->isFresh>L2wBemcEvent2009::kDataFresh) mhN->fill(6); // stale data, should never happen
  ...
  memcpy(myL2Result,&(btowEve->resultBlob),sizeof(L2wResult2009));
  if(par_dbg) L2wResult2009_print((L2wResult2009 *)&(btowEve->resultBlob));
...
/* ========================================
  ======================================== */
void
L2wBemc2009::finishRunUser() {  /* called once at the end of the run */
...
//=======================================
void 
L2wBemc2009::clearEvent(int token){
  memset(wrkBtow_et,0,sizeof(wrkBtow_et)); 
  wrkBtow_tower_seed_size=0; 
  memset(&(mBtow[token].resultBlob),0, sizeof(L2wResult2009));
}
  
/* ========================================
  ======================================== */
void 
L2wBemc2009::print2(){ // full , local ADC array
  int i;
...
/* ========================================
  ======================================== */
void 
L2wBemc2009::print4(int token, int hitSize){ // L2-algo input list
  int i;
