...
/*********************************************************************
 * $Id: L2eemcGamma2009.cxx,v 1.1 2011/03/09 16:29:07 pibero Exp $
...
//=================================================
//=================================================
void L2eemcGamma2009::quickSort(int array[], int start, int end)
{
...
void L2eemcGamma2009::swap(int array[], int index1, int index2) 
...
//=================================================
//=================================================
L2eemcGamma2009::L2eemcGamma2009(const char* name, L2EmcDb* db, L2EmcGeom *geoX, char* outDir, int resOff)  :  L2VirtualAlgo2009( name,  db, outDir,  false,true, resOff) { 
  /* called one per days
  ...
  */
  ...
  if (sizeof(L2gammaResult2009)!= L2gammaResult2009::mySizeChar) 
    ...
    criticalError("L2eemcGamma has failed consistency check. sizeof(L2gammaResult2009)!= L2gammaResult2009::mySizeChar");
...
/* ========================================
  ======================================== */
int 
L2eemcGamma2009::initRunUser( int runNo, int *rc_ints, float *rc_floats) {
...
/* ========================================
  ======================================== */
int
L2eemcGamma2009::countNonZeroTow(int phi, int eta) {
...
/* ========================================
  ======================================== */
void
L2eemcGamma2009::flagUsed(int phi, int eta) {
  int tow = EtowGeom::mxEtaBin *((phi+EtowGeom::mxPhiBin)%EtowGeom::mxPhiBin) + ((eta+EtowGeom::mxEtaBin)%EtowGeom::mxEtaBin); // phi- changes faster
  const int maxTowers = EtowGeom::mxEtaBin * EtowGeom::mxPhiBin;
  int towPlusOne;
  etow_used[tow] = 1;
...
/* ========================================
  ======================================== */
void
L2eemcGamma2009::averageEtaPhi(int phi, int eta, float *avePhi, float *aveEta) {
  int tow = EtowGeom::mxEtaBin *((phi+EtowGeom::mxPhiBin)%EtowGeom::mxPhiBin) + ((eta+EtowGeom::mxEtaBin)%EtowGeom::mxEtaBin); // phi- changes faster
  const int maxTowers = EtowGeom::mxEtaBin * EtowGeom::mxPhiBin;
  int towPlusOne;
  float ETsum;
...
/* ========================================
  ======================================== */
float
L2eemcGamma2009::sumET(int phi, int eta) {
  int tow = EtowGeom::mxEtaBin *((phi+EtowGeom::mxPhiBin)%EtowGeom::mxPhiBin) + ((eta+EtowGeom::mxEtaBin)%EtowGeom::mxEtaBin); // phi- changes faster
...
/* ========================================
  ======================================== */
void 
L2eemcGamma2009::computeUser(int token){
  ...
  */
  ...
  L2eemcGammaEvent2009 *etowEve=mEtow+token;
  ...
  for(i=hitSize-1;i >= 0; i--) {
    ...
    if(etowEve->size>=L2eemcGammaEvent2009::mxClust) continue; // overflow protection
...
/* ========================================
  ======================================== */
bool 
L2eemcGamma2009::decisionUser(int token, int *myL2Result){
  ...
  if(etowEve->size>= L2eemcGammaEvent2009::mxClust) mhN->fill(5);  // was overflow
  if(etowEve->isFresh>L2eemcGammaEvent2009::kDataFresh) mhN->fill(6); // stale data
  ...
  if(maxClusterEt>par_eventEtThres) {
    ...
    */
    ...
    if(etowEve->size>= L2eemcGammaEvent2009::mxClust) mhN->fill(15);
    mhN->fill(15); 
  memcpy(myL2Result,&(etowEve->resultBlob),sizeof(L2gammaResult2009));
    return true;
  }
...
/* ========================================
  ======================================== */
void
L2eemcGamma2009::finishRunUser() {  /* called once at the end of the run */
...
//=======================================
void 
L2eemcGamma2009::clearEvent(int token){
  ...
  mEtow[token].isFresh=L2eemcGammaEvent2009::kDataFresh;
// do not set 'fresh-flag here, only after compute() finishes
  memset(&(mEtow[token].resultBlob),0, sizeof(L2gammaResult2009));
}
  
/* ========================================
  ======================================== */
void 
L2eemcGamma2009::print2(){ // full , local ADC array
  int i;
...
/* ========================================
  ======================================== */
void 
L2eemcGamma2009::print3(){ // seed list
  int i;
...
/* ========================================
  ======================================== */
void 
L2eemcGamma2009::print4(int token, int hitSize){ // L2-algo input list
  int i;
