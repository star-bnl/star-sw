...
/**********************************************************
 * $Id: L2pedAlgo09.cxx,v 1.1 2010/04/17 17:14:37 pibero Exp $
...
#include "L2pedResults2009.h"

//=================================================
//=================================================
L2pedAlgo09::L2pedAlgo09(const char* name, L2EmcDb* db, char* outDir, int resOff) 
  ...
  */
  ...
  if (sizeof(L2pedResults2009)!= L2pedResults2009::mySizeChar) 
    criticalError("L2pedAlgo09 has failed consistency check. sizeof(L2pedAlgo09)!= L2pedResults2009::mySizeChar");
  //j1  printf("L2pedAlgo09 instantiated, logPath='%s'\n",mOutDir);
...
/*========================================
  ======================================== */
int
L2pedAlgo09::initRunUser(int runNo, int *rc_ints, float *rc_floats) {
  //myName is not used.
  // update DB if run # has changed
  //printf("aaa L2pedAlgo09::initRun runNo=%d\n",runNo);
...
L2pedAlgo09::doPedestals(int inpEveId, int* L2Result, 
  ...
  L2pedResults2009 out; // all output bits lump together
  ...
  memcpy(outPlace,&out,sizeof( L2pedResults2009));

  if(par_dbg) L2pedResults2009_print(&out);
...
/* ========================================
  ======================================== */
void 
L2pedAlgo09::computeUser(int token ){
  ...
  criticalError("L2pedAlgo09::computeUser has been called and should not have been.  Serious problem in L2");
...
/*========================================
  ======================================== */
void 
L2pedAlgo09::finishRunUser() {/* called once at the end of the run */
