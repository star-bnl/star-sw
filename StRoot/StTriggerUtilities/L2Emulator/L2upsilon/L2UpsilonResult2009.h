...
#ifndef L2_BEMC_UPSILON_RESULT_2009_H
#define L2_BEMC_UPSILON_RESULT_2009_H

struct L2UpsilonResult2009 {
//	enum {mySizeChar=24};
	enum {mySizeChar=8};
...
//...................................
inline void 
L2UpsilonResult2009_print(L2UpsilonResult2009 *p){
  if(p==0) {printf("print L2UpsilonResult2009 - NULL pointer ????\n"); return;}
  printf("print L2UpsilonResult2009: L0SeedTowerID=%d, L0SeedTowerID=%d,  energyOfL0Cluster=%f, energyOfL2Cluster=%f, invMass=%f  \n", 
  p->L0SeedTowerID,
  p->L2SeedTowerID,
