...
// $Id: St_GeantHitsPoints.h,v 1.1 2000/03/09 16:22:16 fine Exp $

#ifndef STAR_St_GeantHitsPoints
#define STAR_St_GeantHitsPoints
// ***********************************************************************
...
class St_GeantHitsPoints : public TPoints3DABC
{
  protected:
    ...
    St_GeantHitsPoints();
  public:
    St_GeantHitsPoints(St_TableSorter *sorter,const void *key,Option_t *opt="");
    St_GeantHitsPoints(St_TableSorter *sorter, Int_t keyIndex,Option_t *opt="");
   ~St_GeantHitsPoints(){}
    ...
    ClassDef(St_GeantHitsPoints,0)  // Defines the St_Table as an element of "event" geometry
};

//____________________________________________________________________________
inline void St_GeantHitsPoints::SetTablePointer(void *table){ m_Rows = table;}

//____________________________________________________________________________
// return the index of the origial row by its index from the sorted table
   inline Int_t St_GeantHitsPoints::Indx(Int_t sortedIndx) const
     {return m_TableSorter?m_TableSorter->GetIndex(m_FirstRow+sortedIndx):-1;}
//____________________________________________________________________________
// return the pointer to the original table object
  inline void *St_GeantHitsPoints::GetTable(){
    if (m_TableSorter) {
...
//____________________________________________________________________________
  inline Int_t St_GeantHitsPoints::Size() const { return m_Size;}
//____________________________________________________________________________
  inline Int_t St_GeantHitsPoints::GetLastPosition() const {return Size()-1;}

//____________________________________________________________________________
  inline Int_t St_GeantHitsPoints::SetLastPosition(Int_t idx)
  { 
...
//____________________________________________________________________________
// $Log: St_GeantHitsPoints.h,v $
// Revision 1.1  2000/03/09 16:22:16  fine
