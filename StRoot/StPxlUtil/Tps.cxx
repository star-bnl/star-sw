...
/***************************************************************************
 *
 * $Id: Tps.cxx,v 1.4 2014/01/23 01:05:06 qiuh Exp $
 *
 * Author: Qiu Hao, March 2013
 ***************************************************************************
 *
...
Tps::Tps(Int_t nMeasurements, Double_t* X, Double_t* Y, Double_t* W, Double_t* A)
{
...
Tps::Tps(Int_t nMeasurements, Float_t* X, Float_t* Y, Float_t* W, Float_t* A)
{
    mX = new TMatrixT<double>(nMeasurements, 1);
    mY = new TMatrixT<double>(nMeasurements, 1);
    mW = new TMatrixT<double>(nMeasurements, 1);
...
void Tps::fit(Int_t nMeasurements, Double_t* xMeasurement, Double_t* yMeasurement, Double_t* zMeasurement, Double_t lambda)
{
...
Double_t Tps::ur(Double_t r2)
{
  if(r2==0) return 0;
  return r2*log(r2);
}

Double_t Tps::z(Double_t x, Double_t y)
{
  double z_ = 0;
