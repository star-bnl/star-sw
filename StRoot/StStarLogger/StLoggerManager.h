...
// Generic Messages:
   virtual St_ostrstream& Message(const char* mess="", const char* type="",
         const char* opt=0,const char *sourceFileName=0, int lineNumber=-1);
   virtual       void Print();
//    virtual        int PrintList(messVec* list);
...
// Info Messages:
   virtual St_ostrstream& Info(const char* mess="", const char* opt="O"
...
// Warning Messages:
   virtual St_ostrstream& Warning(const char* mess="", const char* opt="E"
                             ,const char *sourceFileName=0, int lineNumber=-1);
...
// Error Messages:
   virtual St_ostrstream& Error(const char* mess="", const char* opt="E"
                           ,const char *sourceFileName=0, int lineNumber=-1);
...
// Debug Messages:
   virtual St_ostrstream& Debug(const char* mess="", const char* opt="OT"
                           ,const char *sourceFileName=0, int lineNumber=-1);
...
// QAInfo Messages:
   virtual St_ostrstream& QAInfo(const char* mess="", const char* opt="OS"
                            ,const char *sourceFileName=0, int lineNumber=-1);
...
// UCMInfo Messages:
   virtual St_ostrstream& UCMInfo(const char* mess="", const char* opt="OS"
                            ,const char *sourceFileName=0, int lineNumber=-1);
...
// "As is" Messages:
   virtual St_ostrstream& out(const char* mess="");
   virtual St_ostrstream& err(const char* mess="");

   virtual       void PrintInfo();

   // Fatal Messages:
   virtual St_ostrstream& Fatal(const char* mess="", const char* opt="F",const char *sourceFileName=0, int lineNumber=-1);
