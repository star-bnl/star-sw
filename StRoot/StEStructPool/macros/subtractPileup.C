void subtractPileup(const char *pileupCutFile, const char *noPileupCutFile, const char *subFile, double eff=0.75) {
    ...
    //
    // root.exe -q -b subtractPileup.C("cutFile","noCutFile","subFile")
    // 
