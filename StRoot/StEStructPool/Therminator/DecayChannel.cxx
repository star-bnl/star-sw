...
DecayChannel::DecayChannel() :
  mBranchRatio(0.0), mParticleType1(0), mParticleType2(0), mParticleType3(-1)
{
}
...
DecayChannel::DecayChannel(double aBranchRatio, int aPartType1, int aPartType2, int aPartType3) :
  mBranchRatio(aBranchRatio), mParticleType1(aPartType1), mParticleType2(aPartType2), mParticleType3(aPartType3)
{
}
