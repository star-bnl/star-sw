...
{
    double xd = (int) (Na->X - Nb->X), yd = (int) (Na->Y - Nb->Y);
...
{
    double xd = (int) (Na->X - Nb->X),
        yd = (int) (Na->Y - Nb->Y), zd = (int) (Na->Z - Nb->Z);
...
static double Meuss(double lat1, double lon1, double lat2, double lon2)
{
...
int Distance_GEO_MEEUS(Node * Na, Node * Nb)
{
    ...
    return (int) (Meuss(lat1, lon1, lat2, lon2) + 0.5);
}
...
int Distance_GEOM_MEEUS(Node * Na, Node * Nb)
{
    ...
    return (int) (1000 * Meuss(lat1, lon1, lat2, lon2) + 0.5);
}
