...
double* StEStructAutoFit::autofit8Par(double* best, TH2D* plot, int type) {
	...
	cout << "\nOut of 500 attempts, " << numConverge << " actually converged." << endl;
...
double* StEStructAutoFit::autofit11Par(double* best, TH2D* plot, int type) {
...
double* StEStructAutoFit::autofit11Parv3(double* best, TH2D* plot, int type) {
...
double* StEStructAutoFit::autofit9Par(double* best, TH2D* plot, int type) {
        // First set the error in the (0,0) bin high so it isn't part of the fit
        plot->SetBinError(13, 7, 1000.);
        plot->SetBinError(12, 7, 1000.);
        plot->SetBinError(11, 7, 1000.);
...
double* StEStructAutoFit::autofit12Par(double* best, TH2D* plot, int type) {
...
double* StEStructAutoFit::autofit11Par2G(double* best, TH2D* plot, int type, double yt) {
        // First set the error in the (0,0) bin high so it isn't part of the fit
        plot->SetBinError(13, 7, 1000.);
        plot->SetBinError(12, 7, 1000.);
        plot->SetBinError(11, 7, 1000.);
