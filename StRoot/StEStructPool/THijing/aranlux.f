...
*
*
* Revision 1.2  2001/12/18 02:02:55  nevski
* add entry to set counters
*
* Revision 1.1  2001/02/27 10:15:00  nevski
*  first working release
*
      SUBROUTINE a RANLUX (RVEC,LENV)
...
C                    Entry to output the "convenient" restart point
      ENTRY a RLUXAT(LOUT,INOUT,K1,K2)
      LOUT = LUXLEV
      INOUT = INSEED
      K1 = KOUNT
      K2 = MKOUNT
...
C       Now IN24 had better be between zero and 23 inclusive
     ...
     +     K1, K2, ' cannot occur at luxury level', LUXLEV
      ...
      ENDIF
      RETURN
*  entry to set seed counters for continuity :
      ENTRY a RLUXCN (k1,k2)
      KOUNT = K1
      MKOUNT = K2
      END
