...
public:
    ...
    void    init();
    void    initPmtOne();
    Float_t getFromPheToAdc() const
    {
        return mFromPheToAdc;
    }
    Float_t getMeanAdcPed()   const
    {
        return mMeanAdcPed;
    }
    Float_t getRmsAdcPed()    const
    {
        return mRmsAdcPed;
    }
    Int_t   getAdc(Int_t nphe, Int_t iver);

    void setFromPheToAdc(Float_t var)
    {
        mFromPheToAdc = var;
    }
    void setMeanAdcPed(Float_t var)
    {
        mMeanAdcPed   = var;
    }
    void setRmsAdcPed(Float_t var)
    {
        mRmsAdcPed    = var;
    }
