...
#define PrPP(A,B)
#endif
static const char rcsid[] = "$Id: StTpcRSMaker.cxx,v 1.72 2016/12/19 15:20:20 fisyak Exp $";
...
Int_t StTpcRSMaker::Make(){  //  PrintInfo();
  ...
  for (Int_t sector = 1; sector <= NoOfSectors; sector++) {
	...
	break;
      ...
      if (selectedRow > 0 && iRow != selectedRow) {sortedIndex++; continue;}
#endif
...
#undef PrPP
//________________________________________________________________________________
// $Id: StTpcRSMaker.cxx,v 1.72 2016/12/19 15:20:20 fisyak Exp $
// $Log: StTpcRSMaker.cxx,v $
// Revision 1.72  2016/12/19 15:20:20  fisyak
// Fix bug 3268: add missing correction for TpcAvgPowerSupply, add treatment for stopping electons and gammas
//
