...
class StEvent;  // just need forwarded class b/c only have pointers

class StEventQAMaker : public StMaker {
 private:
  Bool_t drawinit;


  //! static Char_t m_VersionCVS = "$Id: StEventQAMaker.h,v 1.1 1999/11/18 19:36:50 kathy Exp $";
...
// the following is a ROOT macro  that is needed in all ROOT code
  ...
  {static const char cvs[]="Tag $Name:  $ $Id: StEventQAMaker.h,v 1.1 1999/11/18 19:36:50 kathy Exp $ built "__DATE__" "__TIME__ ; return cvs;}

  ClassDef(StEventQAMaker, 1)   //StAF chain virtual base class for Makers
    };
    
#endif //this was unbalanced? -CL
