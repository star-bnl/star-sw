// $Id: StSsdClusterList.cc,v 1.2 2005/03/18 14:23:46 lmartin Exp $
//
...
int StSsdClusterList::splitCluster(StSsdClusterControl *clusterControl, StSsdCluster *CurrentCluster, int *ListAdc, StSsdStripList *currentStripList)
{
  ...
  float testTolerance = clusterControl->getTestTolerance();//20%
