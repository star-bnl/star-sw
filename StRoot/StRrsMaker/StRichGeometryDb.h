...
public:
    ...
    // survey geometry
    // Origin of Local in Global in cylindrical
    double localOriginR()     const;
    double localOriginAngle() const;
    double localOriginZ()     const;
    // Inclination in "Euler-like" angles.
    // Rotation to get Local in Global is AngleZ*AngleY*AngleX*Permutation
    double localAngleZ()      const;
    double localAngleY()      const;
    double localAngleX()      const;
...
inline double StRichGeometryDb::localOriginR() const { 
  return mLocalOriginR; }
inline double StRichGeometryDb::localOriginAngle() const { 
  return mLocalOriginAngle; }
inline double StRichGeometryDb::localOriginZ() const { 
  return mLocalOriginZ; }

    // Inclination in "Euler-like" angles.
    // Rotation to get Local in Global is AngleZ*AngleY*AngleX*Permutation

inline double StRichGeometryDb::localAngleZ() const { 
  return mLocalAngleZ; }
inline double StRichGeometryDb::localAngleY() const { 
  return mLocalAngleY; }
inline double StRichGeometryDb::localAngleX() const { 
  return mLocalAngleX; }
