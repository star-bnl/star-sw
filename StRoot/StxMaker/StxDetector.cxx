...
//________________________________________________________________________________ 
ostream& operator<<(ostream& os, const StxDetector& d) {
  os << "StxDetector:" << *d.GetMatrix();
  return os;
} // operator<<
//________________________________________________________________________________ 
void  StxDetector::SetPhysicalNode(TGeoPhysicalNode *nodeP) {
  // from GEANT local system (x_L, y_L=0, z_L) to Stx Local System (R + y_L, -x_L, z_L)
  // from GEANT local system (x_L=0,y_L, z_L) to Stx Local System (R + x_L, y_L, z_L)
