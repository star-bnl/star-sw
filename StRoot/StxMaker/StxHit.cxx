...
void StxHit::setError(const StMatrixF& matrix)
{
...
//_____________________________________________________________________________
Double_t StxHit::Value(int key) const
{
  Double_t value;
  switch (key)
    {
...
//_____________________________________________________________________________
Double_t StxHit::PseudoRapidity() const
{
...
//_____________________________________________________________________________
void StxHit::setGlobal(const StxDetector * detector,
...
void StxHit::set(const StxDetector * detector,
		 const StMeasuredPoint * stHit,
...
//_____________________________________________________________________________
void StxHit::set(const StxDetector * detector, Float_t y, Float_t z) {
  Reset();
  _detector = detector;
  _M = TRVector(2, y, z);
}
...
//________________________________________________________________________________
void StxHit::setVyz(Float_t vy, Float_t vz) {_DriftVelocity = TRVector(2,vy,vz);}
void StxHit::setVz(Float_t vz) {_DriftVelocity = TRVector(2,0.,vz);}
void StxHit::setVy(Float_t vy) {_DriftVelocity = TRVector(2,vy,0.);}
