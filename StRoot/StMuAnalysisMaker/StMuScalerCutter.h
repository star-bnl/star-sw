 ...
 *
 *
 * $Id: StMuScalerCutter.h,v 1.1 2009/02/04 21:37:45 genevb Exp $
...
public:
    ...
    virtual const char *GetCVS() const {
      static const char cvs[]="Tag $Name:  $ $Id: StMuScalerCutter.h,v 1.1 2009/02/04 21:37:45 genevb Exp $ built "__DATE__" "__TIME__ ; 
      return cvs;
    }
