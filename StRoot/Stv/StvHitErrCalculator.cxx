...
//______________________________________________________________________________
void StvHitErrCalculator::SetPars(const double *par,int nPar)
{
...
//______________________________________________________________________________
void StvHitErrCalculator::CalcDetErrs(const StvHit *hit, const StvNodePars *node
                                     ,StvHitErrs *hrr)
{
...
//______________________________________________________________________________
void StvHitErrCalculator::CalcDCAErrs(const StvHit *hit, const StvNodePars *node
                                     ,StvHitErrs *hrr)
{
...
//______________________________________________________________________________
//______________________________________________________________________________
void StvTpcHitErrCalculator::CalcDetErrs(const StvHit *hit, const StvNodePars *node
                                        ,StvHitErrs *hrr)
{
...
//______________________________________________________________________________
void StvTpcHitErrCalculator::CalcDCAErrs(const StvHit *hit, const StvNodePars *node
                                     ,StvHitErrs *hrr)
{
    float zSpan = fabs(hit->x_g()[2]-210)/100;
    ...
    StvHitErrCalculator::CalcDCAErrs(hit,node,hrr);
...
//    Project along X to X=0
  ...
  calc.SetPars(par,4);
  StvNodePars np; np._cosCA = cP;  np._sinCA = sP; np._tanl=tL;
  StvHitErrs hitErr;
