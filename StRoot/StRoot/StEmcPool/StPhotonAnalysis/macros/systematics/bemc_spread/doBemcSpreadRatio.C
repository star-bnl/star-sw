void doBemcSpreadRatio(char *f_100,char *f_110,char *f_90){
  ...
  leg->AddEntry(gHT2_plus,"BEMC gain spread 9%","p");
  leg->AddEntry(gHT2_min,"BEMC gain spread 5%","p");
  leg->Draw();

  c->SaveAs("bemc_spread_ratio_pp.eps");
  c->SaveAs("bemc_spread_ratio_pp.root");
