...
class StFgtLHHTracking;

// global variables
StChain            *analysisChain = 0;
StMuDstMaker       *muDstMaker    = 0;
StMuFgtOccTxtMkr   *occTxtMkr     = 0;
StFgtLHHTracking   *fgtTrkMkr     = 0;

void runFgtLHHTracking_MuDst( const Char_t *filename, 
                              Int_t neventsIn = 10 ){
   ...
   // the track maker
   //
   fgtTrkMkr = new StFgtLHHTracking( "fgtTrkMkr" );
...
/*
 * $Id: runFgtLHHTracking_MuDst.C,v 1.1 2012/04/09 16:14:23 sgliske Exp $
 * $Log: runFgtLHHTracking_MuDst.C,v $
