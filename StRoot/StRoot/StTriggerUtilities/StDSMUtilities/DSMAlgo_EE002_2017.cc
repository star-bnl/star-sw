...
void DSMAlgo_EE002_2017::operator()(DSM& dsm)
{
  // INPUT:
  ...
  sumTriggerPatchChannels2015(dsm, 0, 4, 1, 1, sumJ0, highTowerBitsJ0);
  ...
  sumTriggerPatchChannels2015(dsm, 5, 9, 1, 1, sumJ1, highTowerBitsJ1);
