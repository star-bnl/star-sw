...
int DSMAlgo_EM201_2013_a::ajpBarrel(DSM& dsm, int offset) const
{
  int jpBits[6];
...
*/
void DSMAlgo_EM201_2013_a::operator()(DSM& dsm)
{
...
int DSMAlgo_EM201_2013_a::Dijet(DSM &dsm, int jpTH = 0) const
{
...
/*
int DSMAlgo_EM201_2013_a::EndDijet(DSM &dsm, int jpTH = 0) const
{
