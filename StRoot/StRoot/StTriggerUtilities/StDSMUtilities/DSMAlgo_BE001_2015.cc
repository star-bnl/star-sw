...
void DSMAlgo_BE001_2015::operator()(DSM& dsm)
{
  // INPUT:
  ...
  sumTriggerPatchChannels2015(dsm, 0, 5, 1, 1,  lowEtaSum, highTowerBits);
  sumTriggerPatchChannels2015(dsm, 6, 9, 1, 1, highEtaSum, highTowerBits);
