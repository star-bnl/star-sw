...
void DSMAlgo_BW003_2015::operator()(DSM& dsm)
{
  // INPUT:
  ...
  sumTriggerPatchChannels2015(dsm, 1, 3, 2, 1,  lowEtaSumJP1, highTowerBitsJP1);
  sumTriggerPatchChannels2015(dsm, 5, 9, 2, 1, highEtaSumJP1, highTowerBitsJP1);
  ...
  sumTriggerPatchChannels2015(dsm, 0, 2, 2, 1,  lowEtaSumJP6, highTowerBitsJP6);
  sumTriggerPatchChannels2015(dsm, 4, 8, 2, 1, highEtaSumJP6, highTowerBitsJP6);
