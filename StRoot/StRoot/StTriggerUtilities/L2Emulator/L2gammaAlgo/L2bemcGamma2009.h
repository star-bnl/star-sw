#ifndef L2bemcGamma2009_H
#define L2bemcGamma2009_H
/*********************************************************************
 * $Id: L2bemcGamma2009.h,v 1.1 2011/03/09 16:29:07 pibero Exp $
...
class L2bemcGamma2009 ;
class L2Histo;
class L2EmcGeom;
// remember to clear in initRun() to avoid stale data
class L2bemcGammaEvent2009 {// WARN : all is in RAM x 4096 tokens!
 public:
  enum {kDataFresh=0}; // if used 1 or more times data are stale
 private:
  friend class L2bemcGamma2009 ;
  int   isFresh; // for QA    
  float clusterET;
  float seedET;
  int seedTwID;
...
class L2bemcGamma2009 : public  L2VirtualAlgo2009 {
 ...
 //............... preserved for Decision(),
  L2bemcGammaEvent2009 mBtow[L2eventStream2009::mxToken]; //it is a lot of RAM!
 ...
 public:
  L2bemcGamma2009(const char* name, L2EmcDb* db, L2EmcGeom *geo, char* outDir, int resOff);
