...
#ifndef L2_BEMC_GAMMA_RESULT_2012_H
#define L2_BEMC_GAMMA_RESULT_2012_H

struct L2gammaResult2012 {
...
//...................................
inline void 
L2gammaResult2012_print(L2gammaResult2012 *p){
  if(p==0) {printf("print L2gammaResult2012 - NULL pointer ????\n"); return;}
  printf("print L2gammaResult2012: TowerID=%d, quadrant=%d, meanEtaBin=%3.3f, meanPhiBin=%3.3f, \ntrigger=%d, clusterEt=%f, isolationSum=%d\n", 
  (p->TowerID & 0x1FFF),
  (p->TowerID & 0xE000)>>13,
