...
#include "L2VirtualAlgo2006.h"
//=============================================
L2VirtualAlgo2006::L2VirtualAlgo2006(const char* name, L2EmcDb* db, char* outDir, int resOff) :  mDb(db), mResultOffset(resOff) {
...
//=============================================
void 
L2VirtualAlgo2006::finishCommonHistos() {
...
L2VirtualAlgo2006::~L2VirtualAlgo2006(){};

//=============================================
int 
L2VirtualAlgo2006::readParams(const char *fileN, int mxPar, int *iPar, float *fPar) {
  /* return:
    <0 : error in input
  ...
  */
  ...
  if(fd==0) { printf("   L2VirtualAlgo2006::readParams failed to open =%s=\n",fileN); return -2222;}
  ...
  fclose(fd);
  printf("    L2VirtualAlgo2006::readParams %d from '%s'\n",nVal,fileN); 
  return nVal;
}
