scanBXoff( char* Rrun    = "R10103027") {
  ...
  TString fname="../dataB4.31/";  fname+=Rrun;  fname+=".wana.hist.root";
  ...
  // return;
  // tmp
  TFile *fd2=new TFile("../dataB4.31/R10103027.wana.hist.root");
  fd2->ls();
  hI =(TH1F*) fd->Get("mubX7v"); assert(hI); // Ideal distribution --> the goal
