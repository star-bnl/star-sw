...
// Mon May  6 15:50:56 2013 by ROOT version 5.34/07
// from TTree FitP/Fit results
// found on file: /afs/rhic.bnl.gov/star/users/fisyak/work/Tpc/Alignment/Laser/2013/st_laser_adc_14046081_raw.F.Fit.g1.LandauIFreQ.AllN.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/rhic.bnl.gov/star/users/fisyak/work/Tpc/Alignment/Laser/2013/st_laser_adc_14046081_raw.F.Fit.g1.LandauIFreQ.AllN.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/rhic.bnl.gov/star/users/fisyak/work/Tpc/Alignment/Laser/2013/st_laser_adc_14046081_raw.F.Fit.g1.LandauIFreQ.AllN.root");
      }
