...
root -b -q "StRoot/StiEvaluator/macros/SaveEff.C(\"out.root\",\"accMcPtDistributionHiAll\",\"matchedMcPtDistributionHiAll\",\"All_Hi.root\")"
root -b -q "StRoot/StiEvaluator/macros/SaveEff.C(\"out.root\",\"accMcPtDistributionLoAll\",\"matchedMcPtDistributionLoAll\",\"All_Lo.root\")"
