#ifndef StiFilterOptionFrame_H
#define StiFilterOptionFrame_H 
#include <vector>
using std::vector;
#include <utility>
using std::pair;
...
class  StiFilterOptionFrame : public TGTransientFrame
{    
 public:
    StiFilterOptionFrame(const TGWindow *p, const TGWindow *main, EditableParameters * params);
    virtual ~StiFilterOptionFrame();
