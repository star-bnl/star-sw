/***************************************************************************  
 *  
 * $Id: Cut.cxx,v 1.1 2002/04/02 20:05:17 jklay Exp $  
 *  
  ...
  */
  ...
  case 8: // central
	...
	cerr << "unknown centrality definition for spectra " << centDefSpectra<<endl; exit(1);
      ...
      if(centDefOther==9){ // flow
	mFlowCent[0]=7; mFlowCent[1]=9; mDoFlowCent=true;
      }
      else if(centDefOther==8){ // zdc-ctb
  ...
  case 4: // 10-20%
    ...
    if(mDoSpectraCent){
      if(centDefSpectra==9){ // flow
	mFlowCent[0]=4; mFlowCent[1]=6; mDoFlowCent=true; // KLUDGE
      }
      else if(centDefSpectra==8){ // zdc-ctb
	...
	cerr << "unknown centrality definition for spectra " << centDefSpectra<<endl; exit(1);
      ...
      if(centDefOther==9){ // flow
	mFlowCent[0]=4; mFlowCent[1]=6; mDoFlowCent=true;
      }
      else if(centDefOther==8){ // zdc-ctb
	mZdcCtbCent[0]=kThirty; 
	mZdcCtbCent[1]=kThirty; mDoZdcCtbCent=true;
  ...
  case 6:
    mVertexZ[0]=-125; mVertexZ[1]=125; break;
  default:
  ...
  default:
    cerr << "Unknown fit pts type : " << half << endl; exit(1);
  }
