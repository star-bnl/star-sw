/***************************************************************************    
 *    
 * $Id: Bin.h,v 1.1 2002/04/02 20:05:16 jklay Exp $
 *    
 * Author: Bum Choi, UT Austin, Apr 2002    
 *    
 ***************************************************************************    
 *    
 * Description:  Useful definitions for standard histogram bins and ranges                
 *                 
 *                 
 ***************************************************************************  
 *  
...
namespace Bin
{
  ...
  // 0-9 0 is most central (kFive)
   ...
   const Int_t nCtbBin=(Int_t)ceil(ctbMax-ctbMin);
  ...
  void initPtAry(TArrayD* a, int type);
   ...
   const Int_t nPtTinyBin = (Int_t)ceil((ptTinyMax-ptTinyMin)/.1);

   // will rebin with these
   const double ptRebinMin = 1;
   const double ptRebinMax = 8;
