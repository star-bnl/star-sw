/***************************************************************************
 *
 * $Id: StEmcHandleInput.cxx,v 1.1 2001/07/17 00:14:37 perev Exp $
 *
 * Author:  bl
 ***************************************************************************
 *
...
//-----------------------------------------------------------------
    ...
    StEmcHandleInput::StEmcHandleInput(const StEvent*event, const StEMCReader* emcreader,const TDataSet* calibdb)
