...
class TrackT : public TObject {
 ...
 private:
  ...
  Double32_t      fPxlHitXL[3];
  Double32_t      fPxlHitYL[3];
  Double32_t      fPxlHitZL[3];
        
  Double32_t      fIstHitX[2];
  Double32_t      fIstHitY[2];
  Double32_t      fIstHitZ[2];

  Double32_t      fIstHitXL[2];  
  Double32_t      fIstHitYL[2];    
  Double32_t      fIstHitZL[2];
      
  Double32_t      fSsdHitX[2];
  Double32_t      fSsdHitY[2];
  Double32_t      fSsdHitZ[2];
  
  Double32_t      fSsdHitXL[2];      
  Double32_t      fSsdHitYL[2];    
  Double32_t      fSsdHitZL[2];
 ...
 public:
  ...
  virtual void SetPxlHitLocal(UInt_t i, Double32_t *xyz) { fPxlHitXL[i]=xyz[0]; fPxlHitYL[i]=xyz[1]; fPxlHitZL[i]=xyz[2]; }
  virtual void SetIstHitLocal(UInt_t i, Double32_t *xyz) { fIstHitXL[i]=xyz[0]; fIstHitYL[i]=xyz[1]; fIstHitZL[i]=xyz[2]; }
  virtual void SetSsdHitLocal(UInt_t i, Double32_t *xyz) { fSsdHitXL[i]=xyz[0]; fSsdHitYL[i]=xyz[1]; fSsdHitZL[i]=xyz[2]; }
