// @(#)root/base:$Name:  $:$Id: TNumDeriv.h,v 1.1.1.1 2007/02/21 16:54:03 fisyak Exp $
...
public:
           TNumDeriv(const char *name):TNamed(name,"") {fStep=0.01;fIArg=0;fFail=0;};
  virtual ~TNumDeriv(){}
  virtual Double_t   Fcn(Double_t  add=0.)=0;  	//Fcn,              must  be overloaded 
  virtual Int_t      Failed() {return fFail;} 	  
