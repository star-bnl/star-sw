/***************************************************************************
 *
 * $Id: mercedesEventCutMonitor.cxx,v 1.2 2003/01/17 16:47:31 mercedes Exp $
 *
...
mercedesEventCutMonitor::mercedesEventCutMonitor(){
  ...
  mEventMultvsTracks = new StHbt2DHisto("Event Multiplicity vs Tracks ","EventMultvsTracks",1000, 0., 1000., 1000,0.,10000.0);
