...
public:
  ...
  // do project
  ////
  TH1D *get1dProjection(TString axis, double xmin, double xmax, double ymin,
                        double ymax, double zmin, double zmax);
  TH2D *get2dProjection(TString axis, double xmin, double xmax, double ymin,
                        double ymax, double zmin, double zmax);
