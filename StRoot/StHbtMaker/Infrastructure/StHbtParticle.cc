...
// //   if (TMath::IsNaN(mNominalTpcEntrancePoint.x()) || 
// //       TMath::IsNaN(mNominalTpcEntrancePoint.x()) || 
// //       TMath::IsNaN(mNominalTpcEntrancePoint.x()) ) mNominalTpcEntrancePoint = StHbtThreeVector(-9999.,-9999.,-9999); 
// //   if (TMath::IsNaN(mNominalTpcExitPoint.x()) || 
// //       TMath::IsNaN(mNominalTpcExitPoint.x()) || 
// //       TMath::IsNaN(mNominalTpcExitPoint.x()) ) mNominalTpcExitPoint = StHbtThreeVector(-9999.,-9999.,-9999); 

//   // This is faster  
//   if (TMath::IsNaN(mNominalTpcExitPoint.x())) mNominalTpcExitPoint = StHbtThreeVector(-9999.,-9999.,-9999); 
...
//   ZeroVec.setZ(tHelix->origin().z()-PrimVert->z());
  ...
  *tmpTpcEntrancePoint = hel.at(sideLength);
  // This is the secure way !  
  if (TMath::IsNaN(tmpTpcEntrancePoint->x()) || 
      TMath::IsNaN(tmpTpcEntrancePoint->y()) || 
  ...
  if (TMath::IsNaN(tmpTpcExitPoint->x()) || 
      TMath::IsNaN(tmpTpcExitPoint->y()) || 
...
//   if (TMath::IsNaN(tmpTpcEntrancetPoint->x())) *tmpTpcEntrancePoint = StHbtThreeVector(-9999.,-9999.,-9999); 
  ...
  while (irad<11 && !TMath::IsNaN(sideLength)){
    ...
    if(TMath::IsNaN(tmpPosSample[irad].x()) ||
       TMath::IsNaN(tmpPosSample[irad].y()) ||
