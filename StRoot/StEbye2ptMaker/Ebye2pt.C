...
void Ebye2pt(Int_t, const Char_t **, const Char_t *qaflag = "");

void Ebye2pt(Int_t nevents=2, 
              const Char_t *path="-",
              const Char_t *file="/afs/rhic/star/data/samples/gstar.dst.root",
	      const Char_t *outFile="Ebye2pt.root",
...
void Ebye2pt(Int_t nevents, const Char_t **fileList, const Char_t *outFile, const Char_t *qaflag, const Int_t wrStEOut)
{
  ...
  cout << " doEvents -  input wrStEOut = " << wrStEOut << endl << endl << endl;
    ...
    gSystem->Load("StMagF");
    gSystem->Load("StEbyeDSTMaker");
    gSystem->Load("StEbye2ptMaker");
    ...
    //Read pico-DST
    StEbye2ptMaker *Ebye2ptMaker = new StEbye2ptMaker("Ebye2pt");
    Ebye2ptMaker->EbyeDSTRead(kTRUE);
    Ebye2ptMaker->SetEbyeDSTFileName(fileList[0]);

   //Set Output Filename
    Ebye2ptMaker->SetEbye2ptFileName(outFile);
...
void Ebye2pt(const Int_t nevents, const Char_t *path, const Char_t *file,
              const Char_t *outFile, const Char_t *qaflag, const Int_t wrStEOut)
{
    ...
    Ebye2pt(nevents,fileListQQ,outFile,qaflag,wrStEOut);
}
