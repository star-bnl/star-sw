...
//     mThetaX = -.090*milliradian;
    mThetaY = -.381*milliradian;
//     mThetaY = -.341*milliradian;
...
//     PR(mOmegaTau);
    ...
    //
    // velocity for positron transport
    //
    //         u |E|       ^           ^   ^              ^   ^  ^
    ...
    double constant = (mMobility*abs(mDriftField))/(1+sqr(omegaTau));
//     PR(constant/(centimeter/microsecond));
	...
	e = StThreeVectorD(-1.*mDriftField.unit());
    }
