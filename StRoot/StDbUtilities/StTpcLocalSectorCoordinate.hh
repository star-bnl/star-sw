...
public:
  ...
  StTpcLocalSectorCoordinate(double x, double y, double z, int sector=0, int row=0) :
    StTpcCoordinate(x,y,z,sector,row) {}
  StTpcLocalSectorCoordinate(const StThreeVector<double>& xyz, int sector=0, int row=0) :
