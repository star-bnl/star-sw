...
void EvtSLBKPoleFF::getbaryonff(EvtId, EvtId, double, double, double*, 
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtSLBKPoleFF.\n";  
  ::abort();
...
void EvtSLBKPoleFF::getdiracff(EvtId, EvtId, double, double, double*, double*,
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :getdiracff in EvtSLBKPoleFF.\n";
  ::abort();
