  ...
  if ( ndaug != 2 ) {
    ...
    int il2=0;
     ...
     case 15:
       ...
       break;
     default:
       EvtGenReport(EVTGEN_ERROR,"EvtGen") << "too many daughters for phase space..." << ndaug << " "<< mp <<endl;;
       break;
     }
	 ...
	 wt=wt*EvtPawt(pm[4][il-1],pm[4][il+1-1],mass[il-1]);
       ...
       if (wt>wtmax) {
	 EvtGenReport(EVTGEN_ERROR,"EvtGen") << "wtmax to small in EvtPhaseSpace with "
