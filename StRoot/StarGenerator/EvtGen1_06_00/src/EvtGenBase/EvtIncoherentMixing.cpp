// $Id: EvtIncoherentMixing.cpp,v 1.1 2016/10/28 16:52:46 jwebb Exp $
// Include files 
                                           ...
                                           int &mix )
{
  ...
  if ( ( B0 != id ) && ( B0B != id ) ) {
    EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Bad configuration in incoherentB0Mix" 
                           << std::endl ;
    ::abort() ;
  }
                                           ...
                                           int &mix )
{
  ...
  if ( ( BS != id ) && ( BSB != id ) ) {
    EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Bad configuration in incoherentBsMix" 
                           << std::endl ;
    ::abort() ;
  }
