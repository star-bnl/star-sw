...
EvtParticle* EvtParticleFactory::particleFactory(EvtSpinType::spintype spinType){
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen")<<"Error in EvtParticleFactory::particleFactory"<<endl;
  EvtGenReport(EVTGEN_ERROR,"EvtGen")<<"Tried to create non-existing particle"
