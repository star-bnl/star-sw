...
say a <i>g &rarr; g g</i> branching or a <i>u u &rarr; u u</i> 
hard scattering, it will stop the tracing and return the current position. 
...
example of this is for ISR cascades, e.g. <i>e &rarr; e gamma</i> where 
