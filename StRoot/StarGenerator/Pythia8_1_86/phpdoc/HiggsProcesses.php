...
channels, which is only based on the above parameters. 
<br/>
<input type="radio" name="113" value="0"><strong>0 </strong>: <br/>
<input type="radio" name="113" value="1" checked="checked"><strong>1 </strong>: assuming the <ei>H^0(H_2)</ei> is a pure scalar  (CP-even), as in the MSSM.<br/>
<input type="radio" name="113" value="2"><strong>2 </strong>: assuming the <ei>H^0(H_2)</ei> is a pure pseudoscalar  (CP-odd).<br/>
<input type="radio" name="113" value="3"><strong>3 </strong>: assuming the <ei>H^0(H_2)</ei> is a mixture of the two,  including the CP-violating interference term. The parameter  <ei>eta</ei>, see below, sets the strength of the CP-odd admixture,  with the interference term being proportional to <ei>eta</ei>  and the CP-odd one to <ei>eta^2</ei>.<br/>
 
<br/><br/><table><tr><td><strong>HiggsH2:etaParity </td><td></td><td> <input type="text" name="114" value="0." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.</strong></code>)</td></tr></table>
The <i>eta</i> value of CP-violation in the 
<code>HiggsSM:parity = 3</code> option. 
...
channels, which is only based on the above parameters. 
<br/>
<input type="radio" name="115" value="0"><strong>0 </strong>: <br/>
<input type="radio" name="115" value="1"><strong>1 </strong>: assuming the <ei>A^0(H_3)</ei> is a pure scalar  (CP-even).<br/>
<input type="radio" name="115" value="2" checked="checked"><strong>2 </strong>: assuming the <ei>A^0(H_3)</ei> is a pure pseudoscalar  (CP-odd), as in the MSSM.<br/>
<input type="radio" name="115" value="3"><strong>3 </strong>: assuming the <ei>A^0(H_3)</ei> is a mixture of the two,  including the CP-violating interference term. The parameter  <ei>eta</ei>, see below, sets the strength of the CP-odd admixture,  with the interference term being proportional to <ei>eta</ei>  and the CP-odd one to <ei>eta^2</ei>.<br/>
 
<br/><br/><table><tr><td><strong>HiggsA3:etaParity </td><td></td><td> <input type="text" name="116" value="0." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.</strong></code>)</td></tr></table>
The <i>eta</i> value of CP-violation in the 
<code>HiggsSM:parity = 3</code> option. 
...
if($_POST["113"] != "1")
{
$data = "HiggsH2:parity = ".$_POST["113"]."\n";
fwrite($handle,$data);
}
if($_POST["114"] != "0.")
{
$data = "HiggsH2:etaParity = ".$_POST["114"]."\n";
fwrite($handle,$data);
}
if($_POST["115"] != "2")
{
$data = "HiggsA3:parity = ".$_POST["115"]."\n";
fwrite($handle,$data);
}
if($_POST["116"] != "0.")
{
$data = "HiggsA3:etaParity = ".$_POST["116"]."\n";
fwrite($handle,$data);
}
fclose($handle);
}
