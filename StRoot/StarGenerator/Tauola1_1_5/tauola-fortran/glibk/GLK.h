...
*//                                                                          //
*//                      Version:    1.30                                    //
*//              Last correction:    December 1997                           //
*//                                                                          //
*//////////////////////////////////////////////////////////////////////////////

      INTEGER    m_version         ! this is version version number
      PARAMETER( m_version = 130)
*-----------------------------------------------------------------------------
...
* so m_buf1=m_buf2 is still required
      ...
      INTEGER m_MaxNb
      PARAMETER( m_MaxNb = 1000)   ! maximum numbers of bins
*-----------------------------------------------------------------------------
      INTEGER    m_LenmB
      PARAMETER (m_LenmB = 50000)
