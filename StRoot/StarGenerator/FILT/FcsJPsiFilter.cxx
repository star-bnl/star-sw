...
FcsJPsiFilter::FcsJPsiFilter():StarFilterMaker("fcsJPsiFilter"){
    cout<<"FCS JPsi filter is used!!!"<<endl;
}
//_______________________________________________________________
Int_t FcsJPsiFilter::Filter( StarGenEvent *mEvent){
    ntot++;
    ...
    // apply JPsi conditions for events
	...
	for(unsigned int j=i + 1; j<size; j++){
		...
		ngood++;
		cout << Form("FcsJPsiFilter : N_Genearted=%6d  N_Accepted=%6d  R=%6.4f  x1=%.3f   x2=%.3f   xx=%.3f",
