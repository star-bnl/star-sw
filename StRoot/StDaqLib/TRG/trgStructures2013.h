#ifndef trgStructures2013_h
#define trgStructures2013_h
/******
*
...
******************************************************************************/
#define y13FORMAT_VERSION        0x12112942      /* Format: yymmddvv */
#define y13MAX_TRG_BLK_SIZE          122896      /* Estimated at 100k bytes including pre/post */
#define y13MAX_OFFLEN                    20      /* Depends on the number of crates in the system */

#define   y13L1_CONF_NUM       1
#define  y13BC1_CONF_NUM       2
#define  y13MXQ_CONF_NUM       3
#define  y13MIX_CONF_NUM       4
#define  y13BCW_CONF_NUM       5
#define  y13BCE_CONF_NUM       6
#define  y13FEQ_CONF_NUM       7
#define  y13BBC_CONF_NUM       8
#define  y13BBQ_CONF_NUM       9
#define  y13FMS_CONF_NUM      10
#define  y13QT1_CONF_NUM      11
#define  y13QT2_CONF_NUM      12
#define  y13QT3_CONF_NUM      13
#define  y13QT4_CONF_NUM      14

#define y13ADD_BIT_PILEUP         0              /* Contamination/Pileup bit in event descriptor add-bits */
#define y13ADD_BIT_FORCE          5              /* Force store of this event */
#define y13ADD_BIT_L2_5           6              /* Level 2.5 abort */
#define y13ADD_BIT_SIM            7              /* Simulated event - used by DAQ */

#define L2RESULTS_2013_OFFSET_EMC_CHECK   1
#define L2RESULTS_2013_OFFSET_EMC_PED     2
#define L2RESULTS_2013_OFFSET_BGAMMA      3
#define L2RESULTS_2013_OFFSET_EGAMMA      6
#define L2RESULTS_2013_OFFSET_DIJET       9 
#define L2RESULTS_2013_OFFSET_UPSILON     17
#define L2RESULTS_2013_OFFSET_BEMCW       20
#define L2RESULTS_2013_OFFSET_BHIEN       42
#define L2RESULTS_2013_OFFSET_EHIEN       0
#define L2RESULTS_2013_OFFSET_BTOW_CAL    0
#define L2RESULTS_2013_OFFSET_ETOW_CAL    0
...
typedef struct {
  ...
  TrgOfflen2013 EventDesc_ofl;                /* Offset/length pair to Event Descriptor */
  TrgOfflen2013 L1_DSM_ofl;                   /* Offset/length pair to L1 DSM Data */
  TrgOfflen2013 Summary_ofl;                  /* Offset/length pair to Summary Data */
  TrgOfflen2013 MainX[y13MAX_OFFLEN];         /* Offset/length pairs for main crossing */
  int PrePostList[10];                        /* Offsets to offset/length pairs to (5) Pre and (5) Post crossing */
  int raw_data[y13MAX_TRG_BLK_SIZE/4];        /* Storage for raw data */
} TriggerDataBlk2013;
