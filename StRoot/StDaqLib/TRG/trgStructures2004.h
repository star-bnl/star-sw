/*
 * Header Name: trgStructures2004.h                                                       
 * Header Number: x.y                                                                 
 * Package Name: All                                                                  
...
#define y4L2_SUM_LEN           116              /* Number of bytes in L2 Summary + Header */
...
#define y4ADD_BIT_FORCE          5              /* Force store of this event */
#define y4ADD_BIT_L2_5           6              /* Level 2.5 abort */
#define y4ADD_BIT_SIM            7              /* Simulated event - used by DAQ */
...
} EvtDescData2004;        /* 40 bytes total */ 
...
} L0_DSM_Data2004;       /* 192 bytes total */
...
typedef struct {
  ...
  L0_DSM_Data2004    DSMdata;           /* L0 DSM Data from DSM Tree */
...
} TrgSumData2004;     /* 480 bytes total */
...
} RawTrgDet2004;           /* 1776 bytes total */
