...
#if defined(__i386)	/* assume linux, GCC 3.X (new!) */

#define RTS_LITTLE_ENDIAN

#elif defined(__i960)	/* assume vxworks, GCC 2.7 */
...
#elif defined(__ppc)	/* assume linux, GCC 2.95? */

#define RTS_BIG_ENDIAN

#elif defined(__sparc)	/* assume Solaris ultrasparc, GCC 2.8 */
