...
//TODO: define a map from constant name to array index
Int_t fms_db_recpar(char* opt = "readdb writetext", char* dataspec = "r11fmsrecpar.txt"){
//Int_t fms_db_recpar(char* opt = "readtext writedb", char* dataspec = "fmsrecpar.txt"){
	...
	TString storeTime = "2014-12-20 00:00:00"; //store time for run15
//	TString storeTime = "2014-02-22 00:00:00"; //store time for run15
//	TString storeTime = "2013-06-08 00:00:00"; //store time for run13
//	TString storeTime = "2010-12-20 00:00:00"; //store time for run11, temporary test. fmsRec is not installed for Run11
