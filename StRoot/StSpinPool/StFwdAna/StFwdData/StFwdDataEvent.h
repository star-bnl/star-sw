...
public:
  ...
  Short_t mFoundVertex = 0;      ///< Encoding for which vertex was best; 0 means no vertex, 1=Primary Vertex found,2=Vpd,3=Epd,4=Bbc
  ...
  Int_t mTriggers[mMaxTrig];               //! Array with all the triggers found in the data, (according to)[https://root.cern/manual/io/#excluding-data-members-from-io] the '//!' tag at the beginning says don't store this variable. A separate branch will be created manually for storing the trigger information
