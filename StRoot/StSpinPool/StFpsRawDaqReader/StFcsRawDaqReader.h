...
inline const char *StFcsRawDaqReader::GetCVS() const {
   static const char cvs[] = "Tag $Name:  $ $Id: StFcsRawDaqReader.h,v 1.1 2019/03/13 20:31:34 akio Exp $ built " __DATE__ " " __TIME__ ;
   return cvs;
};
...
/*
 * $Id: StFcsRawDaqReader.h,v 1.1 2019/03/13 20:31:34 akio Exp $
