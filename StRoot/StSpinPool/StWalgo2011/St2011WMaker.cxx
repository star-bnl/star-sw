// $Id: St2011WMaker.cxx,v 1.13 2012/08/20 23:43:01 smirnovd Exp $
//
...
//________________________________________________
Int_t St2011WMaker::InitRun(int runNo)
{
   ...
   if (mMuDstMaker) {
      ...
      for (int isec = 0; isec < mxTpcSec; isec++)
      {
         ...
         if ((sec == 5 || sec == 6 || sec == 7 || sec == 21) && (mRunNo >= 13000000 || mRunNo / 100 == 3) )Rin = 125.; //all have dead inner padrows, run#300+nn is for M-C generated by Jan
...
//________________________________________________
//________________________________________________
Int_t St2011WMaker::FinishRun(int runNo)
{
...
//________________________________________________
//________________________________________________
void St2011WMaker::Clear(const Option_t *)
{
   wEve->clear();
}
...
//--------------------------------------
// returns error code
int St2011WMaker::L2algoEtaPhi2IJ(float etaF, float phiF, int &iEta, int &iPhi)
{
...
//________________________________________________
//________________________________________________
void St2011WMaker::fillNorm()  //intended for normalization of filtered QCD MC
{
...
//________________________________________________
//________________________________________________
TClonesArray * St2011WMaker::getJets(TString branchName)
{
...
// ----------------------------------------------------------------------------
TClonesArray * St2011WMaker::getJetsTreeAnalysis(TString branchName)
{
   if (mJetTreeChain == 0) {
      nJets = -1; return 0;
   }
...
// ----------------------------------------------------------------------------
StJets * St2011WMaker::getStJetsCopy(TString branchName)
{
...
// Revision 1.13  2012/08/20 23:43:01  smirnovd
