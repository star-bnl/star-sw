// $Id: St2009WMaker.h,v 1.16.6.1 2016/05/23 18:33:23 jeromel Exp $
...
class St2009WMaker : public StMaker {
 ...
 public: 
  ...
  virtual const char *GetCVS() const {
    static const char cvs[]="Tag $Name:  $ $Id: St2009WMaker.h,v 1.16.6.1 2016/05/23 18:33:23 jeromel Exp $ built "__DATE__" "__TIME__ ; 
    return cvs;
  }
...
// Revision 1.16.6.1  2016/05/23 18:33:23  jeromel
// Updates for SL12d / gcc44 embedding library - StDbLib, QtRoot update, new updated StJetMaker, StJetFinder, StSpinPool ... several cast fix to comply with c++0x and several cons related fixes (wrong parsing logic). Changes are similar to SL13b (not all ode were alike). Branch BSL12d_5_embed.
//
// Revision 1.16.4.2  2016/04/27 17:47:53  zchang
// *** empty log message ***
//
