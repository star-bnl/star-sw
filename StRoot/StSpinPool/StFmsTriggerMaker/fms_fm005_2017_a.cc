...
void fms_fm005_2017_a(Board& fm005, int t, int simdat){
  ...
  int BS1IJ= (bs[4]>BSThr1) | (bs[5]>BSThr1) | (bs[6]>BSThr1);
  int BS1GH= (bs[0]>BSThr1) | (bs[1]>BSThr1) | (bs[2]>BSThr1) | (bs[3]>BSThr1);
  ...
  if(PRINT){
    ...
    printf("%s out=%08x BS3=%1d BS2=%1d BS1IJ=%1d BS1GH=%1d sum=%4d %4d %4d %4d %4d %4d %4d JpGH/IJ=%3d %3d\n",
	   fm005.name,fm005.output[t],BS3,BS2,BS1IJ,BS1GH,
	   bs[0],bs[1],bs[2],bs[3],bs[4],bs[5],bs[6],JpGH,JpIJ);
  }
}

int getFM005_2017a_BS3(int out)    {return getbits(out, 0, 1);}
int getFM005_2017a_BS2(int out)    {return getbits(out, 1, 1);}
int getFM005_2017a_BS1IJ(int out)  {return getbits(out, 2, 1);}
int getFM005_2017a_BS1GH(int out)  {return getbits(out, 3, 1);}
int getFM005_2017a_J23(int out)    {return getbits(out, 4,12);}
int getFM005_2017a_JpGH(int out)   {return getbits(out,16, 8);}
int getFM005_2017a_JpIJ(int out)   {return getbits(out,24, 8);}
