...
void fms_fm001_2011_a(Board& fm001)
{
  int A[4], B[4], C[4], D[4], htadc, htid;

  getQtSumAndHighTower((int*)fm001.channels,A,B,C,D,htadc,htid);
  ...
  fm001.output = SumD | SumC << 5 | SumBC << 10 | SumB << 15 | SumAB << 20 | SumA << 25 | HT0 << 30 | HT1 << 31;
}
