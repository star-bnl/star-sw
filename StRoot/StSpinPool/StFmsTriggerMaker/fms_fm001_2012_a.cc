...
void fms_fm001_2012_a(Board& fm001, int t){
  ...
  if (SumC  > 31) SumC  = 31;
  if (SumCD > 31) SumCD = 31;
  if (SumD  > 31) SumD  = 31;

  // Output the resulting 6 5-bit sums to the Layer-1 DSM (30 bits)
  fm001.output[t] = SumD | SumC << 5 | SumBC << 10 | SumB << 15 | SumCD << 20 | SumA << 25 | HT0 << 30 | HT1 << 31;
