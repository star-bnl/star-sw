// $Id: StdEdxY2Maker.h,v 1.11 2004/07/01 13:36:15 fisyak Exp $
...
class StdEdxY2Maker : public StMaker {
 private:
  ...
  Int_t                m_OldClusterFinder; //! old == 1; new == 0
  Int_t                m_Calibration;   //!
 ...
 public: 
  ...
  virtual const char *GetCVS() const {
    static const char cvs[]=
      "Tag $Name:  $ $Id: StdEdxY2Maker.h,v 1.11 2004/07/01 13:36:15 fisyak Exp $ built "__DATE__" "__TIME__ ; 
    return cvs;
  }
