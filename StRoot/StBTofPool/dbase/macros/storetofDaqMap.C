...

{
  ...
  TString ZStoreTime = "2014-02-18 00:00:00";
...
//                            129,131,105,107,33,35,9,11,109,110,
//                            39,133,132,135,108,37,36,13,12}; //east;
// //-- Run 10 Le/Te to the same channel
//  Short_t PMT2LeChan[38] = {5, 22, 12, 29, 46, 36, 53, 70, 60, 101,
//                            0, 24, 118, 108, 125, 142, 132, 48, 96,  //west
//                            5, 22, 12, 29, 46, 36, 53, 70, 60, 101,
//                            0, 24, 118, 108, 125, 142, 132, 48, 96}; //east
//  Short_t PMT2TeChan[38] = {5, 22, 12, 29, 46, 36, 53, 70, 60, 101,
//                            0, 24, 118, 108, 125, 142, 132, 48, 96,  //west 
//                            5, 22, 12, 29, 46, 36, 53, 70, 60, 101,
//                            0, 24, 118, 108, 125, 142, 132, 48, 96}; //east
//
 //-- Run 14 Le/Te to the same channel (4 channels moved to different inputs)
  Short_t PMT2LeChan[38] = {5, 22, 12, 29, 46, 36, 53, 70, 60, 101,
                            0, 24, 118, 108, 125, 139, 133, 48, 96,  //west
                            5, 22, 12, 29, 46, 36, 53, 70, 60, 101,
                            0, 24, 118, 108, 125, 139, 133, 48, 96}; //east
  Short_t PMT2TeChan[38] = {5, 22, 12, 29, 46, 36, 53, 70, 60, 101,
                            0, 24, 118, 108, 125, 139, 133, 48, 96,  //west 
                            5, 22, 12, 29, 46, 36, 53, 70, 60, 101,
                            0, 24, 118, 108, 125, 139, 133, 48, 96}; //east
