/*******************************************************************
 *
 * $Id: StBTofCalibMaker.h,v 1.16 2021/05/31 03:35:08 genevb Exp $
 *
 * Author: Xin Dong
 *****************************************************************
 *
 ...
 * Revision 1.16  2021/05/31 03:35:08  genevb
...
private:
  ...
  static const Double_t mC_Light;  // = C_C_LIGHT/1.e9;
    ...
    virtual const char *GetCVS() const
      {static const char cvs[]="Tag $Name:  $ $Id: StBTofCalibMaker.h,v 1.16 2021/05/31 03:35:08 genevb Exp $ built " __DATE__ " " __TIME__ ; return cvs;}
