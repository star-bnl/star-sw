...
//_________________
StPicoHelix::StPicoHelix(const StPicoHelix &helix) {
  mSingularity = helix.mSingularity;
  mOrigin = helix.mOrigin;
  mDipAngle = helix.mDipAngle;
  mCurvature = helix.mCurvature;
  mPhase = helix.mPhase;
  mH = helix.mH;
  
  mCosDipAngle = helix.mCosDipAngle;
  mSinDipAngle = helix.mSinDipAngle;
  mCosPhase = helix.mCosPhase;
  mSinPhase = helix.mSinPhase;
}
