/***************************************************************************
 *
 * $Id: makeFgtPedAndStat.C,v 1.1 2013/02/10 14:51:29 akio Exp $
 ...
 * Revision 1.1  2013/02/10 14:51:29  akio
 * *** empty log message ***
 *
...
int makeFgtPedAndStat(const Char_t *filenameIn ="inputfile",
   ...
   if( !isCosmic ){
      ...
      dbMkr->SetDateTime(20121127,000000); 
   ...
   if( fout ){
      ...
      fout << "CVS Ids: "<< endl;
      fout << "\t$Id: makeFgtPedAndStat.C,v 1.1 2013/02/10 14:51:29 akio Exp $" << endl;
      if( fgtDbMkr )
