/***************************************************************************
 *
 * $Id: makeFgtPedAndStat.C,v 1.1 2012/01/31 08:56:43 sgliske Exp $
...
int makeFgtPedAndStat( const Char_t *filenameIn = "testfile.daq",
                       const Char_t *filenameOutbase = "testfile",
   ...
   if( fout ){
      ...
      fout << "CVS Ids: "<< endl;
      fout << "\t$Id: makeFgtPedAndStat.C,v 1.1 2012/01/31 08:56:43 sgliske Exp $" << endl;
      if( fgtDbMkr )
      ...
      std::string command("lynx -dump 'http://online.star.bnl.gov/RunLogRun12/index.php?r=13025001' | grep GMT");
