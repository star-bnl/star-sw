// Configuration to run pi0 reconstruction chain on the dAu2003 simulated data w/ 1/2 of SMD calibration spread.
{
    ...
    dataAnalysisSettings.CalibSpreadSMDE = 0.2 / 2.0;
    dataAnalysisSettings.CalibOffsetSMDE = 0.1 / 2.0;
    dataAnalysisSettings.CalibSpreadSMDP = 0.2 / 2.0;
    dataAnalysisSettings.CalibOffsetSMDP = 0.0 / 2.0;
