// Default configuration to run pi0 reconstruction chain.
{
    ...
    dataAnalysisSettings.saveCandidatesWithoutSMD = false;
    dataAnalysisSettings.saveCandidatesWithoutSMDBoth = false;
    ...
    dataAnalysisSettings.jetConeRadius = 0.7;
    dataAnalysisSettings.triggers[0] = 0;
    dataAnalysisSettings.triggersSim = 0;
    dataAnalysisSettings.triggersMB = 0;
    dataAnalysisSettings.triggersHT1 = 0;
    dataAnalysisSettings.triggersHT2 = 0;
    ...
    dataAnalysisSettings.triggerSimulatorName = "myTriggerSimulator";
    dataAnalysisSettings.triggerSimulatorNameEmbed = "myTriggerSimulatorEmbed";
    dataAnalysisSettings.triggerSimulatorNameFinal = "myTriggerSimulatorFinal";
    ...
    dataAnalysisSettings.jetFullMakerUse2003TowerCuts = false;
