...
void StGmtQAPlotter::Loop() {
  ...
  for (Long64_t jentry=0; jentry<nentries; jentry++) {
    ...
    b_EventT_fEvtHdr_fField->GetEntry(ientry);
    ...
    */
    ...
    for(Int_t iHit=0; iHit<fNhit; iHit++) {
      ...
      //Before cuts
      hUAdcD[8]->Fill(TMath::Log(fHits_uAdcD[iHit]));
      hVAdcD[8]->Fill(TMath::Log(fHits_vAdcD[iHit]));
      hDuAdcD[8]->Fill(fHits_duAdcD[iHit]);
      hDvAdcD[8]->Fill(fHits_dvAdcD[iHit]);
	...
	break;
      ...
      hUAdcD[fHits_barrel[iHit]]->Fill(TMath::Log(fHits_uAdcD[iHit]));
      hVAdcD[fHits_barrel[iHit]]->Fill(TMath::Log(fHits_vAdcD[iHit]));
      hDuAdcD[fHits_barrel[iHit]]->Fill(fHits_duAdcD[iHit]);
      hDvAdcD[fHits_barrel[iHit]]->Fill(fHits_dvAdcD[iHit]);
      ...
      hUAdcDVsVAdcDPassedCut[fHits_barrel[iHit]]->Fill(TMath::Log(fHits_vAdcD[iHit]),
						       TMath::Log(fHits_uAdcD[iHit]));
      hDuAdcDVsDvAdcDPassedCut[fHits_barrel[iHit]]->Fill(fHits_dvAdcD[iHit],
							 fHits_duAdcD[iHit]);
      hDvAdcDOverDuAdcDPassedCut[fHits_barrel[iHit]]->Fill(mDvAdcDOverDuAdcD);

      hUAdcDVsVAdcDPassedCut[8]->Fill(TMath::Log(fHits_vAdcD[iHit]),
				      TMath::Log(fHits_uAdcD[iHit]));
      hDuAdcDVsDvAdcDPassedCut[8]->Fill(fHits_dvAdcD[iHit],
					fHits_duAdcD[iHit]);
      hDvAdcDOverDuAdcDPassedCut[8]->Fill(mDvAdcDOverDuAdcD);
...
void StGmtQAPlotter::CreateCanvases() {
  ...
  //Before cuts
  cUAdcD = new TCanvas("cUAdcD","cUAdcD",mCanvSizeX,mCanvSizeY);
  cUAdcD->Divide(4,2,mPadSpaceX,mPadSpaceY);
  cVAdcD = new TCanvas("cVAdcD","cVAdcD",mCanvSizeX,mCanvSizeY);
  cVAdcD->Divide(4,2,mPadSpaceX,mPadSpaceY);
  cDuAdcD = new TCanvas("cDuAdcD","cDuAdcD",mCanvSizeX,mCanvSizeY);
  cDuAdcD->Divide(4,2,mPadSpaceX,mPadSpaceY);
  cDvAdcD = new TCanvas("cDvAdcD","cDvAdcD",mCanvSizeX,mCanvSizeY);
  cDvAdcD->Divide(4,2,mPadSpaceX,mPadSpaceY);
  cUAdcDVsVAdcDCanvas = new TCanvas("cUAdcDVsVAdcDCanvas",
				    "cUAdcDVsVAdcDCanvas",
				    mCanvSizeX,mCanvSizeY);
  cUAdcDVsVAdcDCanvas->Divide(4,2,mPadSpaceX,mPadSpaceY);
  cDuAdcDVsDvAdcDCanvas = new TCanvas("cDuAdcDVsDvAdcDCanvas",
				      "cDuAdcDVsDvAdcDCanvas",
				      mCanvSizeX,mCanvSizeY);
  cDuAdcDVsDvAdcDCanvas->Divide(4,2,mPadSpaceX,mPadSpaceY);
  cDvAdcDOverDuAdcDCanvas = new TCanvas("cDvAdcDOverDuAdcDCanvas",
					"cDvAdcDOverDuAdcDCanvas",
					mCanvSizeX,mCanvSizeY);
  cDvAdcDOverDuAdcDCanvas->Divide(4,2,mPadSpaceX,mPadSpaceY);

  //After cuts
  cUAdcDVsVAdcDPassedCutCanvas = 
    new TCanvas("cUAdcDVsVAdcDPassedCutCanvas",
		"cUAdcDVsVAdcDPassedCutCanvas",
		mCanvSizeX,mCanvSizeY);
  cUAdcDVsVAdcDPassedCutCanvas->Divide(4,2,mPadSpaceX,mPadSpaceY);
  cDuAdcDVsDvAdcDPassedCutCanvas = 
    new TCanvas("cDuAdcDVsDvAdcDPassedCutCanvas",
		"cDuAdcDVsDvAdcDPassedCutCanvas",
		mCanvSizeX,mCanvSizeY);
  cDuAdcDVsDvAdcDPassedCutCanvas->Divide(4,2,mPadSpaceX,mPadSpaceY);
  cDvAdcDOverDuAdcDPassedCutCanvas = 
    new TCanvas("cDvAdcDOverDuAdcDPassedCutCanvas",
		"cDvAdcDOverDuAdcDPassedCutCanvas",
		mCanvSizeX,mCanvSizeY);
  cDvAdcDOverDuAdcDPassedCutCanvas->Divide(4,2,mPadSpaceX,mPadSpaceY);
...
void StGmtQAPlotter::FillCanvases() {
  ...
  for(Int_t iModule=0; iModule<8; iModule++) {
    ...
    gPad->SetGrid(1);
    cDuAdcD->cd(iPad);
    hDuAdcD[iModule]->Draw();
    gPad->SetGrid(1);
    cDvAdcD->cd(iPad);
    hDvAdcD[iModule]->Draw();
    gPad->SetGrid(1);
    ...
    //After cuts
    cUAdcDVsVAdcDPassedCutCanvas->cd(iPad);
    hUAdcDVsVAdcDPassedCut[iModule]->Draw("colz");
    gPad->SetLogz(1);
    gPad->SetGrid();
    cDuAdcDVsDvAdcDPassedCutCanvas->cd(iPad);
    hDuAdcDVsDvAdcDPassedCut[iModule]->Draw("colz");
    gPad->SetLogz(1);
    gPad->SetGrid();
    cDvAdcDOverDuAdcDPassedCutCanvas->cd(iPad);
    hDvAdcDOverDuAdcDPassedCut[iModule]->Draw("colz");
    gPad->SetLogz(1);
    gPad->SetGrid();
...
void StGmtQAPlotter::WriteCanvases2File() {
  ...
  //After cuts
  cUAdcDVsVAdcDPassedCutCanvas->Write();
  cDuAdcDVsDvAdcDPassedCutCanvas->Write();
  cDvAdcDOverDuAdcDPassedCutCanvas->Write();
...
double* FitPtDependence(TH1* histo) {
  ...
  TF1* fNegFunc = new TF1("fNegFunc","[0]+[1]*x",-1.9,-0.2);
  TF1* fPosFunc = new TF1("fPosFunc","[0]+[1]*x",0.2,1.9);
