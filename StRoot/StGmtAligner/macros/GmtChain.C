...
void GmtChain(const Char_t *dirname, const Char_t *ext, const Char_t *oFileName="test") {
  ...
  oFile->Write();
  myPlotter.cUAdcD->Write();
  myPlotter.cVAdcD->Write();
  myPlotter.cDuAdcD->Write();
  myPlotter.cDvAdcD->Write();
  myPlotter.cUAdcDVsVAdcDCanvas->Write();
  myPlotter.cDuAdcDVsDvAdcDCanvas->Write();
  myPlotter.cDvAdcDOverDuAdcDCanvas->Write();

  myPlotter.cUAdcDVsVAdcDPassedCutCanvas->Write();
  myPlotter.cDuAdcDVsDvAdcDPassedCutCanvas->Write();
  myPlotter.cDvAdcDOverDuAdcDPassedCutCanvas->Write();
