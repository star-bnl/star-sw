...
const Int_t kMaxfTracks = 50000;
const Int_t kMaxfHits = 50000;
...
class StGmtQAPlotter {
 public :
  ...
  TH2F*  hUAdcDVsVAdcDPassedCut[9];
  TH2F*  hDuAdcDVsDvAdcDPassedCut[9];
  TH1F*  hDvAdcDOverDuAdcDPassedCut[9];
  ...
  TCanvas* cUAdcDVsVAdcDPassedCutCanvas;
  TCanvas* cDuAdcDVsDvAdcDPassedCutCanvas;
  TCanvas* cDvAdcDOverDuAdcDPassedCutCanvas;
...
void StGmtQAPlotter::CreateHistograms() {
  ...
  hFNhits->Sumw2();
   ...
   for(Int_t iModule=0; iModule<9; iModule++) {
    ...
    sName.Form("hUAdcD_%i",iModule);
    sTitle.Form("Log(uAdcD) for GMT module #%i;Log(uAdcD)",iModule);
    hUAdcD[iModule] = new TH1F(sName,sTitle,mLogUAdcDBins,mLogUAdcDMin,mLogUAdcDMax);
    hUAdcD[iModule]->Sumw2();
    sName.Form("hVAdcD_%i",iModule);
    sTitle.Form("Log(vAdcD) for GMT module #%i;Log(vAdcD)",iModule);
    hVAdcD[iModule] = new TH1F(sName,sTitle,mLogVAdcDBins,mLogVAdcDMin,mLogVAdcDMax);
    hVAdcD[iModule]->Sumw2();
    sName.Form("hDuAdcD_%i",iModule);
    sTitle.Form("duAdcD for GMT module #%i;duAdcD",iModule);
    hDuAdcD[iModule] = new TH1F(sName,sTitle,mDuAdcDBins,mDuAdcDMin,mDuAdcDMax);
    hDuAdcD[iModule]->Sumw2();
    sName.Form("hDvAdcD_%i",iModule);
    sTitle.Form("dvAdcD for GMT module #%i;dvAdcD",iModule);
    hDvAdcD[iModule] = new TH1F(sName,sTitle,mDvAdcDBins,mDvAdcDMin,mDvAdcDMax);
    hDvAdcD[iModule]->Sumw2();

    sName.Form("hUAdcDVsVAdcD_%i",iModule);
    sTitle.Form("Log(uAdcD) vs Log(vAdcD) for GMT module #%i;Log(vAdcD);Log(uAdcD)",iModule);;
    ...
    sTitle.Form("dvAdcD/duAdcD for GMT module #%i; dvAdcD/duAdcD",iModule);
    ...
    //After cuts
    sName.Form("hUAdcDVsVAdcDPassedCut_%i",iModule);
    sTitle.Form("After cuts: Log(uAdcD) vs Log(vAdcD) for GMT module #%i;Log(vAdcD);Log(uAdcD)",iModule);;
    hUAdcDVsVAdcDPassedCut[iModule] = new TH2F(sName,sTitle,
					       mLogVAdcDBins,mLogVAdcDMin,mLogVAdcDMax,
					       mLogUAdcDBins,mLogUAdcDMin,mLogUAdcDMax);
    hUAdcDVsVAdcDPassedCut[iModule]->Sumw2();
    sName.Form("hDuAdcDVsDvAdcDPassedCut_%i",iModule);
    sTitle.Form("After cuts: duAdcD vs dvAdcD for GMT module #%i;dvAdcD;duAdcD",iModule);
    hDuAdcDVsDvAdcDPassedCut[iModule] = new TH2F(sName,sTitle,
						 mDvAdcDBins,mDvAdcDMin,mDvAdcDMax,
						 mDuAdcDBins,mDuAdcDMin,mDuAdcDMax);
    hDuAdcDVsDvAdcDPassedCut[iModule]->Sumw2();
    sName.Form("hDvAdcDOverDuAdcDPassedCut_%i",iModule);
    sTitle.Form("After cuts: dvAdcD/duAdcD for GMT module #%i; dvAdcD/duAdcD",iModule);
    hDvAdcDOverDuAdcDPassedCut[iModule] = new TH1F(sName,sTitle,
						   mDvAdcDOverDuAdcDBins,mDvAdcDOverDuAdcDMin,mDvAdcDOverDuAdcDMax);
    hDvAdcDOverDuAdcDPassedCut[iModule]->Sumw2();	  
