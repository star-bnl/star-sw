...
void RunStiMaker2(Int_t, const Char_t **, const Char_t *qaflag = "");
...
void RunStiMaker2(Int_t nevents, const Char_t **fileList, const Char_t *qaflag, const Int_t wrStEOut)
{
...
void RunStiMaker2(const Int_t nevents, const Char_t *path, const Char_t *file,
		      const Char_t *qaflag, const Int_t wrStEOut)
{
    ...
    */
    ...
    RunStiMaker2(nevents,fileListQQ,qaflag,wrStEOut);
}
