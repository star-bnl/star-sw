...
protonstart.g:
--------------
line 42:	Particle type (6=muon, 14,15=proton, 11,12=kaon, 8,9=pion) differing in charge sign
...
5) root4star -b 'bfc.C(NEVENTS, "fzin evout mdc4 y2b","OUTPUT.fzd")'
   where NEVENTS is an integer that is an upperbound on the number of events to reconstruct
   and OUTPUT.fzd is a char* that must be identical to that given in line18 of proton.kumac
...
In the near future, I will add information on how to use MEVSIM, which is a simple event generator with much more flexibility.
