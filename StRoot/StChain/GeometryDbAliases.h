...
//{"y2007a",      20061105,     1, "y2007a",    "the material of the water channels is now carbon "}, // advertized simu 20061101
  ...
  {"dev2016",     20151215,     0, "y2016",    "y2016 development geometry, AgML,xgeometry"},
  ...
  {"devTA",       20170101,     1, "devTA",     "dev geo for Inner Tpc Sector Upgrade, Variant 1,xgeometry"}, // 
  {"devTB",       20170101,     2, "devTB",     "dev geo for Inner Tpc Sector Upgrade, Variant 2,xgeometry"}, // 
  {"devTC",       20170101,     3, "devTC",     "dev geo for Inner Tpc Sector Upgrade, Variant 3,xgeometry"}, // 
  {"devTD",       20170101,     4, "devTD",     "dev geo for Inner Tpc Sector Upgrade, Variant 4,xgeometry"}, // 
  {"devTE",       20170101,     5, "devTE",     "dev geo for Inner Tpc Sector Upgrade, Variant 5,xgeometry"}, // 
  {"devTF",       20170101,     6, "devTF",     "dev geo for Inner Tpc Sector Upgrade, Variant 5,xgeometry"}, // 
  {"devTX",       20170101,     7, "devTX",     "dev geo for Inner Tpc Sector Upgrade, Final Variant,xgeometry"}, // 
