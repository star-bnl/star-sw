 ...
 * \date   May 2007
 *
 * $Id: StPrepEmbedMaker.h,v 1.3.2.1 2011/07/26 20:39:52 didenko Exp $
 *
 *
 * -------------------------------------------------------------------------
 * $Log: StPrepEmbedMaker.h,v $
 * Revision 1.3.2.1  2011/07/26 20:39:52  didenko
...
class StPrepEmbedMaker : public StMaker {
 public:
  ...
  virtual const char *GetCVS() const {
    static const char cvs[]="Tag $Name:  $ $Id: StPrepEmbedMaker.h,v 1.3.2.1 2011/07/26 20:39:52 didenko Exp $ built "__DATE__" "__TIME__ ; 
    return cvs;
  }
