...
public:
  ...
  while((fOrigin[p]=Origin[p]) && p++<10);fOrigin[10]=0;}
   ...
   inline Float_t     GetPT() const {return TMath::Sqrt(fPx*fPx+fPy*fPy);}
   ...
   ClassDef(GParticle,1)  // LUJETS particles data record.
};
 
////////////////////////////////////////////////////////////////////////////////
 
inline
GParticle &GParticle::operator = (const GParticle &p)
{
  fKS                   = p.fKS;
  fKF                   = p.fKF;
  fParent               = p.fParent;
