// $Id: St_geom_Maker.cxx,v 1.9 1999/01/03 21:25:28 fisyak Exp $
// $Log: St_geom_Maker.cxx,v $
// Revision 1.9  1999/01/03 21:25:28  fisyak
...
St_geom_Maker::St_geom_Maker(const char *name, const char *title):StMaker(name,title){
   drawinit=kFALSE;
}
//_____________________________________________________________________________
...
void St_geom_Maker::PrintInfo(){
  printf("**************************************************************\n");
  printf("* $Id: St_geom_Maker.cxx,v 1.9 1999/01/03 21:25:28 fisyak Exp $\n");
//  printf("* %s    *\n",m_VersionCVS);
  printf("**************************************************************\n");
