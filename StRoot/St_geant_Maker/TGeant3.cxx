...
*         WEIGH - event weight                                            *
*/
R__EXTERN  void type_of_call rootmaptable_(DEFCHARD,DEFCHARD,DEFCHARD, Int_t&,Int_t * DEFCHARL DEFCHARL DEFCHARL);
R__EXTERN Int_t type_of_call agvolume(St_Node*&,Float_t*&,Float_t*&,Float_t*&,
...
//______________________________________________________________________________
void TGeant3::Geometry() {geometry();}
//______________________________________________________________________________
Int_t TGeant3::Agstroot() {return agstroot();}
//_____________________________________________________________________________
...
//_____________________________________________________________________________
void TGeant3::Gfxzrm(Int_t & Nlevel, 
...
//_____________________________________________________________________________
void TGeant3::Agnzgete (Int_t &ILK,Int_t &IDE,
...
#endif
//_____________________________________________________________________________
void TGeant3::Dzddiv(Int_t& idiv ,Int_t &Ldummy,const Char_t* path,const Char_t* opt,
...
//_____________________________________________________________________________
Int_t TGeant3::G2t_volume_id(const Char_t *name, Int_t *numbv){
  return g2t_volume_id(PASSCHARD(name),numbv PASSCHARL(name));
}
//_____________________________________________________________________________
Int_t TGeant3::Agvolume(St_Node *&node,Float_t *&par,Float_t *&pos,Float_t *&mot,
