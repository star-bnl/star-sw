/***************************************************************************
 *
 * $Id: StMuFgtCluster.h,v 1.1 2012/11/15 22:27:24 sangalin Exp $
...
class StMuFgtCluster : public TObject {
 public:
   // constructors
   StMuFgtCluster( Int_t centralStripGeoId = -1, Int_t firstStripAssociationIdx = -1, Int_t numStrips = 0, 
                   Float_t charge = 0, Float_t chargeUncert = 1000,
                   Float_t r = 0,      Float_t errR = 1e10,
                   Float_t phi = 0,    Float_t errPhi = 1e10 );
