/***************************************************************************
 *
 * $Id: StMuDstMaker.h,v 1.57 2013/04/10 19:28:35 jeromel Exp $
...
class StMuDstMaker : public StIOInterFace {
  ...
  */
  ...
  virtual const char *GetCVS() const {  ///< Returns version tag.
    ...
    static const char cvs[]="Tag $Name:  $ $Id: StMuDstMaker.h,v 1.57 2013/04/10 19:28:35 jeromel Exp $ built "__DATE__" "__TIME__ ;
    return cvs;
  }
