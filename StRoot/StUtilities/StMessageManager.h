...
// Info Messages:
   virtual St_ostrstream& Info(const char* mess="", const char* opt="O",const char *sourceFileName=0, int lineNumber=-1)
...
// Warning Messages:
   virtual St_ostrstream& Warning(const char* mess="", const char* opt="E",const char *sourceFileName=0, int lineNumber=-1)
...
// Error Messages:
   virtual St_ostrstream& Error(const char* mess="", const char* opt="E",const char *sourceFileName=0, int lineNumber=-1)
...
// Debug Messages:
   virtual St_ostrstream& Debug(const char* mess="", const char* opt="OT",const char *sourceFileName=0, int lineNumber=-1)
...
// QAInfo Messages:
   virtual St_ostrstream& QAInfo(const char* mess="", const char* opt="OS",const char *sourceFileName=0, int lineNumber=-1)
...
// UCMInfo Messages:
   virtual St_ostrstream& UCMInfo(const char* mess="", const char* opt="OS",const char *sourceFileName=0, int lineNumber=-1)
...
// Fatal Messages:
   virtual St_ostrstream& Fatal(const char* mess="", const char* opt="E",const char *sourceFileName=0, int lineNumber=-1)
   { return Message(mess, "E", opt,sourceFileName,lineNumber);}
