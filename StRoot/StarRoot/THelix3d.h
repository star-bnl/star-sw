...
enum THelix3dE {kU =0,kV =1, kFita =2 ,kLama =3,kPinv =4, kPhi = 2, kLam = 3};
...
TkDir_t        &operator=(const TkDir_t  &tkd)
                         {memcpy(mTkd[0],tkd[0],sizeof(mTkd)); return *this;}      
...
class THelix3d : public THelixTrack 
{
public:
...
static void ConvertErrs(const THelixTrack *he, const double Bz
