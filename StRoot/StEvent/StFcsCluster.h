...
/****************************************************************************
 *
 * $Id: StFcsCluster.h,v 1.4 2019/10/23 13:30:10 akio Exp $
 *
...
inline const StLorentzVectorF& StFcsCluster::fourMomentum() const { return mFourMomentum; } // Cluster four-momentum (px, py, pz, E)
...
inline void StFcsCluster::setFourMomentum(StLorentzVectorF p4) { mFourMomentum = p4; }
