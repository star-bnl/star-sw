...
%
% $Id: StEvent.tex,v 1.13 1999/03/30 18:54:15 genevb Exp $
%
...
% Revision 2.22  2000/03/02 12:40:40  ullrich
  ...
  {\LARGE $ $Date: 1999/03/30 18:54:15 $ $}  % replaced by cvs with current revision
...
\item[Related Classes]
    ...
    table entry.\index{dst_vertex.idl}
