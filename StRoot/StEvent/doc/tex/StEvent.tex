...
%
% $Id: StEvent.tex,v 2.5 1999/11/18 19:40:49 ullrich Exp $
%
...
% Define header and footer style
  {\LARGE $ $Revision: 2.5 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 1999/11/18 19:40:49 $ $}  % replaced by cvs with current revision
...
specified root directory (see doEvents.C for details). Example
        \includegraphics[width=0.5\textwidth]{run.eps}
...
the idea behind it and illustrate a few things in simple examples.  If
        \includegraphics[width=0.8\textwidth]{event.eps}
