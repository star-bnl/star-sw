...
%
% $Id: StEvent.tex,v 1.11 1999/03/25 22:10:54 ullrich Exp $
%
...
% Revision 2.22  2000/03/02 12:40:40  ullrich
  ...
  {\LARGE $ $Date: 1999/03/25 22:10:54 $ $}  % replaced by cvs with current revision
...
\item[Persistence]
    \index{event Id} Unique 64 bit event ID number. Since many
...
\item[Public\\ Constructors]
    ...
    the object to its actual type. This is illustrated in one of the
    ...
    Returns pointer to the trigger detector collection or a null pointer
...
\end{Entry}
unifications of the concepts and notations used in earlier models such
    \verb+Int_t operator!=(const StVertex&) const;+\\
\end{Entry}
\clearpage
certainly not of great use for the developer and user of HENP software
it provides one important component which gains more and more
importance: its notation, i.e., a set of rules on how to present
\appendix
