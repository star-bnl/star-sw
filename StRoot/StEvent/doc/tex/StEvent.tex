...
%
% $Id: StEvent.tex,v 2.30 2000/05/09 11:09:30 ullrich Exp $
%
...
\newcommand{\entrylabel}[1]{\mbox{\textbf{{#1}}}\hfil}%
  {\LARGE $ $Revision: 2.30 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/05/09 11:09:30 $ $}  % replaced by cvs with current revision
