...
%
% $Id: StEvent.tex,v 2.27 2000/04/10 19:59:34 genevb Exp $
%
...
\newcommand{\entrylabel}[1]{\mbox{\textbf{{#1}}}\hfil}%
  {\LARGE $ $Revision: 2.27 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/04/10 19:59:34 $ $}  % replaced by cvs with current revision
