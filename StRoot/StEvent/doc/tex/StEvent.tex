...
%
% $Id: StEvent.tex,v 2.17 2000/01/31 13:40:40 ullrich Exp $
%
...
% Define header and footer style
  {\LARGE $ $Revision: 2.17 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/01/31 13:40:40 $ $}  % replaced by cvs with current revision
...
\item[Description]
    \index{track quality flag}\index{iflag}
\item[Public\\ Constructors]
...
\item[Public Data\\ Member]
    ...
    This method (and the referring data member) is likely
