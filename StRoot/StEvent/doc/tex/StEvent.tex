...
%
% $Id: StEvent.tex,v 2.31 2000/05/16 13:22:39 ullrich Exp $
%
...
\newcommand{\entrylabel}[1]{\mbox{\textbf{{#1}}}\hfil}%
  {\LARGE $ $Revision: 2.31 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/05/16 13:22:39 $ $}  % replaced by cvs with current revision
