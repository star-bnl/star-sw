...
%
% $Id: StEvent.tex,v 2.1 1999/11/12 17:44:09 ullrich Exp $
%
...
% and added description of StPrimaryVertex::flag().
  {\LARGE $ $Revision: 2.1 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 1999/11/12 17:44:09 $ $}  % replaced by cvs with current revision
