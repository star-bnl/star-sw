...
%
% $Id: StEvent.tex,v 2.28 2000/04/20 13:31:25 ullrich Exp $
%
...
\newcommand{\entrylabel}[1]{\mbox{\textbf{{#1}}}\hfil}%
  {\LARGE $ $Revision: 2.28 $ $}  \\[5mm] % replaced by cvs with current revision
  {\LARGE $ $Date: 2000/04/20 13:31:25 $ $}  % replaced by cvs with current revision
...
\item[Description]
    ...
    \verb+UInt_t numberOfHits(StDetectorId) const;+\\
