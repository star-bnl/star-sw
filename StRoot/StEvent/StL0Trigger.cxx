/***************************************************************************
 *
 * $Id: StL0Trigger.cxx,v 1.4 1999/04/28 22:27:33 fisyak Exp $
 *
...
static const Char_t rcsid[] = "$Id: StL0Trigger.cxx,v 1.4 1999/04/28 22:27:33 fisyak Exp $";
#include "tables/dst_L0_Trigger.h"
#include <algorithm>
#include "StL0Trigger.h"
#include "tables/St_dst_L0_Trigger_Table.h"

static const char rcsid[] = "$Id: StL0Trigger.cxx,v 1.4 1999/04/28 22:27:33 fisyak Exp $";
