...
public:
    ...
    /// \param nMIP/nMIP_QT gain-calibrated signal from QT; energy loss in terms of MPV of Landau for a MIP
    ...
    StEpdHit(int position, int tile, short EW, int ADC, int TAC, int TDC, bool hasTAC, float nMIP_QT, bool statusIsGood, int truthId, unsigned short DEPdata = 0, float nMIP_DEP = 0);
