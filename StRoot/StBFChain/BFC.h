Bfc_st BFC[] = {
  ...
  {"StarMagField","", "","" ,"","StarMagField","Load StarMagField",kFALSE},
  ...
  {"EmcUtil" ,"" ,"","emc_T,geomT","" ,"StEmcUtil","Load StEmcUtil",kFALSE},
  ...
  {"RootVMC","","" ,"-geant,-fzin,-ntin,StarMagField,-geant,-geometry,-geomNoField","",
  ...
  {"McEvent" ,"","","Event,EEmcUtil,EmcUtil","StMcEventMaker" ,"StMcEvent,StMcEventMaker","",kFALSE},
  ...
  {"emcSim" ,"","emcY2","emc_T,EmcUtil","StEmcSimulatorMaker","StMcEvent,StEmcSimulatorMaker",
