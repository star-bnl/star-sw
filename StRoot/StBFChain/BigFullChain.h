...
Bfc_st BFC[] = { // standard chains
  ...
  {"P2025","" ,"",
   "B2025,ITTF,BAna,iTpcIT,VFMinuit,etofa,btof,mtd,l3onl,emcDY2,epdHit,trgd,ZDCvtx,analysis",
           "","",        "Base chain for year 2025 AA data - CorrY (+ l3, epd, mtd, b/etof, b-emc)",kFALSE},
