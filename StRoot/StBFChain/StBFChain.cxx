...
// @(#)StRoot/StBFChain:$Name:  $:$Id: StBFChain.cxx,v 1.216 2001/07/24 02:20:12 jeromel Exp $
//_____________________________________________________________________
#include "TROOT.h"
#include "TString.h"
...
Bfc_st BFC[] = {
  ...
  {"P2001"       ,""  ,"","ry2001,in,tpc_daq,tpc,rich,Cdst,Kalman,tags,Tree,evout,ExB","",""
                                         ,"Production chain for summer 2001 data (tpc, rich no trg)",kFALSE},
  {"P2001a"      ,""  ,"","ry2001,in,tpc_daq,tpc,rich,svt_daq,SvtD,emcY2,ftpc,Cdst,Kalman,tags,Tree,evout,ExB,NoHits","",""
