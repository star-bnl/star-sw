...
/*!
 ...
 @(#)StRoot/StBFChain:$Name:  $:$Id: StBFChain.h,v 1.56.2.1 2016/06/03 18:14:45 smirnovd Exp $
 ...
 public:
  ...
  void Setup(Int_t mode=1);
   ...
   virtual const char *GetCVS() const {
       static const char cvs[]="Tag $Name:  $ $Id: StBFChain.h,v 1.56.2.1 2016/06/03 18:14:45 smirnovd Exp $ built " __DATE__ " " __TIME__ ;
       return cvs;
   }
