...
class StMessMgr : public St_ostrstream {
...
public:
// Info Messages:
   virtual St_ostrstream& Info(const char* mess="", const char* opt="O",const char *sourceFileName=0, int lineNumber=-1)=0;
...
// Warning Messages:
   virtual St_ostrstream& Warning(const char* mess="", const char* opt="E",const char *sourceFileName=0, int lineNumber=-1)= 0;
...
// Error Messages:
   virtual St_ostrstream& Error(const char* mess="", const char* opt="E",const char *sourceFileName=0, int lineNumber=-1) = 0;
...
// Debug Messages:
   virtual St_ostrstream& Debug(const char* mess="", const char* opt="OT",const char *sourceFileName=0, int lineNumber=-1)= 0;
...
// QAInfo Messages:
   virtual St_ostrstream& QAInfo(const char* mess="", const char* opt="OS",const char *sourceFileName=0, int lineNumber=-1) = 0;
...
// UCMInfo Messages:
   virtual St_ostrstream& UCMInfo(const char* mess="", const char* opt="OS",const char *sourceFileName=0, int lineNumber=-1) = 0;
...
// "As is" Messages:
   virtual St_ostrstream& out(const char* mess="") = 0;
   virtual St_ostrstream& err(const char* mess="") = 0;

   virtual       void PrintInfo() =0;
   // Fatal Messages:
   virtual St_ostrstream& Fatal(const char* mess="", const char* opt="OT",const char *sourceFileName=0, int lineNumber=-1)= 0;
