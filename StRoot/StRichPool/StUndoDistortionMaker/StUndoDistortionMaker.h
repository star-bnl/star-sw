// $Id: StUndoDistortionMaker.h,v 1.1 2002/11/19 18:44:28 dunlop Exp $

#ifndef STAR_StUndoDistortionMaker
#define STAR_StUndoDistortionMaker

/*!
 *                                                                     
 * \class  StUndoDistortionMaker
 * \author fisyak
 * \date   1998/07/20
 ...
 *
 * 
 * StUndoDistortionMaker virtual base class for Maker                        
 * Template Maker doing nothing. See README file in StRoot/StUndoDistortionMaker
 *
 *
 */                                                                      
...
#endif
//class St_stk_stkpar;
class StGlobalTrackRefitter;
class StMagUtilities;

class StUndoDistortionMaker : public StMaker {
 private:
  // static Char_t  m_VersionCVS = "$Id: StUndoDistortionMaker.h,v 1.1 2002/11/19 18:44:28 dunlop Exp $";
    StGlobalTrackRefitter *mRefitter;
    StMagUtilities *m_ExB;
    
 protected:
 public: 
                  StUndoDistortionMaker(const char *name="undoDistortion");
   virtual       ~StUndoDistortionMaker();
   virtual Int_t Init();
   virtual Int_t  Make();
...
// virtual Int_t FinishRun(int runumber){return 0;}; // Overload empty StMaker::FinishRun 
   ...
   virtual const char *GetCVS() const {
     static const char cvs[]="Tag $Name:  $ $Id: StUndoDistortionMaker.h,v 1.1 2002/11/19 18:44:28 dunlop Exp $ built "__DATE__" "__TIME__ ; 
     return cvs;
   }

   ClassDef(StUndoDistortionMaker, 1)   //StAF chain virtual base class for Makers
};

#endif


// $Log: StUndoDistortionMaker.h,v $
