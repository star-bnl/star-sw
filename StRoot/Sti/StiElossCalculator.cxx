...
/*! Energy Loss Calculator Constructor
  <p>
  \param zOverA Effective Z over A ratio.
  \param ionization mean ionization potential 
*/
StiElossCalculator::StiElossCalculator(double zOverA, double ionization)
  : _zOverA(zOverA),
    _ionization2(ionization*ionization)
{}
