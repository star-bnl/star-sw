// $Id: StiELossTrak.cxx,v 2.1 2013/08/13 21:51:11 perev Exp $
//
//
// Class StiELossTrak
// ------------------
...
ClassImp(StiELossTrak)

//_____________________________________________________________________________
void StiELossTrak::Reset()
{
  memset(fBeg,0,fEnd-fBeg+1);
}
//_____________________________________________________________________________
void StiELossTrak::Clear(const char*)
{
  memset(fMed,0,fEnd-fMed+1);
}
//_____________________________________________________________________________
void StiELossTrak::Set(double A, double Z, double dens, double x0
...
//_____________________________________________________________________________
void StiELossTrak::Set(double p)
{
  fP = p;
  fdEdX=0;fdEdXErr2=0;
...
double StiELossTrak::ELoss(double l) const
{
  return fdEdX*l;
}
//______________________________________________________________________________
double StiELossTrak::ELossErr2(double l) const
{
  return fdEdXErr2*l;
}
//______________________________________________________________________________
//_____________________________________________________________________________
void StiELossTrak::Add(double len)
{
...
//_____________________________________________________________________________
double StiELossTrak::GetTheta2() const 
{
  assert(fFak>0);
  return fFak*fMCS[0];
}
//_____________________________________________________________________________
double StiELossTrak::GetOrt2() const 
{
  assert(fFak>0);
