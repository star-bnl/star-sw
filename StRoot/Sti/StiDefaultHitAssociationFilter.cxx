...
bool StiDefaultHitAssociationFilter::accept(const StiHit * h1,const StiHit * h2) const
{
  double dy = h1->y()- h2->y();
  double dz = h1->z()- h2->z();
  return h1->position()==h2->position() && h1->refangle()==h2->refangle()&&sqrt(dy*dy+dz*dz)<_maxDistance;
}
