...
/// This is a temp hack to accomadate for nodes that have inconsistent detector and fX values
bool StiKTNXLessThan::operator()(const StiKalmanTrackNode& lhs, const StiKalmanTrackNode& rhs) const
{
    //should be: return lhs.fx < rhs.fX;
    return lhs.getDetector()->getPlacement()->getCenterRadius() < rhs.fX;
}
