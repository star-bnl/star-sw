...
void StiTPCCATrackerInterface::RunPerformance()
{
...
#if 1
  const int printTime = 3; // 0 - show nothing; 1 - show averege; 2 - show cur event; 3 - show both
  ...
  if ((printTime == 1) || (printTime == 3)){
    ...
    std::cout << "Total (sector+merge) average reconstuction time" 
              ...
              << std::endl;
    std::cout << "Average preparation time"
