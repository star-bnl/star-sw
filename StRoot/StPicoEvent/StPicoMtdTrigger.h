...
inline void StPicoMtdTrigger::setShouldHaveRejectEvent(Int_t val) { mShouldHaveRejectEvent = (Char_t)val; }
inline void StPicoMtdTrigger::setShouldHaveRejectEvent(Char_t val) { mShouldHaveRejectEvent = val; }
