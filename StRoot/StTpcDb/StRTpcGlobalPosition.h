/***************************************************************************
 *
 * $Id: StRTpcGlobalPosition.h,v 1.1 2001/05/21 23:26:08 hardtke Exp $
 *
...
inline double  StRTpcGlobalPosition::TpcRotationAroundGlobalAxisX() const { return (*mGlobalPosition)[0].PhiYZ;}

inline double  StRTpcGlobalPosition::TpcRotationAroundGlobalAxisY() const { return (*mGlobalPosition)[0].PhiXZ;}

inline double  StRTpcGlobalPosition::TpcRotationAroundGlobalAxisZ() const { return (*mGlobalPosition)[0].PhiXY;}
