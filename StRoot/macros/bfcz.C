// $Id: bfcz.C,v 1.21 1999/05/14 00:11:28 fisyak Exp $
// $Log: bfcz.C,v $
// Revision 1.21  1999/05/14 00:11:28  fisyak
// Fix missing endf
//
// Revision 1.20  1999/05/12 15:52:38  didenko
// removed nonneeded macro
//
// Revision 1.19  1999/05/06 03:14:38  fisyak
// old template for bfc
//
...
#endif /* TSS or TRS */
#ifdef TPC
  treeMk->IntoBranch("tpc_hitsBranch","tpc_hits/.data");
  treeMk->IntoBranch("tpc_tracksBranch","tpc_tracks/.data");
#endif /* TPC */
#ifdef FSS
...
//  treeMk->SetInput(".default","Others");
  ...
  // Create HTML docs of all Maker's 
  //  chain->MakeDoc();
  chain->PrintInfo();
