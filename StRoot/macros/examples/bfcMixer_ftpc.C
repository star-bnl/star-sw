...
// Owner:  Yuri Fisyak
//
// $Id: bfcMixer_ftpc.C,v 1.1 2003/03/19 19:45:48 hjort Exp $
//
//////////////////////////////////////////////////////////////////////////
...
//_____________________________________________________________________
void bfcMixer_ftpc(const Int_t Nevents=2,
	      const Char_t *file1 = "/star/xtp/jcs/st_physics_4036002_raw_0040001.daq",
	      const Char_t *file2="/star/u/fsimon/CreateEmbedding/embedding_4036002_raw_0040001.fzd",
             const Char_t *file3= "/star/u/fsimon/CreateEmbedding/st_physics_4036002_raw_0040001.vertices.dat",
             ...
             const Char_t *acc_mode="off" )
{
  ...
  saveMk = chain2->cd();
  chain2->SetFlags("fzin gen_T geomT sim_T tpc trs -tcl -tpt -PreVtx -tpc_daq ftpcT fss");   //
  //chain2->SetFlags("fzin gen_T geomT sim_T ftpcT fss");   //
 ...
 // mixer->writeFile("mixer.trs",Nevents);
  ...
  saveMk = chain3->cd();
  chain3->SetFlags("Simu NoDefault NoInput DbV20030307 db tpc_daq tpc ftpc global Cdst Kalman event qa Tree GeantOut EvOut");
  //chain3->SetFlags("Simu NoDefault NoInput DbV20020226 db tpc_daq tpc ftpc global dst Kalman event qa Tree GeantOut EvOut");
  //chain3->SetFlags("Simu NoDefault NoInput db ftpc global event qa Tree GeantOut EvOut");
 ...
 EventLoop: if (i <= Nevents && iMake != kStEOF && iMake != kStFatal) {
  ...
  //vtxMk->FixVertex(x,y,z);
   cout<<"force the vertex position to match"<<endl;
