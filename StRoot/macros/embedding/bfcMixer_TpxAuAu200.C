...
void bfcMixer_TpxAuAu200(const Int_t Nevents=100,
		  const Char_t *daqfile="/star/rcf/test/daq/2010/embed/auau200_prod/st_physics_adc_11035021_raw_4420002.daq",
		  const Char_t *tagfile="/star/rcf/test/daq/2010/embed/auau200_prod/st_physics_adc_11035021_raw_4420002.tags.root",
		  ...
		  const Double_t mult=100,
                  ...
                  const Char_t *prodName = "P10ihAuAu200",
...
//  TString prodP08icdAu("DbV20080712 P2008 ITTF OSpaceZ2 OGridLeak3D beamLine, VFMCE TpxClu -VFMinuit -hitfilt");
  ...
  TString prodP10ihAuAu200("DbV20101106 P2010a,btof,BEmcChkStat,Corr4,OSpaceZ2,OGridLeak3D,VFMCE TpxClu -VFMinuit -hitfilt");
...
//  TString chain2Opt("NoInput,PrepEmbed,gen_T,geomT,sim_T,trs,-ittf,-tpc_daq,nodefault");
  ...
  else if (prodName == "P10ihAuAu200")   { chain3Opt = prodP10ihAuAu200;    chain2Opt += geomP10ih; }
  else {
  ...
  else if (prodName == "P10ihAuAu200")   { chain3Opt += geomP10ih; }
  else {
    cout << "Choice prodName " << prodName << " does not correspond to known chain. Processing impossible. " << endl;
    return;
  }
