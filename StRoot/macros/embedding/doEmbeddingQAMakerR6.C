  ...
  #pragma cling load("StUtilities");        // new addition 22jul99
  #pragma cling load("StTreeMaker");
  #pragma cling load("StIOMaker");
  #pragma cling load("StarClassLibrary");
  #pragma cling load("StTriggerDataMaker"); // new starting from April 2003
  ...
  #pragma cling load("StMiniMcEvent");
  #pragma cling load("StEmbeddingUtilities");

//______________________________________________________________________
void doEmbeddingQAMakerR6(
  ...
  //
  auto* utility = StEmbeddingQAUtilities::instance() ;
...
void doEmbeddingQA(
  ...
  doEmbeddingQAMakerR6(year, production, inputFileList, "", kTRUE);
}
...
void doRealDataQA(
  ...
  doEmbeddingQAMakerR6(year, production, inputFileList, "", kFALSE);
}
