...
// Owner:  Yuri Fisyak
//
// $Id: bfcMixer_TpcSvt.C,v 1.7 2013/04/28 14:41:31 fisyak Exp $
//
//////////////////////////////////////////////////////////////////////////
...
void bfcMixer_TpcSvt(const Int_t Nevents=100,Int_t isSvtIn=1, Int_t isSsdIn=0,
  ...
  TString prodP07ib("P2005b DbV20070518 MakeEvent ITTF Iana ssddat spt SsdIt SvtIt pmdRaw SCEbyE OGridLeak OShortR OSpaceZ2");// KeepSvtHit hitfilt skip1row");
