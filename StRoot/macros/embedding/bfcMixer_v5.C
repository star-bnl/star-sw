...
// Owner:  Yuri Fisyak
//
// $Id: bfcMixer_v5.C,v 1.1 2011/01/18 05:49:18 hmasui Exp $
// $Log: bfcMixer_v5.C,v $
		 ...
		 )
{
  ...
  // tested with SL06g
  chain3->SetFlags("Simu NoDefault NoInput onlraw -onlcl DbV20050515 ry2005d tpc_daq tpc ftpc event cdst Kalman Tree evout useCDV Xi2 V02 Kink2 CMuDst analysis MiniMcMk");
