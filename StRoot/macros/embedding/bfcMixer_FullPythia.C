...
// Owner:  Yuri Fisyak
//
// $Id: bfcMixer_FullPythia.C,v 1.3 2013/04/28 14:41:31 fisyak Exp $
//
//////////////////////////////////////////////////////////////////////////
...
//_____________________________________________________________________
void bfcMixer_FullPythia(const Int_t Nevents=10,
		 const Char_t *file1="/star/institutions/uky/rfatemi/AuAu62/st_physics_5086073_raw_3020008.daq",
		 const Char_t *file2="/star/institutions/bnl/fisyak/bug1970/evgen.1.nt"
#if 0
		 ...
		 )
{
  ...
  saveMk = chain2->cd();
  chain2->SetFlags("ntin DbV20050515 gen_T geomT sim_T tpc trs -tcl -tpt -PreVtx -tpc_daq");   // 
  ...
  // tested with SL06g
  chain3->SetFlags("TpcMixer Simu NoDefault NoInput onlraw -onlcl DbV20050515 ry2005d tpc_daq tpc event cdst Kalman Tree evout useCDV Xi2 V02 Kink2 CMuDst analysis MiniMcMk");
