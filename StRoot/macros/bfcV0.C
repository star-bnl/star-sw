...
//TString defChain("y2011,gstar,TpcRS,TpxClu,bbcSim,btofsim,emcY2,EEfs,pmdSim,IdTruth,MakeEvent,VFMinuit,ITTF,NosvtIT,NossdIT,analysis,BTofIT,KFVertex");//,corr4,KFVertex,sdt20100107.110000");
//TString defChain("MC.y2012a,sdt20120319,gstar,StiCA,KFVertex,BEmcChkStat,btof,fmsSim,emcSim,EEss,eemcA2E,Corr4,OSpaceZ2,OGridLeak3D,-hitfilt");//,corr4,KFVertex,sdt20100107.110000");
//TString defChain("MC.y2012a,gstar,StiCA,KFVertex,BEmcChkStat,btof,fmsSim,emcSim,EEss,Corr4,OSpaceZ2,OGridLeak3D,-hitfilt");//eemcA2E,,sdt20100107.110000");
//TString defChain("MC.y2012a,gstar,StiCA,KFVertex,xgeometry");//eemcA2E,,sdt20100107.110000");
//TString defChain("MC.y2012a,gstar,StiVMC");//,KFVertex");//eemcA2E,,sdt20100107.110000");
//TString defChain("MC.y2012a,gstar,StiCA,KFVertex,-hitfilt");//eemcA2E,,sdt20100107.110000");
//TString defChain("MC.y2013,pythia,StiCA,-hitfilt,KFVertex,beamline");//eemcA2E,,sdt20100107.110000"); ,KFVertex
//TString defChain("MC.y2012a,gstar,StiCA,-hitfilt,KFVertex,beamline,sdt20120408.134653,Corr4,OSpaceZ2,OGridLeak3D");//eemcA2E,,sdt20100107.110000");
...
//TString defChain("MC.y2014,AgML,pythia,StiCA,-hitfilt,KFVertex,Corr4,OSpaceZ2,OGridLeak3D");//eemcA2E,,sdt20100107.110000");
//TString defChain("MC.y2014,AgML,pythia,StiCA,-hitfilt,KFVertex,Corr4,OSpaceZ2,OGridLeak3D,StiHftC,pxlFastSim,ssdfast");//eemcA2E,,sdt20100107.110000");
//TString defChain("MC.y2014,pythia,StiCA,-hitfilt,KFVertex,Corr4,OSpaceZ2,OGridLeak3D,StiHftC,pxlFastSim,ssdfast,AgML,useXgeom");//eemcA2E,,sdt20100107.110000");
//TString defChain("MC.y2014,pythia,StiCA,-hitfilt,KFVertex,Corr4,OSpaceZ2,OGridLeak3D,StiHftC,pxlFastSim,ssdfast,useXgeom");//eemcA2E,,sdt20100107.110000");
...
//TString defChain("MC.y2012,PythiaPP200,tfs,StiCA,KFVertex,-hitfilt,useXgeom,beamline,evout,GeantOut,CmuDst");//eemcA2E,,sdt20100107.110000");
//TString defChain("MC.y2012,tfs,StiCA,KFVertex,-hitfilt,useXgeom,beamline");//eemcA2E,,sdt20100107.110000");
//TString defChain("MC.y2012,gstar,tfs,StiCA,KFVertex,-hitfilt,useXgeom");//eemcA2E,,sdt20100107.110000");
TString defChain("MC.2014,PythiaPP200HFT,TpcRS,StiCA,KFVertex,beamline,-hitfilt,useXgeom,pxlFastSim,IstSim");
void bfcV0(Int_t First, Int_t Last,const Char_t *Chain = defChain + ",Display",
...
void bfcV0(Int_t Last, const Char_t *Chain = defChain,
	 const Char_t *infile=0, const Char_t *outfile=0, const Char_t *TreeFile=0);
...
//#endif /* __V0Filter__ */
//_____________________________________________________________________
void bfcV0(Int_t First, Int_t Last,
	 const Char_t *Chain,
	 const Char_t *infile,
...
//_____________________________________________________________________
void bfcV0(Int_t Last, 
	 const Char_t *Chain,
	 const Char_t *infile, 
	 const Char_t *outfile, 
	 const Char_t *TreeFile) {
  bfcV0(1,Last,Chain,infile,outfile,TreeFile);
}
//____________________________________________________________
void Usage() {
  printf ("============= \t U S A G E =============\n");
  printf ("bfcV0(Int_t First,Int_t Last,const Char_t *Chain,const Char_t *infile,const Char_t *outfile,const Char_t *TreeFile)\n");
  printf ("bfcV0(Int_t Last,const Char_t *Chain,const Char_t *infile,const Char_t *outfile,const Char_t *TreeFile)\n");
  printf ("bfcV0(const Char_t *ChainShort,Int_t Last,const Char_t *infile,const Char_t *outfile)\n");
  printf ("where\n");
...
//_____________________________________________________________________
void bfcV0(const Char_t *Chain="ittf") {
  bfcV0(-2,Chain);
}
