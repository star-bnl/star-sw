...
#if 0
//________________________________________________________________________________
void DrawSummary(const Char_t *Tag = "Hist114") {
  struct Cell_t {
    const Char_t *Names[7];
    Int_t type;
  }
  Cell_t Cells[10] = {// 5x?
    {{"BarPressure",         "inputTPCGasPressure","nitrogenPressure","gasPressureDiff","inputGasTemperature","",""},  0},
    {{"outputGasTemperature","flowRateArgon1",     "flowRateArgon2",  "flowRateMethane","percentMethaneIn","",""},     0},
    {{"ppmOxygenIn",         "flowRateExhaust",    "ppmWaterOut",      "ppmOxygenOut",  "flowRateRecirculation","",""},0},
    {{"Zdc",                 "ZdcC",               "Multiplicity",     "BBC",           "L0","",""},                   0},
    {{"Z3",                  "Z3A",                "Z3C",              "Z3O",           "Z3OA","",""},                 0},
    {{"Z3OC",                "Z3OW",               "Z3OWA",            "Z3OWC",         "ZdcCP","",""},                0},
    {{"BBCP",                "L0P",                "bbcYellowBkg",     "bbcBlueBkg",    "","",""},                     0},
    {{"MulRow",              "MulRowC",            "ETA",              "ETA3",          "","",""},                     0},
    {{"MultiplicityPI",      "MultiplicityPO",     "",                 "",              "","",""},                     0},
    {{"Phi3",                "Phi3D",              "Theta3D",          "PointsB",       "","",""},                     0},
    {{"SecRow3",             "SecRow3C",           "SecRow3A",         "",              "","",""},                     0},
    {{"TPointsB",            "TPoints70B",         "TPointsBU",       "TPoints70BU",    "TPoints70BA","",""},             0},
//     {{"TPointsB01",          "TPoints70B01",       "TPointsBU01",     "TPoints70BU01",  "TPoints70BA01","",""},           0},
//     {{"TPointsB02",          "TPoints70B02",       "TPointsBU02",     "TPoints70BU02",  "TPoints70BA02","",""},           0},
//     {{"TPointsB03",          "TPoints70B03",       "TPointsBU03",     "TPoints70BU03",  "TPoints70BA03","",""},           0},
//     {{"TPointsB04",          "TPoints70B04",       "TPointsBU04",     "TPoints70BU04",  "TPoints70BA04","",""},           0},
//     {{"TPointsB05",          "TPoints70B05",       "TPointsBU05",     "TPoints70BU05",  "TPoints70BA05","",""},           0},
//     {{"TPointsB06",          "TPoints70B06",       "TPointsBU06",     "TPoints70BU06",  "TPoints70BA06","",""},           0},
//     {{"TPointsB07",          "TPoints70B07",       "TPointsBU07",     "TPoints70BU07",  "TPoints70BA07","",""},           0},
//     {{"TPointsB08",          "TPoints70B08",       "TPointsBU08",     "TPoints70BU08",  "TPoints70BA08","",""},           0},
//     {{"TPointsB09",          "TPoints70B09",       "TPointsBU09",     "TPoints70BU09",  "TPoints70BA09","",""},           0},
//     {{"TPointsB10",          "TPoints70B10",       "TPointsBU10",     "TPoints70BU10",  "TPoints70BA10","",""},           0},
//     {{"TPointsB11",          "TPoints71B11",       "TPointsBU11",     "TPoints71BU11",  "TPoints71BA11","",""},           0},
//     {{"TPointsB12",          "TPoints71B12",       "TPointsBU12",     "TPoints71BU12",  "TPoints71BA12","",""},           0},
//     {{"TPointsB13",          "TPoints71B13",       "TPointsBU13",     "TPoints71BU13",  "TPoints71BA13","",""},           0},
//     {{"TPointsB14",          "TPoints71B14",       "TPointsBU14",     "TPoints71BU14",  "TPoints71BA14","",""},           0},
//     {{"TPointsB15",          "TPoints71B15",       "TPointsBU15",     "TPoints71BU15",  "TPoints71BA15","",""},           0},
//     {{"TPointsB16",          "TPoints71B16",       "TPointsBU16",     "TPoints71BU16",  "TPoints71BA16","",""},           0},
//     {{"TPointsB17",          "TPoints71B17",       "TPointsBU17",     "TPoints71BU17",  "TPoints71BA17","",""},           0},
//     {{"TPointsB18",          "TPoints71B18",       "TPointsBU18",     "TPoints71BU18",  "TPoints71BA18","",""},           0},
//     {{"TPointsB19",          "TPoints71B19",       "TPointsBU19",     "TPoints71BU19",  "TPoints71BA19","",""},           0},
//     {{"TPointsB20",          "TPoints70B20",       "TPointsBU20",     "TPoints70BU20",  "TPoints70BA20","",""},           0},
//     {{"TPointsB21",          "TPoints71B21",       "TPointsBU21",     "TPoints71BU21",  "TPoints71BA21","",""},           0},
//     {{"TPointsB22",          "TPoints71B22",       "TPointsBU22",     "TPoints71BU22",  "TPoints71BA22","",""},           0},
//     {{"TPointsB23",          "TPoints71B23",       "TPointsBU23",     "TPoints71BU23",  "TPoints71BA23","",""},           0},
//     {{"TPointsB24",          "TPoints71B24",       "TPointsBU24",     "TPoints71BU24",  "TPoints71BA24","",""},           0},
    {{"MPointsB",            "MPoints70B",         "MPointsBU",       "MPoints70BU",    "MPoints70BA","",""},             0},
//     {{"MPointsB01",          "MPoints70B01",       "MPointsBU01",     "MPoints70BU01",  "MPoints70BA01","",""},           0},
//     {{"MPointsB02",          "MPoints70B02",       "MPointsBU02",     "MPoints70BU02",  "MPoints70BA02","",""},           0},
//     {{"MPointsB03",          "MPoints70B03",       "MPointsBU03",     "MPoints70BU03",  "MPoints70BA03","",""},           0},
//     {{"MPointsB04",          "MPoints70B04",       "MPointsBU04",     "MPoints70BU04",  "MPoints70BA04","",""},           0},
//     {{"MPointsB05",          "MPoints70B05",       "MPointsBU05",     "MPoints70BU05",  "MPoints70BA05","",""},           0},
//     {{"MPointsB06",          "MPoints70B06",       "MPointsBU06",     "MPoints70BU06",  "MPoints70BA06","",""},           0},
//     {{"MPointsB07",          "MPoints70B07",       "MPointsBU07",     "MPoints70BU07",  "MPoints70BA07","",""},           0},
//     {{"MPointsB08",          "MPoints70B08",       "MPointsBU08",     "MPoints70BU08",  "MPoints70BA08","",""},           0},
//     {{"MPointsB09",          "MPoints70B09",       "MPointsBU09",     "MPoints70BU09",  "MPoints70BA09","",""},           0},
//     {{"MPointsB10",          "MPoints70B10",       "MPointsBU10",     "MPoints70BU10",  "MPoints70BA10","",""},           0},
//     {{"MPointsB11",          "MPoints71B11",       "MPointsBU11",     "MPoints71BU11",  "MPoints71BA11","",""},           0},
//     {{"MPointsB12",          "MPoints71B12",       "MPointsBU12",     "MPoints71BU12",  "MPoints71BA12","",""},           0},
//     {{"MPointsB13",          "MPoints71B13",       "MPointsBU13",     "MPoints71BU13",  "MPoints71BA13","",""},           0},
//     {{"MPointsB14",          "MPoints71B14",       "MPointsBU14",     "MPoints71BU14",  "MPoints71BA14","",""},           0},
//     {{"MPointsB15",          "MPoints71B15",       "MPointsBU15",     "MPoints71BU15",  "MPoints71BA15","",""},           0},
//     {{"MPointsB16",          "MPoints71B16",       "MPointsBU16",     "MPoints71BU16",  "MPoints71BA16","",""},           0},
//     {{"MPointsB17",          "MPoints71B17",       "MPointsBU17",     "MPoints71BU17",  "MPoints71BA17","",""},           0},
//     {{"MPointsB18",          "MPoints71B18",       "MPointsBU18",     "MPoints71BU18",  "MPoints71BA18","",""},           0},
//     {{"MPointsB19",          "MPoints71B19",       "MPointsBU19",     "MPoints71BU19",  "MPoints71BA19","",""},           0},
//     {{"MPointsB20",          "MPoints70B20",       "MPointsBU20",     "MPoints70BU20",  "MPoints70BA20","",""},           0},
//     {{"MPointsB21",          "MPoints71B21",       "MPointsBU21",     "MPoints71BU21",  "MPoints71BA21","",""},           0},
//     {{"MPointsB22",          "MPoints71B22",       "MPointsBU22",     "MPoints71BU22",  "MPoints71BA22","",""},           0},
//     {{"MPointsB23",          "MPoints71B23",       "MPointsBU23",     "MPoints71BU23",  "MPoints71BA23","",""},           0},
//     {{"MPointsB24",          "MPoints71B24",       "MPointsBU24",     "MPoints71BU24",  "MPoints71BA24","",""},           0},
    {{"PointsB",            "Points70B",         "PointsBU",       "Points70BU",    "Points70BA","",""},             0},
//     {{"PointsB01",          "Points70B01",       "PointsBU01",     "Points70BU01",  "Points70BA01","",""},           0},
//     {{"PointsB02",          "Points70B02",       "PointsBU02",     "Points70BU02",  "Points70BA02","",""},           0},
//     {{"PointsB03",          "Points70B03",       "PointsBU03",     "Points70BU03",  "Points70BA03","",""},           0},
//     {{"PointsB04",          "Points70B04",       "PointsBU04",     "Points70BU04",  "Points70BA04","",""},           0},
//     {{"PointsB05",          "Points70B05",       "PointsBU05",     "Points70BU05",  "Points70BA05","",""},           0},
//     {{"PointsB06",          "Points70B06",       "PointsBU06",     "Points70BU06",  "Points70BA06","",""},           0},
//     {{"PointsB07",          "Points70B07",       "PointsBU07",     "Points70BU07",  "Points70BA07","",""},           0},
//     {{"PointsB08",          "Points70B08",       "PointsBU08",     "Points70BU08",  "Points70BA08","",""},           0},
//     {{"PointsB09",          "Points70B09",       "PointsBU09",     "Points70BU09",  "Points70BA09","",""},           0},
//     {{"PointsB10",          "Points70B10",       "PointsBU10",     "Points70BU10",  "Points70BA10","",""},           0},
//     {{"PointsB11",          "Points71B11",       "PointsBU11",     "Points71BU11",  "Points71BA11","",""},           0},
//     {{"PointsB12",          "Points71B12",       "PointsBU12",     "Points71BU12",  "Points71BA12","",""},           0},
//     {{"PointsB13",          "Points71B13",       "PointsBU13",     "Points71BU13",  "Points71BA13","",""},           0},
//     {{"PointsB14",          "Points71B14",       "PointsBU14",     "Points71BU14",  "Points71BA14","",""},           0},
//     {{"PointsB15",          "Points71B15",       "PointsBU15",     "Points71BU15",  "Points71BA15","",""},           0},
//     {{"PointsB16",          "Points71B16",       "PointsBU16",     "Points71BU16",  "Points71BA16","",""},           0},
//     {{"PointsB17",          "Points71B17",       "PointsBU17",     "Points71BU17",  "Points71BA17","",""},           0},
//     {{"PointsB18",          "Points71B18",       "PointsBU18",     "Points71BU18",  "Points71BA18","",""},           0},
//     {{"PointsB19",          "Points71B19",       "PointsBU19",     "Points71BU19",  "Points71BA19","",""},           0},
//     {{"PointsB20",          "Points70B20",       "PointsBU20",     "Points70BU20",  "Points70BA20","",""},           0},
//     {{"PointsB21",          "Points71B21",       "PointsBU21",     "Points71BU21",  "Points71BA21","",""},           0},
//     {{"PointsB22",          "Points71B22",       "PointsBU22",     "Points71BU22",  "Points71BA22","",""},           0},
//     {{"PointsB23",          "Points71B23",       "PointsBU23",     "Points71BU23",  "Points71BA23","",""},           0},
//     {{"PointsB24",          "Points71B24",       "PointsBU24",     "Points71BU24",  "Points71BA24","",""},           0},
    {{"fite",  "fitproton",   "fitkaon",   "fitpi",  "fitmu",  "fitdeuteron",  "fittriton"      }, 0},
    {{"fitPe", "fitPproton"   "fitPkaon",  "fitPpi", "fitPmu", "fitPdeuteron"  "fitPtriton"     }, 0},
    {{"eP70",  "protonP70",   "kaonP70",   "piP70",  "muP70",  "deuteronP70",  "tritonP70"      }, 0},
    {{"eP70B", "protonP70B",  "kaonP70B",  "piP70B", "muP70B", "deuteronP70B"  "tritonP70B"     }, 0},
    {{"eP70BT","protonP70BT", "kaonP70BT", "piP70BT","muP70BT","deuteronP70BT","tritonP70BT"    }, 0},
    {{"ePz",   "protonPz",    "kaonPz",    "piPz",   "muPz",   "deuteronPz",   "tritonPz"       }, 0},
    {{"ePzB",  "protonPzB",   "kaonPzB",   "piPzB",  "muPzB",  "deuteronPzB",  "tritonPzB"      }, 0},
    {{"ePzBT", "protonPzBT",  "kaonPzBT",  "piPzBT", "muPzBT", "deuteronPzBT", "tritonPzBT"     }, 0},
    {{"ePB",   "protonPB",    "kaonPB",    "piPB",   "muPB",   "deuteronPB",   "tritonPB",      }, 0},
    {{"ePBB",  "protonPBB",   "kaonPBB",   "piPBB",  "muPBB",  "deuteronPBB",  "tritonPBB",     }, 0},
    {{"eN70",  "protonN70",   "kaonN70",   "piN70",  "muN70",  "deuteronN70",  "tritonN70"      }, 0},
    {{"eN70B", "protonN70B",  "kaonN70B",  "piN70B", "muN70B", "deuteronN70B", "tritonN70B"     }, 0},
    {{"eN70BT","protonN70BT", "kaonN70BT", "piN70BT" "muN70BT","deuteronN70BT","tritonN70BT"    }, 0},
    {{"eNz",   "protonNz",    "kaonNz",    "piNz",   "muNz",   "deuteronNz",   "tritonNz"       }, 0},
    {{"eNzB",  "protonNzB",   "kaonNzB",   "piNzB",  "muNzB",  "deuteronNzB",  "tritonNzB"      }, 0},
    {{"eNzBT", "protonNzBT",  "kaonNzBT",  "piNzBT", "muNzBT", "deuteronNzBT", "tritonNzBT"     }, 0},
    {{"eNB",   "protonNB",    "kaonNB",    "piNB",   "muNB",   "deuteronNB",   "tritonNB"       }, 0},
    {{"eNBB",  "protonNBB",   "kaonNBB",   "piNBB",  "muNBB",  "deuteronNBB",  "tritonNBB"      }, 0},
    {{"Pressure","PressureA","PressureC","PressureT","PressureTA","PressureTC",""},                0},
    {{"inputTPCGasPressureP","nitrogenPressureP","gasPressureDiffP","inputGasTemperatureP","outputGasTemperatureP","flowRateArgon1P","flowRateArgon2P"}, 0},
    {{"flowRateMethaneP","percentMethaneInP","percentMethaneInPC","percentMethaneInPA","ppmOxygenInP","flowRateExhaustP","ppmWaterOutP"}, 0},
    {{"ppmWaterOutPC","ppmWaterOutPA","ppmOxygenOutP","flowRateRecirculationP","Time","TimeC","TimeP"}, 0};
    {{"FitPull","Pull70","fitZU","fitZU3","fitZA","",""},0},
    {{"hdEI","hdEUI","hdERI","hdEPI","hdETI","hdESI","hdEZI"},0},
    {{"hdEMI","hdEO","hdEUO","hdERO","hdEPO","hdETO","hdESO"}, 0},
    {{"hdEZO","hdEMO","dXdE","dXdEA","dXdEC","",""}, 0},
    {{"BaddEdxZPhi700","BaddEdxZPhi701","BaddEdxMult700","BaddEdxMult701","BaddEdxZPhiZ0","BaddEdxZPhiZ1",""}, 0},
    {{"BaddEdxMultZ0","BaddEdxMultZ1","ZOfBadHits0","ZOfBadHits1","ZOfBadHits2","ZOfBadHits3",""}, 0},
    {{"ZOfBadHits4","ZOfBadHits5","ZOfBadHits6","ZOfBadHits7","ZOfBadHits8","ZOfBadHits9","ZOfGoodHits"}, 0},
    {{"PhiOfBadHits","TracklengthInTpcTotal","TracklengthInTpc","HitsUsage","","",""}, 0},
    {{"TdEdxPF","TdEdxPFpi","TdEdxPFe","TdEdxPFK","TdEdxPFP","",""}, 2},
    {{"TdEdxP70","TdEdxP70pi","TdEdxP70e","TdEdxP70K","TdEdxP70P","",""}, 2}
}
#endif
