// $Id: bfcread_hist_filelist_add.C,v 2.1 2000/06/23 16:19:25 kathy Exp $
// $Log: bfcread_hist_filelist_add.C,v $
// Revision 2.1  2000/06/23 16:19:25  kathy
// macro that will read list of files and add all histograms together
//
//
//=======================================================================
// owner:  Kathy Turner
//
// bfcread_hist_filelist_add.C 
//
// what it does: 
//  - reads in list of  different *.hist.root file produced from a chain 
//               (such as bfc)
