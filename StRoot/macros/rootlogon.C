// $Id: rootlogon.C,v 1.28 2000/10/09 03:32:56 fine Exp $
//
//=======================================================================
// owner:  Yuri Fisyak
...
#pragma optimize 0
  //    gInterpreter->ProcessLine(".O0");
   ...
   gSystem->SetIncludePath("-I. -I./include -I./StRoot -I$STAR/include -I$STAR/StRoot -I$STAF/inc -I$CERN_ROOT/include -I$ROOTSYS/src");
#ifdef RFIO    
   {
     // Load rfio map
