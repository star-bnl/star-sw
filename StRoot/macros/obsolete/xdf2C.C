// $Id: xdf2C.C,v 1.1 1998/12/12 02:38:45 fisyak Exp $
// $Log: xdf2C.C,v $
// Revision 1.1  1998/12/12 02:38:45  fisyak
// Clean up
//
...
// add laser
//
xdf2C(const Char_t *fileinp = "geant.xdf")
{
  ...
  St_XDFFile   *xdf_in   = new St_XDFFile(fileinp,"r");
  // Init the mai chain and all its makers
  St_DataSet *set=xdf_in->NextEventGet();
