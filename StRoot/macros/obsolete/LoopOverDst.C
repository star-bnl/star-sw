...
// $Id: LoopOverDst.C,v 1.1 2000/05/09 19:57:13 kathy Exp $
// $Log: LoopOverDst.C,v $
// Revision 1.1  2000/05/09 19:57:13  kathy
// this only worked for MDC2 and the way it's done is no longer current anyway
//
