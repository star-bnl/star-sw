...
%
% $Id: StMcEvent.tex,v 2.3 2000/04/18 00:55:47 calderon Exp $
%
...
\begin{itemize}
	...
	the method \name{StMcVertex::daughters()} will not return any tracks from the particle
	...
	\item To find out the genealogy of a particle, the \name{StMcTrack::parent()} method is provided.
