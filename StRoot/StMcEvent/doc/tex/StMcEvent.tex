...
%
% $Id: StMcEvent.tex,v 2.6 2003/04/16 18:12:35 calderon Exp $
%
...
\item[Public Data\\ Members]
	...
	look at Bemc hits, switch this off.  This also loads hits from
	Bprs, Bsmde, and Bsmdp detectors.
...
\item[Public Member\\ Functions]
    ...
    \verb+float dE() const;+\\
    Returns the energy deposiotion of the hit.
    \index{dE, EMC}
...
\item[Public Member\\ Functions]
    ...
    This is used for simulated Pythia pp events, where the
