...
%
% $Id: StMcEvent.tex,v 2.8 2003/10/08 20:27:17 calderon Exp $
%
...
\item[Public\\ Constructors]
    \verb+StMcCtbHit(const StThreeVectorF& x,const StThreeVectorF& p,
	     const float de, const float ds,  const long key, const long id, StMcTrack* parent)+\\
