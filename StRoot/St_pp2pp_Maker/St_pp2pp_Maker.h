// $Id: St_pp2pp_Maker.h,v 1.18 2015/10/03 16:45:01 yipkin Exp $
...
class St_pp2pp_Maker : public StRTSBaseMaker {
  ...
  */
  Int_t  MakeTracks(const StRpsCollection &RpsColl, float blue_beamenergy, float yellow_beamenergy);
  ...
  virtual const char *GetCVS() const {
    static const char cvs[]="Tag $Name:  $ $Id: St_pp2pp_Maker.h,v 1.18 2015/10/03 16:45:01 yipkin Exp $ built " __DATE__ " " __TIME__ ; 
    return cvs;
  }
