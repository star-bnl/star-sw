...
void runEEmcPi0Maker( Int_t nevents = -1, 
...
*/
  ...
  ((StMyClusterMaker*)mEEclusters)->setSmdTruncationRatio(1.10);
  ...
  StEEmcPi0Maker *mEEpi0s = new StEEmcPi0Maker("mEEpi0s",mEEanalysis,mEEclusters,mEEpoints);
