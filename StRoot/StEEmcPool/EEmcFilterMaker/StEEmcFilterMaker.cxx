//*-- Author : Jan Balewski
// 
// $Id: StEEmcFilterMaker.cxx,v 1.1 2008/04/21 15:47:09 balewski Exp $
...
Int_t StEEmcFilterMaker::Make(){
  ...
  if(triggerConditionReturn != 1)    {
    printf("Kill2 Me### eve=%d nv=%d zVer=%.2f highT_et=%.3f TP_ET=%.3f\n",nInpEve,nV,vertexPosZ, highTEt,triggerPatchEt);
    return kStSKIP;
  }
  ...
  printf("Keep2 Me### eve=%d  nv=%d zVer=%.2f highT_et=%.3f TP_ET=%.3f\n",nInpEve,nV,vertexPosZ, highTEt,triggerPatchEt);
