#ifndef __StMyClusterMaker_h__
#define __StMyClusterMaker_h__

/*
 ***************************************************************************
 *
 * \class StMyClusterMaker
 * \author Jason C. Webb
 * \brief an example clustering algorithm
 *
 * StMyClusterMaker is an implementation of the StEEmcGenericClusterMaker.
