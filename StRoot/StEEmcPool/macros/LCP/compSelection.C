...
compSelection() {
  ...
  const int  nSel=10;
  char *selL[nSel]={ "default-H/", "maxEta1.4-H/", "highPol-H/", "nPrim5_20-H/","zVert50-H/", "pT1_3-H/", "posCharge-H/","shiftPatt-H/","swapPatt-H/","randPatt-H/" };
