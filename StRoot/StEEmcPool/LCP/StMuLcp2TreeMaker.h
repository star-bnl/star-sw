// $Id: StMuLcp2TreeMaker.h,v 1.1 2003/09/16 19:18:36 balewski Exp $
...
class StMuLcp2TreeMaker : public StMaker {
 private:
  ...
  Int_t eve_cosm; //Mike's Cosmics Rejector return value
 ...
 public: 
  ...
  virtual const char *GetCVS() const {
    static const char cvs[]="Tag $Name:  $ $Id: StMuLcp2TreeMaker.h,v 1.1 2003/09/16 19:18:36 balewski Exp $ built "__DATE__" "__TIME__ ; 
    return cvs;
  }
