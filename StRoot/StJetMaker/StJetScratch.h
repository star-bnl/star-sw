// -*- mode: c++;-*-
// $Id: StJetScratch.h,v 1.7.6.2 2016/04/27 17:31:22 zchang Exp $
...
public:
  ...
  {static const char cvs[]="Tag $Name:  $ $Id: StJetScratch.h,v 1.7.6.2 2016/04/27 17:31:22 zchang Exp $ built " __DATE__ " " __TIME__; return cvs;}
