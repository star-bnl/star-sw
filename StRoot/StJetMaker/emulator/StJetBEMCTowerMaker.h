// -*- mode: c++;-*-
// $Id: StJetBEMCTowerMaker.h,v 1.1 2008/07/21 02:00:23 tai Exp $
...
public:
  ...
  {static const char cvs[]="Tag $Name:  $ $Id: StJetBEMCTowerMaker.h,v 1.1 2008/07/21 02:00:23 tai Exp $ built "__DATE__" "__TIME__; return cvs;}
