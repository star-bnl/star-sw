...
//StNNPDFAsymMaker
#include "StSpinPool/StNNPDFAsymMaker/StNNPDFPythiaEventMaker.h"
...
Int_t StJetSkimEventMaker::Init()
{
	...
	//Amilkar Nov 2017: insert to save mc event info inside the skim.root
	nnpdfAsymMaker  = dynamic_cast<StNNPDFAsymMaker*>(GetMaker("NNPDFAsym"));
	if(nnpdfAsymMaker != NULL) {
	  mEvent->setMcEvent(nnpdfAsymMaker->pythiaEvent());
	  isRealData = false;  //Amilkar 
	}
