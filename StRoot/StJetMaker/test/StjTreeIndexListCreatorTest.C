...
StjTreeIndexList StjTreeIndexListCreatorTest::createExpectedList()
{
  ...
  ret.push_back(StjTreeIndex(6143024,  17479  ));
  ...
  ret.push_back(StjTreeIndex(6143024,  46794  ));
