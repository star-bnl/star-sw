...
void RunJetSimuSkimFinder(const int nevents = 100,
			  ...
			  const char *outfile="Jets_pt35_11.root",
			  const char *skimFile="Skim_pt35_11.root"){
  ...
  //Pythia4pMaker
  StPythiaFourPMaker* pythiaFourPMaker = new StPythiaFourPMaker("StPythiaFourPMaker",asym, mcEventMaker);
