...
ULong64_t gdpbv100::Message::getMsgFullTime(ULong64_t epoch) const
{
   return std::round( getMsgFullTimeD( epoch ) );
}
//----------------------------------------------------------------------------
//! Returns expanded and adjusted time of message in double (in ns)
double gdpbv100::Message::getMsgFullTimeD(ULong64_t epoch) const
{
...
ULong64_t gdpbv100::Message::CalcDistance(ULong64_t start, ULong64_t stop)
{
   if (start>stop) {
