...
namespace gdpbv100 {
   ...
   const ULong64_t kulEpochCycleBins = static_cast<ULong64_t>(kuEpochCounterSz + 1)* kuEpochInBins;
   ...
   const ULong64_t kulEpochCycleFieldSz = 0x1FFFFF; // 21 bits
   ...
   class Message {
      ...
      public:
         ...
         inline uint32_t getField(uint32_t shift, uint32_t len) const
            { return (data >> shift) & (((static_cast<ULong64_t>(1)) << len) - 1); } //used to be 32 bit. might need to replace getfield by getfieldlong in getter of pattern message

         inline void setField(uint32_t shift, uint32_t len, uint32_t value)
            { ULong64_t mask = (((static_cast<ULong64_t>(1)) << len) - 1);
              data = (data & ~(mask << shift)) | ((static_cast<ULong64_t>(value) & mask) << shift); }

         inline void setFieldLong(uint32_t shift, uint32_t len, ULong64_t value)
            { ULong64_t mask = (((static_cast<ULong64_t>(1)) << len) - 1);
         ...
         //++++//
         inline ULong64_t getGdpbTsLsbStarB()   const { return getFieldLong( 20, 24 ); }
         inline ULong64_t getStarTsMsbStarB()   const { return getFieldLong(  4, 16 ); }
         //++++//
         inline ULong64_t getStarTsMidStarC()   const { return getFieldLong(  4, 40 ); }
         //++++//
         inline ULong64_t getStarTsLsbStarD()   const { return getFieldLong( 36,  8 ); }
         ...
         //++++//
         inline void setGdpbTsMsbStarA( ULong64_t fullGdpbTs ) { setFieldLong(  4, 40, ( fullGdpbTs >> 24 ) ); }
         //++++//
         inline void setGdpbTsLsbStarB( ULong64_t fullGdpbTs ) { setFieldLong( 20, 24, ( fullGdpbTs       ) ); }
         inline void setStarTsMsbStarB( ULong64_t fullStarTs ) { setFieldLong(  4, 16, ( fullStarTs >> 48 ) ); }
         //++++//
         inline void setStarTsMidStarC( ULong64_t fullStarTs ) { setFieldLong(  4, 40, ( fullStarTs >>  8 ) ); }
         //++++//
         inline void setStarTsLsbStarD( ULong64_t fullStarTs ) { setFieldLong( 36,  8, ( fullStarTs       ) ); }
         /// 12 bits in between are set to 0
         ...
         inline static ULong64_t FullTimeStamp(ULong64_t epoch, uint32_t ts)
...
namespace gdpb {
   ...
   class Message {
      ...
      public:
         ...
         //++++//
         inline void setGdpbTsMsbStarA( ULong64_t fullGdpbTs ) { setFieldLong(  8, 40, ( fullGdpbTs >> 24 ) ); }
         //++++//
         inline void setGdpbTsLsbStarB( ULong64_t fullGdpbTs ) { setFieldLong( 24, 24, ( fullGdpbTs       ) ); }
         inline void setStarTsMsbStarB( ULong64_t fullStarTs ) { setFieldLong(  8, 16, ( fullStarTs >> 48 ) ); }
         //++++//
         inline void setStarTsMidStarC( ULong64_t fullStarTs ) { setFieldLong(  8, 40, ( fullStarTs >>  8 ) ); }
         //++++//
