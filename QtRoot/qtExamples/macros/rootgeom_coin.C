...
//--- Definition of a simple geometry
   ...
   gSystem->Load("libRQTGL");
   gSystem->Load("libRQIVTGL");
   TCanvas *cc = new TCanvas("rootgeom");
...
//   //--- define some media
   ...
   TGeoTranslationC *tr11 = new TGeoTranslationC(35., 0., 0.);
   ...
   TGeoTranslationC *replica1 =new TGeoTranslationC(-150, -150, 0);
   TGeoTranslation  *replica2 =new TGeoTranslation ( 150, -150, 0);
   TGeoTranslationC *replica3 =new TGeoTranslationC( 150,  150, 0);
   TGeoTranslation  *replica4 =new TGeoTranslation (-150,  150, 0);

   tr11->SetFileName("replica3.iv");
   replica1->SetFileName("replica1.iv");
   replica3->SetFileName("replica3.iv");

   top->AddNode(replica, 1, replica1);
   top->AddNode(replica, 2, replica2);
   top->AddNode(replica, 3, replica3);
   top->AddNode(replica, 4, replica4);
