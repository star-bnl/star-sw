...
namespace Numerics {
  ...
  double BesselI0S(const double xx) {
    return 1. + 3.5156229 * pow(xx / 3.75,  2) +
                ...
                1.2067492 * pow(xx / 3.75,  6) +
                0.2659732 * pow(xx / 3.75,  8) +
                0.0360768 * pow(xx / 3.75, 10) +
  ...
  double BesselI1S(const double xx) {
    return xx * (0.5 +
                 ...
                 0.51498869 * pow(xx / 3.75,  4) +
                 0.15084934 * pow(xx / 3.75,  6) +
                 0.02658733 * pow(xx / 3.75,  8) +
                 0.00301532 * pow(xx / 3.75, 10) +
  ...
  double BesselK0S(const double xx) {
    return -log(xx / 2.) * BesselI0S(xx) - 
           0.57721566 +
           0.42278420 * pow(xx / 2.,  2) +
           0.23069756 * pow(xx / 2.,  4) +
           0.03488590 * pow(xx / 2.,  6) +
           0.00262698 * pow(xx / 2.,  8) +
           0.00010750 * pow(xx / 2., 10) +
  ...
  double BesselK0L(const double xx) {
    return (exp(-xx) / sqrt(xx)) * (1.25331414 - 
                                    0.07832358 * (2. / xx) +
                                    0.02189568 * pow(2. / xx, 2) -
                                    0.01062446 * pow(2. / xx, 3) +
                                    0.00587872 * pow(2. / xx, 4) -
                                    0.00251540 * pow(2. / xx, 5) +
  ...
  double BesselK1S(const double xx) {
    return log(xx / 2.) * BesselI1S(xx) + 
           (1. / xx) * (1. +
                        0.15443144 * pow(xx / 2.,  2) -
                        0.67278579 * pow(xx / 2.,  4) -
                        0.18156897 * pow(xx / 2.,  6) -
                        0.01919402 * pow(xx / 2.,  8) -
                        0.00110404 * pow(xx / 2., 10) -
  ...
  double BesselK1L(const double xx) {
    return (exp(-xx) / sqrt(xx)) * (1.25331414 + 
                                    0.23498619 * (2./ xx) -
                                    0.03655620 * pow(2. / xx, 2) +
                                    0.01504268 * pow(2. / xx, 3) -
                                    0.00780353 * pow(2. / xx, 4) +
                                    0.00325614 * pow(2. / xx, 5) -
