...
class ComponentNeBem2d : public ComponentBase {
  ...
  public:
    ...
    void AddPanel(const double x0, const double y0,
                  const double x1, const double y1,
                  const int bctype, const double bcval,
                  const double lambda);
    void AddWire(const double x0, const double y0, 
  ...
  private:
    ...
    bool ComputePotential(const int gt, const double len, 
                          const double x, const double y, double& p) {
      
      switch (gt) {
        case 0: p = LinePotential(len, x, y); break;
        case 1: p = WirePotential(len, x, y); break;
    ...
    bool ComputeFlux(const int gt, const double len, const double rot, 
      ...
      double fx, fy;
      switch (gt) {
        case 0: LineFlux(len, x, y, fx, fy); break;
        case 1: WireFlux(len, x, y, fx, fy); break;
        default: return false;
      }
    ...
    void LineFlux(const double a, 
                  const double x, const double y, 
                  double& ex, double& ey);
    void WireFlux(const double r0, 
                  const double x, const double y, 
                  double& ex, double& ey);
