#ifndef G_COMPONENT_ANALYTIC_FIELD_WRAP_H
#define G_COMPONENT_ANALYTIC_FIELD_WRAP_H
...
extern "C" {
  ...
  void sigini_(int* ifail);
  
  void test_(int * ifail);
...
// ----------------------------------------------------------------
class ComponentAnalyticFieldWrap: public ComponentBase {
    
  RQ_OBJECT("ComponentAnalyticFieldWrap")
 
  public:
    // Constructors
    ComponentAnalyticFieldWrap(std::string cellName, 
                             float xl, float xm, float yl, float ym, 
                             float zl, float zm);
    ComponentAnalyticFieldWrap(std::string cellName);
    ComponentAnalyticFieldWrap();
    ...
    void Test() {int ifail; test_(&ifail);}
