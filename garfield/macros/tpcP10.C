...
//________________________________________________________________________________
void tpcP10(Int_t nEvents = 0, const Char_t *OutName = "GL.root") {
  ...
  gasFile += Form("B%ikGT%iP%iP10",b,t,p);
  ...
  //  gas->SetComposition("ar", 100*Fracs[0], "ch4", 100*Fracs[1], "cf4", Fracs[2]);
