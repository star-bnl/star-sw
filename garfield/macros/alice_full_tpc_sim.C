...
int main(int argc, char * argv[]) {
  ...
  TString gasFile("Ne_90_CO2_10_N2_5_with_mg.gas");
  ...
  gas->PrintGas();
  gas->LoadIonMobility("$GARFIELD_HOME/Data/IonMobility_Ne+_Ne.txt");
...
#else
      driftline_e->GetEndPoint(xendpoint, yendpoint, dummy, dummy, st);
      if (st) continue;
#endif
