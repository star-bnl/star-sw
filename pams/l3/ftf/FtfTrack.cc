...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void FtfTrack::Add ( FtfHit *this_hit, int way )
{
//
...
//
    ...
    if ( piece->first_hit->i_r < first_hit->i_r ){
      ...
      for ( FtfHit *current_hit  = piece->first_hit ; 
...
//****************************************************************************
int FtfTrack::Build_Track ( FtfHit *first_hit, VOLUME *volume ) {
//
...
//***********************************************************************
void FtfTrack::Delete_Candidate(void)
{
  FtfHit *next_hit ;
...
//****************************************************************************
void FtfTrack::Fill_Primary (  double &xc, double &yc, double &rc  ) {
//
//   Get cercle parameters
//
...
//
//****************************************************************************
void FtfTrack::Fill_Secondary ( double &xc, double &yc, double &rc )
{
...
/*******************************************************************************
        Reconstructs tracks
*********************************************************************************/
int FtfTrack::Follow_Hit_Selection ( FtfHit *base_hit, FtfHit *candidate_hit ){
//
	double lchi2_sz = 0 ;
   double lchi2 ;
...
//    Merges tracks
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
int FtfTrack::Merge_Primary ( AREA *track_area ){
   short  track_merged ;
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FtfHit *FtfTrack::Seek_Next_Hit ( VOLUME  *volume, 
								    FtfHit *base_hit,
									int     n_r_steps,
									int which_function ) {
#define N_LOOP 9 
...
//
         ...
         for ( FtfHit *candidate_hit = volume[tmp_index].first_hit ; 
               candidate_hit != 0 ;
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
int FtfTrack::Segment_Hit_Selection ( FtfHit *base_hit, FtfHit *candidate_hit ){
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void FtfTrack::Debug_Delete_Candidate(void)
{
...
/*****************************************************************************
        Reconstructs tracks
******************************************************************************/
void FtfTrack::Debug_Follow_Candidate ( FtfHit* candidate_hit )
{
...
/*******************************************************************************
        Reconstructs tracks
*********************************************************************************/
void FtfTrack::Debug_Follow_Success ( float dxy,      float dsz, float lchi2_xy, 
...
*******************************************************************************/
void FtfTrack::Debug_in_Volume ( FtfHit *base_hit, FtfHit *candidate_hit )
{
