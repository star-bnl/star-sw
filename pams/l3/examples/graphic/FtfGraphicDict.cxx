//
// File generated by rootcint at Thu Mar  2 13:47:59 2000.
...
void FtfGraphic::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b << fitWidth;
      R__b << nHits;
      //R__b.WriteArray(hitP, __COUNTER__);
      //R__b.WriteArray(trackP, __COUNTER__);
      R__b << nTracks;
   }
}
...
void FtfGraphic::ShowMembers(TMemberInspector &R__insp, char *R__parent)
{
   ...
   R__insp.Inspect(R__cl, R__parent, "*hitP", &hitP);
   R__insp.Inspect(R__cl, R__parent, "*trackP", &trackP);
...
static int G__FtfGraphic_ExecuteEvent_3_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
...
static int G__FtfGraphic_set_4_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((FtfGraphic*)(G__getstructoffset()))->set((int)G__int(libp->para[0]),(int)G__int(libp->para[1])
,(FtfHit*)G__int(libp->para[2]),(FtfTrack*)G__int(libp->para[3])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_setDefaults_5_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,108,(long)((FtfGraphic*)(G__getstructoffset()))->setDefaults());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_setXy_6_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfGraphic*)(G__getstructoffset()))->setXy();
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_setYz_7_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfGraphic*)(G__getstructoffset()))->setYz();
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_setXz_8_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfGraphic*)(G__getstructoffset()))->setXz();
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_shiftX_9_1(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfGraphic*)(G__getstructoffset()))->shiftX((float)G__double(libp->para[0]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_shiftY_0_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfGraphic*)(G__getstructoffset()))->shiftY((float)G__double(libp->para[0]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_shiftZ_1_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfGraphic*)(G__getstructoffset()))->shiftZ((float)G__double(libp->para[0]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_shiftPhi_2_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfGraphic*)(G__getstructoffset()))->shiftPhi((float)G__double(libp->para[0]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_shiftTheta_3_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfGraphic*)(G__getstructoffset()))->shiftTheta((float)G__double(libp->para[0]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_shiftPsi_4_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfGraphic*)(G__getstructoffset()))->shiftPsi((float)G__double(libp->para[0]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_zoom_5_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfGraphic*)(G__getstructoffset()))->zoom((float)G__double(libp->para[0]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_DeclFileName_6_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((FtfGraphic*)(G__getstructoffset()))->DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_DeclFileLine_7_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((FtfGraphic*)(G__getstructoffset()))->DeclFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_ImplFileName_8_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((FtfGraphic*)(G__getstructoffset()))->ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_ImplFileLine_9_2(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((FtfGraphic*)(G__getstructoffset()))->ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_Class_Version_0_3(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,115,(long)((FtfGraphic*)(G__getstructoffset()))->Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_Class_1_3(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((FtfGraphic*)(G__getstructoffset()))->Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_IsA_2_3(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((FtfGraphic*)(G__getstructoffset()))->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_ShowMembers_3_3(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfGraphic*)(G__getstructoffset()))->ShowMembers(*(TMemberInspector*)libp->para[0].ref,(char*)G__int(libp->para[1]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_Streamer_4_3(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfGraphic*)(G__getstructoffset()))->Streamer(*(TBuffer*)libp->para[0].ref);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfGraphic_Dictionary_5_3(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
...
static int G__FtfGraphic_FtfGraphic_6_3(G__value *result7,char *funcname,struct G__param *libp,int hash)
{
   FtfGraphic *p;
   if(1!=libp->paran) ;
...
static int G__FtfGraphic_wAFtfGraphic_7_3(G__value *result7,char *funcname,struct G__param *libp,int hash) {
...
static void G__setup_memvarFtfGraphic(void) {
   ...
   G__memvar_setup((void*)((long)(&p->hitP)-(long)(p)),89,0,0,-1,-1,-1,1,"hitP=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->trackP)-(long)(p)),89,0,0,-1,-1,-1,1,"trackP=",0,(char*)NULL);
...
"i - 'Int_t' 0 - py",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("set",332,G__FtfGraphic_set_4_1,105,-1,-1,0,4,1,1,0,
"i - - 0 - nHitsIn i - - 0 - nTracksIn "
"U 'FtfHit' - 0 - hitArray U 'FtfTrack' - 0 - trackArray",(char*)NULL,(void*)NULL,0);
