//
// File generated by rootcint at Fri May 19 13:22:09 2000.
...
void FtfPara::ShowMembers(TMemberInspector &R__insp, char *R__parent)
{
   ...
   R__insp.Inspect(R__cl, R__parent, "parameterLocation", &parameterLocation);
   R__insp.Inspect(R__cl, R__parent, "maxChi2Primary", &maxChi2Primary);
   ...
   R__insp.Inspect(R__cl, R__parent, "rowEnd", &rowEnd);
   ...
   R__insp.Inspect(R__cl, R__parent, "distanceMerge", &distanceMerge);
...
extern "C" void G__set_cpp_environmentFtfParaDict() {
  ...
  G__add_compiledheader("../inc/FtfPara.h");
...
/* FtfPara */
static int G__FtfPara_FtfPara_0_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   FtfPara *p=NULL;
...
static int G__FtfPara_setDefaults_1_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfPara*)(G__getstructoffset()))->setDefaults();
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfPara_read_2_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfPara*)(G__getstructoffset()))->read((char*)G__int(libp->para[0]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfPara_write_3_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfPara*)(G__getstructoffset()))->write((char*)G__int(libp->para[0]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfPara_DeclFileName_4_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((FtfPara*)(G__getstructoffset()))->DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfPara_DeclFileLine_5_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((FtfPara*)(G__getstructoffset()))->DeclFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfPara_ImplFileName_6_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((FtfPara*)(G__getstructoffset()))->ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfPara_ImplFileLine_7_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((FtfPara*)(G__getstructoffset()))->ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfPara_Class_Version_8_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,115,(long)((FtfPara*)(G__getstructoffset()))->Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfPara_Class_9_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((FtfPara*)(G__getstructoffset()))->Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfPara_IsA_0_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((const FtfPara*)(G__getstructoffset()))->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfPara_ShowMembers_1_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfPara*)(G__getstructoffset()))->ShowMembers(*(TMemberInspector*)libp->para[0].ref,(char*)G__int(libp->para[1]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfPara_Streamer_2_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfPara*)(G__getstructoffset()))->Streamer(*(TBuffer*)libp->para[0].ref);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfPara_Dictionary_3_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
...
static int G__FtfPara_FtfPara_4_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash)
{
   FtfPara *p;
...
static int G__FtfPara_wAFtfPara_5_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
static void G__setup_memvarFtfPara(void) {
   ...
   G__memvar_setup((void*)((long)(&p->infoLevel)-(long)(p)),105,0,0,-1,-1,-1,1,"infoLevel=",0,"Level of information printed about progress");
   G__memvar_setup((void*)((long)(&p->segmentRowSearchRange)-(long)(p)),105,0,0,-1,-1,-1,1,"segmentRowSearchRange=",0,"Row search range for segments ");
   G__memvar_setup((void*)((long)(&p->trackRowSearchRange)-(long)(p)),105,0,0,-1,-1,-1,1,"trackRowSearchRange=",0,"Row search range for tracks ");
   G__memvar_setup((void*)((long)(&p->dEdx)-(long)(p)),105,0,0,-1,-1,-1,1,"dEdx=",0,"dEdx switch");
   G__memvar_setup((void*)((long)(&p->dEdxNTruncate)-(long)(p)),105,0,0,-1,-1,-1,1,"dEdxNTruncate=",0,"# points to truncate in dEdx");
   G__memvar_setup((void*)((long)(&p->eventReset)-(long)(p)),105,0,0,-1,-1,-1,1,"eventReset=",0,"Flag to reset event in fft ");
   G__memvar_setup((void*)((long)(&p->getErrors)-(long)(p)),105,0,0,-1,-1,-1,1,"getErrors=",0,"Flag to switch error calculation");
   G__memvar_setup((void*)((long)(&p->fillTracks)-(long)(p)),105,0,0,-1,-1,-1,1,"fillTracks=",0,"Flag to switch FtfTrack class filling");
   G__memvar_setup((void*)((long)(&p->ghostFlag)-(long)(p)),105,0,0,-1,-1,-1,1,"ghostFlag=",0,"=1 when there are ghost hits");
   G__memvar_setup((void*)((long)(&p->goBackwards)-(long)(p)),105,0,0,-1,-1,-1,1,"goBackwards=",0,"Flag to go backwards at the end of track reco");
   G__memvar_setup((void*)((long)(&p->init)-(long)(p)),105,0,0,-1,-1,-1,1,"init=",0,"Control initialization ");
   G__memvar_setup((void*)((long)(&p->mergePrimaries)-(long)(p)),105,0,0,-1,-1,-1,1,"mergePrimaries=",0,"Switch to control primary merging ");
   G__memvar_setup((void*)((long)(&p->minHitsPerTrack)-(long)(p)),105,0,0,-1,-1,-1,1,"minHitsPerTrack=",0,"Minimum # hits per track ");
   G__memvar_setup((void*)((long)(&p->modRow)-(long)(p)),105,0,0,-1,-1,-1,1,"modRow=",0,"Modulo pad row number to use ");
   G__memvar_setup((void*)((long)(&p->nHitsForSegment)-(long)(p)),105,0,0,-1,-1,-1,1,"nHitsForSegment=",0,"# hits in initial segments ");
   G__memvar_setup((void*)((long)(&p->minHitsForFit)-(long)(p)),105,0,0,-1,-1,-1,1,"minHitsForFit=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->nEta)-(long)(p)),105,0,0,-1,-1,-1,1,"nEta=",0,"# volumes in eta ");
   G__memvar_setup((void*)((long)(&p->nEtaTrack)-(long)(p)),105,0,0,-1,-1,-1,1,"nEtaTrack=",0,"# Track areas in eta ");
   G__memvar_setup((void*)((long)(&p->nPhi)-(long)(p)),105,0,0,-1,-1,-1,1,"nPhi=",0,"# volumes in nphi ");
   G__memvar_setup((void*)((long)(&p->nPhiTrack)-(long)(p)),105,0,0,-1,-1,-1,1,"nPhiTrack=",0,"# Track areas in nphi ");
   G__memvar_setup((void*)((long)(&p->nPrimaryPasses)-(long)(p)),105,0,0,-1,-1,-1,1,"nPrimaryPasses=",0,"# iterations looking for primaries");
   G__memvar_setup((void*)((long)(&p->nSecondaryPasses)-(long)(p)),105,0,0,-1,-1,-1,1,"nSecondaryPasses=",0,"# iterations looking for secondaries");
   G__memvar_setup((void*)((long)(&p->vertexConstrainedFit)-(long)(p)),105,0,0,-1,-1,-1,1,"vertexConstrainedFit=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->parameterLocation)-(long)(p)),105,0,0,-1,-1,-1,1,"parameterLocation=",0,"0=inner most point, 1=closest approach");
   G__memvar_setup((void*)((long)(&p->maxChi2Primary)-(long)(p)),102,0,0,-1,-1,-1,1,"maxChi2Primary=",0,"maximum chi2 to be considered primary ");
   G__memvar_setup((void*)((long)(&p->rowInnerMost)-(long)(p)),105,0,0,-1,-1,-1,1,"rowInnerMost=",0,"Row where end track search ");
   G__memvar_setup((void*)((long)(&p->rowOuterMost)-(long)(p)),105,0,0,-1,-1,-1,1,"rowOuterMost=",0,"Outer most row to consider tin tracking");
   G__memvar_setup((void*)((long)(&p->rowStart)-(long)(p)),105,0,0,-1,-1,-1,1,"rowStart=",0,"Row where start track search");
   G__memvar_setup((void*)((long)(&p->rowEnd)-(long)(p)),105,0,0,-1,-1,-1,1,"rowEnd=",0,"Row where end   track search");
   G__memvar_setup((void*)((long)(&p->szFitFlag)-(long)(p)),105,0,0,-1,-1,-1,1,"szFitFlag=",0,"Switch for sz fit ");
   ...
   G__memvar_setup((void*)((long)(&p->distanceMerge)-(long)(p)),102,0,0,-1,-1,-1,1,"distanceMerge=",0,"Maximum distance for reference point to merge secondaries");
   ...
   G__memvar_setup((void*)((long)(&p->maxTime)-(long)(p)),102,0,0,-1,-1,-1,1,"maxTime=",0,"maxTime tracker can run");
   G__memvar_setup((void*)((long)(&p->phiClosed)-(long)(p)),105,0,0,-1,-1,-1,1,"phiClosed=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->primaries)-(long)(p)),105,0,0,-1,-1,-1,1,"primaries=",0,(char*)NULL);
...
static void G__setup_memfuncFtfPara(void) {
   ...
   G__memfunc_setup("read",412,G__FtfPara_read_2_0,121,-1,-1,0,1,1,1,0,"C - - 0 - inputFile",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("write",555,G__FtfPara_write_3_0,121,-1,-1,0,1,1,1,0,"C - - 0 - outputFile",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileName",1145,G__FtfPara_DeclFileName_4_0,67,-1,-1,0,0,1,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__FtfPara_DeclFileLine_5_0,105,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__FtfPara_ImplFileName_6_0,67,-1,-1,0,0,1,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileLine",1178,G__FtfPara_ImplFileLine_7_0,105,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class_Version",1339,G__FtfPara_Class_Version_8_0,115,-1,G__defined_typename("Version_t"),0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class",502,G__FtfPara_Class_9_0,85,G__get_linked_tagnum(&G__FtfParaDictLN_TClass),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("IsA",253,G__FtfPara_IsA_0_1,85,G__get_linked_tagnum(&G__FtfParaDictLN_TClass),-1,0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("ShowMembers",1132,G__FtfPara_ShowMembers_1_1,121,-1,-1,0,2,1,1,0,
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("Streamer",835,G__FtfPara_Streamer_2_1,121,-1,-1,0,1,1,1,0,"u 'TBuffer' - 1 - b",(char*)NULL,(void*)NULL,1);
   G__memfunc_setup("Dictionary",1046,G__FtfPara_Dictionary_3_1,121,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   // automatic copy constructor
   G__memfunc_setup("FtfPara",676,G__FtfPara_FtfPara_4_1,(int)('i'),G__get_linked_tagnum(&G__FtfParaDictLN_FtfPara),-1,0,1,1,1,0,"u 'FtfPara' - 1 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
   G__memfunc_setup("~FtfPara",802,G__FtfPara_wAFtfPara_5_1,(int)('y'),-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
