//
// File generated by rootcint at Tue Sep 21 11:18:04 1999.
...
static int G__FtfHit_setStatus_2_0(G__value *result7,char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfHit*)(G__getstructoffset()))->setStatus((FtfTrack*)G__int(libp->para[0]),(FtfPara*)G__int(libp->para[1]));
   return(1 || funcname || hash || result7 || libp) ;
}
...
static void G__setup_memfuncFtfHit(void) {
   ...
   G__memfunc_setup("setStatus",976,G__FtfHit_setStatus_2_0,121,-1,-1,0,2,1,1,0,
"U 'FtfTrack' - 0 - this_track U 'FtfPara' - 0 - para",(char*)NULL,(void*)NULL,0);
