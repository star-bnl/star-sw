//
// File generated by rootcint at Fri May 19 13:19:43 2000.
...
extern "C" void G__set_cpp_environmentFtfFinderDict() {
  ...
  G__add_compiledheader("../inc/FtfFinder.h");
...
/* FtfFinder */
static int G__FtfFinder_FtfFinder_0_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   FtfFinder *p=NULL;
...
static int G__FtfFinder_dEdx_2_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfFinder*)(G__getstructoffset()))->dEdx();
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_getTracks_3_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((FtfFinder*)(G__getstructoffset()))->getTracks());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_mergePrimaryTracks_4_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfFinder*)(G__getstructoffset()))->mergePrimaryTracks();
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_process_5_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letdouble(result7,100,(double)((FtfFinder*)(G__getstructoffset()))->process());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_reset_6_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((FtfFinder*)(G__getstructoffset()))->reset());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_setConformalCoordinates_7_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((FtfFinder*)(G__getstructoffset()))->setConformalCoordinates());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_setPointers_8_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((FtfFinder*)(G__getstructoffset()))->setPointers());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_CpuTime_9_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letdouble(result7,100,(double)((FtfFinder*)(G__getstructoffset()))->CpuTime());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_RealTime_0_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letdouble(result7,100,(double)((FtfFinder*)(G__getstructoffset()))->RealTime());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_DeclFileName_1_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((FtfFinder*)(G__getstructoffset()))->DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_DeclFileLine_2_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((FtfFinder*)(G__getstructoffset()))->DeclFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_ImplFileName_3_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,67,(long)((FtfFinder*)(G__getstructoffset()))->ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_ImplFileLine_4_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,105,(long)((FtfFinder*)(G__getstructoffset()))->ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_Class_Version_5_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,115,(long)((FtfFinder*)(G__getstructoffset()))->Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_Class_6_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((FtfFinder*)(G__getstructoffset()))->Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_IsA_7_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__letint(result7,85,(long)((const FtfFinder*)(G__getstructoffset()))->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_ShowMembers_8_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfFinder*)(G__getstructoffset()))->ShowMembers(*(TMemberInspector*)libp->para[0].ref,(char*)G__int(libp->para[1]));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_Streamer_9_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((FtfFinder*)(G__getstructoffset()))->Streamer(*(TBuffer*)libp->para[0].ref);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__FtfFinder_Dictionary_0_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
...
static int G__FtfFinder_FtfFinder_1_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash)
{
   FtfFinder *p;
...
static int G__FtfFinder_wAFtfFinder_2_2(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
