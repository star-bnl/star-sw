...
double	tkf_circle_param(double , localTrack *, double []);
void	tkf_fine_approach(double [], double [], double [], double []);
double	tkf_inv_mass(double , int , localTrack *, localTrack *, double [], double []);
void	tkf_project_track(double [], double, double [], double []);
void	tkf_track_mom(double , localTrack *, int, double []);
...
double	tkf_circle_param(double bfield, localTrack *trk, double xc[2])
{
  int		iflag;
  ...
  iflag = 0;
  tkf_track_mom(bfield, trk, iflag, p);
...
double	tkf_inv_mass(double beta, int iflag, localTrack *trk1, 
                     localTrack *trk2, double m[2], double p[3])
{
  double	phi1, phi2;
...
void	tkf_track_mom(double beta, localTrack *trk, int flag, double p[3])
{
  double	phi;
  double	lambda, cl;
