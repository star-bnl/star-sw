  ...
  for (i=0;i<tracksFound;i++)
    {
      ...
      */
      ...
      radiusOne = 0;
      radiusOne = tkf_circle_param(magnetic_field, trackOne, coordsOne); 
      ...
      for (j=i+1;j<tracksFound;j++)
        {
          ...
          radiusTwo = 0;
          radiusTwo = tkf_circle_param(magnetic_field, trackTwo, coordsTwo);
          ...
          if (l != -1) 
            {
              tkf_track_mom(magnetic_field, newTrackOne[l], 0, trackOneMomentum);
              tkf_track_mom(magnetic_field, newTrackTwo[l], 0, trackTwoMomentum);
