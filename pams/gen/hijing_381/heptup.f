...
*******************************************************************************
     ...
     *Z2)                                                                 96
      IMPLICIT NONE                                                       97
      INTEGER GETPID,IVER/11/,IPMX/1000000/,MXRF/1/,MXPA/65000/,NV/16/    98
      INTEGER MAXIP,MAXRF,MAXPA,MAXNV,K,IC/0/,ID/999/,LUX/2/              99
      REAL VXMAX,VXMX/0.001/,VXMM                                         100
* Input parameters:
...
* Local:
     ...
     *venus' , 'optns.dat' , 6, 'hijing' , 'hijev.inp' , 5, 'mevsim' , '  131
     *mult_gen.in' , 4, 'rqmd' , 'rqmd.inp' , 3, 'pythia' , 'pythia.data  131
...
C Check IS!=0                                                             163
      ...
      CALL HEPBNAME (ID,MASS, 'mass:R:' ,16, -1, 10)                      175
C  mm                                                                     176
      CALL HEPBNAME (ID,VXYZ, 'Vxyz(3):R:' ,NV, VXMM, VXMX)               176
C mm/c                                                                    177
      CALL HEPBNAME (ID,VTIME,'Vtime:R:' ,NV, 0, VXMX)                    177
