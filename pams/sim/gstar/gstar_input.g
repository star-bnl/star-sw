...
*************************************************************************
   Implicit   None
   Integer    LENOCC,CSADDR,Igate,Ier,J,I
   Character  C*1
*
+CDE,AgCKINE,GCNUM.
*
   Do i=1,LENOCC(Ccommand)
     ...
     elseif C=='X' { J=CsADDR('xdf_read'); If (J!=0) call CsJCAL(J,1,Igate) }
...
*************************************************************************
   ...
   character*120 line
   integer       Index,li,Ieven,Ntrac,Nvert,itr,ivt,nv,nt,Igate,
...
*
 ...
 { line='end-of-file';   read5 (li,'(a)') Line; (1x,a)
   ...
   { 
     read2 (line(7:),*)  Ieven,Ntrac,Nvert,a,b
   ...
   { 
     read1 (line,'(i7,a8,i6)') Ntrac,tit,Ieven; (' gstar_ReadOld: ',i8,a8,i6)
...
*************************************************************************
   module  Gstar_Header defines event header
   author  Pavel Nevski
...
* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
*
   check JHEAD>0 & LKRUNT>0 & LKEVNT>0
*
   fill UEVN(1) ! user event buffer
   ...
   endfill
*
   FILL EGRN(1)            !  Event generator run structure 
...
*
   FILL EGEV(1)            !  Event generator event structure 
...
*
   ...
   print *,' Gstar_Header: geant header set with length =',iadr
*
   end
