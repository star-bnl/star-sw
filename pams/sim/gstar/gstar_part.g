...
* All remaining partocles (including quarks) are unknown to GEANT, 
...
***********************************************************************
   print *,' gstar_part loaded, read program comments for more information'
   end
*
* --------------------------------------------------------------------------
*
...
*    group rho-pi and pi-pi-pi together (in practice indistinguishable)
   Particle phi       code=151 TrkTyp=3  mass=1019.41 charge=0 tlife=1.482e-22,
...
*    For D+, include only K0_S + pi+ decay mode  pmj 16/2/95
   Particle D_plus    code=155 TrkTyp=4  mass=1.869 charge=1 tlife=1.057e-12,
                      bratio= { 1, }     mode= { 1608, }
 
*    For D0, include only K+ + pi- decay mode  pmj 16/2/95
   Particle D0        code=156 TrkTyp=3  mass=1.865 charge=0 tlife=0.415e-12,
                      bratio= { 1, }     mode= { 1208, }
