/***************************************************************************
 *
 * $Id: spr_svt.cc,v 1.1 1998/09/25 19:46:28 kathy Exp $
 *
 ...
 *
 * $Log: spr_svt.cc,v $
 * Revision 1.1  1998/09/25 19:46:28  kathy
 * Brian's new version of spr - doesn't work yet - kumacs wrong
 *
 **************************************************************************/
#include "spr_svt.h"
...
// PAM
  ...
  TABLE_HEAD_ST *globalTrackH,        EGR_GLOBTRK_ST   *globalTrack, 
  TABLE_HEAD_ST *globalPidH,          EPI_HYPO_PID_ST  *globalPid)

{
    ...
    cout << "globalPidH= " << (globalPidH->nok) << endl;
    if ((globalPidH->nok) == 0)         
	for(ii=0; ii<(svtTrackH->nok); ii++) 
	    globalTrack[ii].id_hypo_pid = 0;
