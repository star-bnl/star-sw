...
// traitement propre aux space points..(probabilite)
 	  double setA[2], setB[2], setC[2], setD[2];
          ...
          setA[0] = (Adc[0] - Adc[1])/M_SQRT2;
          setA[1] = matchDistr(scm_ctrl, setA[0]);
          setB[0] = (Adc[0] - Adc[2])/M_SQRT2;
          setB[1] = matchDistr(scm_ctrl, setB[0]);
          setC[0] = (Adc[3] - Adc[1])/M_SQRT2;
          setC[1] = matchDistr(scm_ctrl, setC[0]);
          setD[0] = (Adc[3] - Adc[2])/M_SQRT2;
...
// traitement propre aux space points..(probabilite)
	  ...
	  double setAB[2], setCD[2];
          ...
          setA[0]  = (Adc[0] - Adc[1])/M_SQRT2;
          setA[1]  = matchDistr(scm_ctrl, setA[0]);
          setAB[0] = (Adc[0] - (Adc[1]+Adc[2]))/M_SQRT2;
          setAB[1] = matchDistr(scm_ctrl, setAB[0]);
          setCD[0] = (Adc[3] - (Adc[2]+Adc[5]))/M_SQRT2;
          setCD[1] = matchDistr(scm_ctrl, setCD[0]);
          setD[0]  = (Adc[3] - Adc[5])/M_SQRT2;
          setD[1]  = matchDistr(scm_ctrl, setD[0]);
...
// traitement propre aux space points..(probabilite)
	  ...
	  double setAB[2], setCD[2];
          ...
          setA[0]  = (Adc[0] - Adc[1])/M_SQRT2;
          setA[1]  = matchDistr(scm_ctrl, setA[0]);
          setAB[0] = (Adc[0] + Adc[2] - Adc[1])/M_SQRT2;
          setAB[1] = matchDistr(scm_ctrl, setAB[0]);
          setCD[0] = (Adc[2] + Adc[5] - Adc[4])/M_SQRT2;
          setCD[1] = matchDistr(scm_ctrl, setCD[0]);
          setD[0]  = (Adc[5] - Adc[4])/M_SQRT2;
          setD[1]  = matchDistr(scm_ctrl, setD[0]);
	  probABD  = (setAB[1]*setD[1])/(setAB[1]*setD[1]+setA[1]*setCD[1]);
	  probACD  = (setA[1]*setCD[1])/(setAB[1]*setD[1]+setA[1]*setCD[1]);
	  newPointB->setFlag(int(100*probABD));
...
// traitement propre aux space points..(probabilite)
	  ...
	  double setAB[2], setAC[2], setDE[2];
          ...
          setAB[0] = (Adc[0] - (Adc[1] + Adc[2]))/M_SQRT2;
          setAB[1] = matchDistr(scm_ctrl, setAB[0]);
          setAC[0] = (Adc[0] - (Adc[1] + Adc[3]))/M_SQRT2;
          setAC[1] = matchDistr(scm_ctrl, setAC[0]);
          setDE[0] = (Adc[4] - (Adc[2] + Adc[3]))/M_SQRT2;
          setDE[1] = matchDistr(scm_ctrl, setDE[0]);
          setD[0]  = (Adc[4] - Adc[2])/M_SQRT2;
          setD[1]  = matchDistr(scm_ctrl, setD[0]);
          setE[0]  = (Adc[4] - Adc[3])/M_SQRT2;
...
// traitement propre aux space points..(probabilite)
	  double setA[2], setC[2], setE[2];
          ...
          setAB[0] = (Adc[0] + Adc[2] - Adc[1])/M_SQRT2;
          setAB[1] = matchDistr(scm_ctrl, setAB[0]);
          setAD[0] = (Adc[0] + Adc[5] - Adc[1])/M_SQRT2;
          setAD[1] = matchDistr(scm_ctrl, setAD[0]);
          setCE[0] = (Adc[2] + Adc[5] + Adc[4])/M_SQRT2;
          setCE[1] = matchDistr(scm_ctrl, setCE[0]);
          setC[0]  = (Adc[2] - Adc[4])/M_SQRT2;
          setC[1]  = matchDistr(scm_ctrl, setC[0]);
          setE[0]  = (Adc[5] - Adc[4])/M_SQRT2;
          setE[1]  = matchDistr(scm_ctrl, setE[0]);
...
// traitement propre aux space points..(probabilite)
	  double setA[2], setB[2], setE[2];
          ...
          setAB[0] = (Adc[0] - (Adc[1] + Adc[2]))/M_SQRT2;
          setAB[1] = matchDistr(scm_ctrl, setAB[0]);
          setCE[0] = (Adc[3] - (Adc[1] - Adc[6]))/M_SQRT2;
          setCE[1] = matchDistr(scm_ctrl, setCE[0]);
          setDE[0] = (Adc[3] - (Adc[2] + Adc[6]))/M_SQRT2;
          setDE[1] = matchDistr(scm_ctrl, setDE[0]);
          setE[0]  = (Adc[3] - Adc[6])/M_SQRT2;
          setE[1]  = matchDistr(scm_ctrl, setE[0]);
...
// traitement propre aux space points..(probabilite)
	  double setA[2], setC[2], setE[2];
          ...
          setA[0]  = (Adc[0] - Adc[1])/M_SQRT2;
          setA[1]  = matchDistr(scm_ctrl, setA[0]);
          setAC[0] = (Adc[0] + Adc[3] - Adc[1])/M_SQRT2;
          setAC[1] = matchDistr(scm_ctrl, setAC[0]);
          setBE[0] = (Adc[0] + Adc[6] - Adc[2])/M_SQRT2;
          setBE[1] = matchDistr(scm_ctrl, setBE[0]);
          setC[0]  = (Adc[3] - Adc[1])/M_SQRT2;
          setC[1]  = matchDistr(scm_ctrl, setC[0]);
          setDE[0] = (Adc[3] + Adc[6] - Adc[2])/M_SQRT2;
          setDE[1] = matchDistr(scm_ctrl, setDE[0]);
          setE[0]  = (Adc[6] - Adc[2])/M_SQRT2;
          setE[1]  = matchDistr(scm_ctrl, setE[0]);
...
// traitement propre aux space points..(probabilite)
	  double setA[2], setB[2], setC[2], setD[2], setE[2], setF[2];
          ...
          setB[0]  = (Adc[0] - Adc[2])/M_SQRT2;
          setB[1]  = matchDistr(scm_ctrl, setB[0]);
          setC[0]  = (Adc[0] - Adc[3])/M_SQRT2;
          setC[1]  = matchDistr(scm_ctrl, setC[0]);
          setD[0]  = (Adc[4] - Adc[1])/M_SQRT2;
          setD[1]  = matchDistr(scm_ctrl, setD[0]);
          setE[0]  = (Adc[4] - Adc[2])/M_SQRT2;
          setE[1]  = matchDistr(scm_ctrl, setE[0]);
          setF[0]  = (Adc[4] - Adc[3])/M_SQRT2;
          setF[1]  = matchDistr(scm_ctrl, setF[0]);
          setAB[0] = (Adc[0] - Adc[1] - Adc[2])/M_SQRT2;
          setAB[1] = matchDistr(scm_ctrl, setAB[0]);
          setAC[0] = (Adc[0] - Adc[1] - Adc[3])/M_SQRT2;
          setAC[1] = matchDistr(scm_ctrl, setAC[0]);
          setBC[0] = (Adc[0] - Adc[2] - Adc[3])/M_SQRT2;
          setBC[1] = matchDistr(scm_ctrl, setBC[0]);
          setDE[0] = (Adc[4] - Adc[1] - Adc[2])/M_SQRT2;
          setDE[1] = matchDistr(scm_ctrl, setDE[0]);
          setDF[0] = (Adc[4] - Adc[1] - Adc[3])/M_SQRT2;
          setDF[1] = matchDistr(scm_ctrl, setDF[0]);
          setEF[0] = (Adc[4] - Adc[2] - Adc[3])/M_SQRT2;
...
// traitement propre aux space points..(probabilite)
	  double setA[2], setB[2], setC[2], setD[2], setE[2], setF[2];
          ...
          setD[0]  = (Adc[3] - Adc[2])/M_SQRT2;
          setD[1]  = matchDistr(scm_ctrl, setD[0]);
          setE[0]  = (Adc[6] - Adc[1])/M_SQRT2;
          setE[1]  = matchDistr(scm_ctrl, setE[0]);
          setF[0]  = (Adc[6] - Adc[2])/M_SQRT2;
          setF[1]  = matchDistr(scm_ctrl, setF[0]);
          setAC[0] = (Adc[0] + Adc[3] - Adc[1])/M_SQRT2;
          setAC[1] = matchDistr(scm_ctrl, setAC[0]);
          setBD[0] = (Adc[0] + Adc[3] - Adc[2])/M_SQRT2;
          setBD[1] = matchDistr(scm_ctrl, setBD[0]);
          setAE[0] = (Adc[0] + Adc[6] - Adc[1])/M_SQRT2;
          setAE[1] = matchDistr(scm_ctrl, setAE[0]);
          setBF[0] = (Adc[0] + Adc[6] - Adc[2])/M_SQRT2;
          setBF[1] = matchDistr(scm_ctrl, setBF[0]);
          setCE[0] = (Adc[3] + Adc[6] - Adc[1])/M_SQRT2;
          setCE[1] = matchDistr(scm_ctrl, setCE[0]);
          setDF[0] = (Adc[3] + Adc[6] - Adc[2])/M_SQRT2;
          setDF[1] = matchDistr(scm_ctrl, setDF[0]);
...
// traitement propre aux space points..(probabilite)
          ...
          setC[0] = (Adc[3] - Adc[2])/M_SQRT2;
          setC[1] = matchDistr(scm_ctrl, setC[0]);
          setD[0] = (Adc[3] - Adc[5])/M_SQRT2;
          setD[1] = matchDistr(scm_ctrl, setD[0]);
          setE[0] = (Adc[6] - Adc[2])/M_SQRT2;
          setE[1] = matchDistr(scm_ctrl, setE[0]);
          setF[0] = (Adc[6] - Adc[5])/M_SQRT2;
          setF[1] = matchDistr(scm_ctrl, setF[0]);
...
// traitement propre aux space points..(probabilite)
          ...
          setC[0] = (Adc[2] - Adc[4])/M_SQRT2;
          setC[1] = matchDistr(scm_ctrl, setC[0]);
          setD[0] = (Adc[2] - Adc[5])/M_SQRT2;
          setD[1] = matchDistr(scm_ctrl, setD[0]);
          setE[0] = (Adc[6] - Adc[4])/M_SQRT2;
          setE[1] = matchDistr(scm_ctrl, setE[0]);
          setF[0] = (Adc[6] - Adc[5])/M_SQRT2;
          setF[1] = matchDistr(scm_ctrl, setF[0]);
	  probACF = (setC[1]*setF[1])/(setC[1]*setF[1]+setD[1]*setE[1]);
...
// traitement propre aux space points..(probabilite)
          ...
          setE[0] = (Adc[4] - Adc[3])/M_SQRT2;
          setE[1] = matchDistr(scm_ctrl, setE[0]);
          setF[0] = (Adc[7] - Adc[2])/M_SQRT2;
          setF[1] = matchDistr(scm_ctrl, setF[0]);
          setG[0] = (Adc[7] - Adc[3])/M_SQRT2;
...
// traitement propre aux space points..(probabilite)
          ...
          setD[0] = (Adc[2] - Adc[5])/M_SQRT2;
          setD[1] = matchDistr(scm_ctrl, setD[0]);
          setF[0] = (Adc[6] - Adc[4])/M_SQRT2;
          setF[1] = matchDistr(scm_ctrl, setF[0]);
          setG[0] = (Adc[6] - Adc[5])/M_SQRT2;
          setG[1] = matchDistr(scm_ctrl, setG[0]);
...
// traitement propre aux space points..(probabilite)
          ...
          setF[0] = (Adc[4] - Adc[3])/M_SQRT2;
          setF[1] = matchDistr(scm_ctrl, setF[0]);
          setG[0] = (Adc[8] - Adc[2])/M_SQRT2;
          setG[1] = matchDistr(scm_ctrl, setG[0]);
          setH[0] = (Adc[8] - Adc[3])/M_SQRT2;
...
// traitement propre aux space points..(probabilite)
          ...
          setE[0] = (Adc[3] - Adc[6])/M_SQRT2;
          setE[1] = matchDistr(scm_ctrl, setE[0]);
          setF[0] = (Adc[7] - Adc[1])/M_SQRT2;
          setF[1] = matchDistr(scm_ctrl, setF[0]);
          setG[0] = (Adc[7] - Adc[2])/M_SQRT2;
          setG[1] = matchDistr(scm_ctrl, setG[0]);
          setH[0] = (Adc[7] - Adc[6])/M_SQRT2;
          setH[1] = matchDistr(scm_ctrl, setH[0]);
...
// traitement propre aux space points..(probabilite)
          ...
          setF[0] = (Adc[4] - Adc[3])/M_SQRT2;
          setF[1] = matchDistr(scm_ctrl, setF[0]);
          setG[0] = (Adc[8] - Adc[1])/M_SQRT2;
          setG[1] = matchDistr(scm_ctrl, setG[0]);
          setH[0] = (Adc[8] - Adc[2])/M_SQRT2;
          setH[1] = matchDistr(scm_ctrl, setH[0]);
          setI[0] = (Adc[8] - Adc[3])/M_SQRT2;
