* $Id: svttgeo10.g,v 1.5 2009/03/31 02:25:57 perev Exp $
*
* $Log: svttgeo10.g,v $
* Revision 1.5  2009/03/31 02:25:57  perev
* Bug in SVTT.SRDA fixed
*
* Revision 1.4  2008/11/30 01:30:55  perev
* modifs for extending alpha,theta,phi,ort commandas
*
* Revision 1.3  2008/11/19 04:08:30  perev
...
*******************************************************************************
*
************** PLEASE SEE SVTTGEO6 FOR PRIOR CVS LOG MESSAGES *****************
*
*******************************************************************************
Module  SVTTGEO10 is evolution of svttgeo6 with carbon replacing Be as per Dave Lynn: 
...
*     Position electronics carrier on left side of ladder (y pos)
      ...
      do s=-1,1,2
**VP	  Position SELE ORT=YZX AlphaZ=s*deg, x=svtl_radius-ladthk-xpos, y=s*(swca_WaferWid/2+ypos), AlphaX=-90*(1-s)
**VP	  Position SELE ORT=YZX AlphaZ=s*deg, x=svtl_radius-ladthk-xpos, y=s*(swca_WaferWid/2+ypos), AlphaX= 90*(1-s)
...
EndBlock
* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Block SBER are the Carbon wafer carrier rails
      Material  Carbon 
...
EndBlock
* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Block STAB are the Carbon wafer carrier end tabs
      Material  Carbon 
...
EndBlock
* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Block STRU are the Carbon struts between the wafer carrier rails
      Material  Carbon 
