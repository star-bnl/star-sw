* $Id: svttgeo4.g,v 1.1 2005/03/24 20:04:39 potekhin Exp $
*
* $Log: svttgeo4.g,v $
* Revision 1.1  2005/03/24 20:04:39  potekhin
* Need to correct a subtle and original bug in the
* definition of the electronics and IC. Code change is small,
* however we need a new source file to implement it.
* The SELE volume used to be created only once regardless
* of the layer in which it was placed, due to a certain
* feature of the language used. This is now corrected by
* creating an additional attribute for this volume.
*
*******************************************************************************
*
************** PLEASE SEE SVTTGEO3 FOR PRIOR CVS LOG MESSAGES *****************
*
*******************************************************************************
Module  SVTTGEO4  is the SVT geometry for STAR: corrected ELECTRONICS
*-->Based on the SVTTGEO3 code
