* $Id: svttgeo2.g,v 1.9 2009/03/31 02:25:57 perev Exp $
*
* $Log: svttgeo2.g,v $
* Revision 1.9  2009/03/31 02:25:57  perev
* Bug in SVTT.SRDA fixed
*
* Revision 1.8  2008/11/19 04:08:31  perev
*  updates to the corrected(vp) starsim
*
* Revision 1.7  2007/11/13 21:33:21  perev
...
* corrections. Added:
*
* 1) G10 PCBs on the ladders
* 2) Cables going to transition boards, both LV and HV
* 3) Circular tubes distributing water on the rim of the Si barrel,
* which include both plastic shell and water inside
*
...
*
*******************************************************************************
Module  SVTTGEO2  is the SVT geometry for STAR: corrected and augmented
   Author  Maxim Potekhin
*   based on the SVTTGEO1 code, bug corrections
*   adding: PCBs, copper cables, circular water feeds
   created 21 Aug 03
*                                                                             *
*------------------------------------------------------------------------------
*  Division lines:                                                            *
