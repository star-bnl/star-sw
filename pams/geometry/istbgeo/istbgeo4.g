...
*****************************************************************
Module ISTBGEO4 is the geometry of the Inner Silicon Tracker
  Created  12/12/06
...
* -------------------------------------------------------
   Fill ISMG                   ! Mother volume whole detector
      Layer      =  1          ! version
      Rin        =  8.61       ! Inner radius
      Rout       =  11.70      ! Outer radius
      TotalLength=  40.00      ! Overal length of the detector
      code       =   4.00      ! file version
   EndFill
   ...
   Fill ISMG                   ! Mother volume inner layer
      ...
      Rin        =  8.61       ! Inner radius
      Rout       =  11.70      ! Outer radius
      TotalLength=  40.00      ! Overal length of the layer
   EndFill
...
*--------------------------------------------------------
   ...
   Fill ISBG                   ! Inner silicon tracker data
      Layer      =  2          ! layer index				
      nLadder    =  15         ! ladder count				
      nUnit      =  9          ! sensor units per ladder		
      Length     =  36.0       ! Overal length of the detector		
      r          =  9.5         ! 2nd ladder nominal radius		
...
* -------------------------------------------------------
   Fill ISCC                   ! Interconnect between support rings 2 and 3
      Version    =   1         ! Version
      Rin1       =  10.70      ! Inner radius small
      Rout1      =  11.70      ! Outer radius small
      Rin2       =  15.00      ! Inner radius large
      Rout2      =  16.00      ! Outer radius large
      Length     =   6.00      ! Thickness of the ring
   EndFill
* -------------------------------------------------------
...
* -------------------------------------------------------
Block IBMY is the mother of the IST layers
     Material  Air
...
Block IBLM is the mother of the sensor assembly
      Attribute IBLM  Seen=0  colo=2 serial=istLayer
...
* -----------------------------------------------------------------------------
Block ISXA is the large glue layer between Carbon foam and sensor (and sensor and hybrid)
      Attribute ISXA Seen=1 colo=11 serial=istLayer
...
Block ISLB is the small glue layer between hybrid and chip
      Attribute ISLB Seen=1 colo=11 serial=istLayer
