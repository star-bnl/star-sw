...
*
*****************************************************************
Module ISTBGEO6 is the geometry of the Inner Silicon Tracker
  Created  09 Mar 2007
  Author   Gerrit edited by Maxim
*****************************************************************
+CDE,AGECOM,GCUNIT.
* ---
...
Block ISTP is the Carbon Foam
      ...
      !      which is for a 4mm thick support core
      ! 0.24 is when we articially increase the density to squeeze into 1.686 mm
      !      between the sensors (this is just to keep the same geometry as
      !      as before
