* $Id: mutdgeo3.g,v 1.1 2007/11/06 01:19:37 perev Exp $
* $Log: mutdgeo3.g,v $
* Revision 1.1  2007/11/06 01:19:37  perev
* y2008 geo
*
...
*
********************************************************************************
Module  MUTDGEO3 is the geometry of the STAR muon trigger system
********************************************************************************
+CDE,AGECOM,GCUNIT.
...
Block MUSC is a sector of MUON Trigger Barrel Scintillators
      ...
      do Ntray=1,2
          Create and Position MTRA   X = MTDG_Radii(Ntray)+(MTRY_SupFullH+MTRY_height+MTRY_StripT)/2.0 Y=0 Z=-128.81

 
      Create and Position MPMT X=3.12/2+1.5+MTDG_Rpmtin Y=0 Z=0
      Create and Position MMRP X=2.50/2.+MTDG_Rmrpcin Y=0 Z=-128.81
