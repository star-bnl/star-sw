...
* differences, we keep it in a separate file,
* triggereed from geometry.g when needed.
*
* 
* New Version 6.0 (Aug-Nov 2003) Akio
*
* Separated into a separate source file, and corrected, by Maxim Potekhin
...
* ----------------------------------------------------------------------------
* Near of FY03 is x = 20.30-2.54 = 17.8 
* Far of  FY03 is x = 30.65-2.54 = 28.1
...
*      AlThick  = 1.0		    ! almunim wrap thickness (real)
...
*----------------------------------------------------------------------------
      ...
      prin1 fmcg_version; ('****************** NEW FPDMGEO version ', F4.2)
...
*SMD
         ...
         Create and Position FSHM x=0 y=0 z=FBXD_SmdOffset+ztotsmd-FBXD_Depth/2
...
Block FSHM  is the SHower Max  section
      ...
      Shape     box dx=FMXG_G10Width/2 dy=FMXG_G10Height/2 dz=ztotsmd
...
*     G10 is about 60% SiO2 and 40% epoxy
      ...
      Shape     BOX dx=FMXG_G10Width/2 dy=FMXG_G10Height/2 dz=FMXG_G10Thick/2
