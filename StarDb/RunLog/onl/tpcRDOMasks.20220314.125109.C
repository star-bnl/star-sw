...
memset(&row,0,tableSet->GetRowSize());
    row.runNumber	 =   23073031; // run number  ;
    row.sector	 =          1; // sector  ;
    row.mask	 =      65535 & ~(0xf + (0xf << 8)); // disable iTPC
tableSet->AddAt(&row);
memset(&row,0,tableSet->GetRowSize());
    row.runNumber	 =   23073031; // run number  ;
    row.sector	 =          3; // sector  ;
...
memset(&row,0,tableSet->GetRowSize());
    ...
    row.mask	 =      65533 & ~(0xf + (0xf << 8)); // disable iTPC
tableSet->AddAt(&row);
memset(&row,0,tableSet->GetRowSize());
    row.runNumber	 =   23073031; // run number  ;
    row.sector	 =         13; // sector  ;
    row.mask	 =      63481 & ~(0xf + (0xf << 8)); // disable iTPC
tableSet->AddAt(&row);
memset(&row,0,tableSet->GetRowSize());
    row.runNumber	 =   23073031; // run number  ;
    row.sector	 =         15; // sector  ;
    row.mask	 =      65531 & ~(0xf + (0xf << 8)); // disable iTPC
tableSet->AddAt(&row);
memset(&row,0,tableSet->GetRowSize());
    row.runNumber	 =   23073031; // run number  ;
    row.sector	 =         17; // sector  ;
    row.mask	 =      65526 & ~(0xf + (0xf << 8)); // disable iTPC
tableSet->AddAt(&row);
memset(&row,0,tableSet->GetRowSize());
    row.runNumber	 =   23073031; // run number  ;
    row.sector	 =         19; // sector  ;
    row.mask	 =      62455 & ~(0xf + (0xf << 8)); // disable iTPC
tableSet->AddAt(&row);
memset(&row,0,tableSet->GetRowSize());
    row.runNumber	 =   23073031; // run number  ;
    row.sector	 =         21; // sector  ;
    row.mask	 =      61439 & ~(0xf + (0xf << 8)); // disable iTPC
tableSet->AddAt(&row);
memset(&row,0,tableSet->GetRowSize());
    row.runNumber	 =   23073031; // run number  ;
    row.sector	 =         23; // sector  ;
    row.mask	 =      63231 & ~(0xf + (0xf << 8)); // disable iTPC
tableSet->AddAt(&row);
// ----------------- end of code ---------------
