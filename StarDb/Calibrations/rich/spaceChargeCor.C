...
// -----------------------------------------------------------------
// db/.const/StarDb/Calibrations/rich/.spaceChargeCor/spaceChargeCor Allocated rows: 1  Used rows: 1  Row size: 60 bytes
...
memset(&row,0,tableSet->GetRowSize());
    ...
    row.detector	 =          0; // 0=RICH, 1=BBCx, 2=ZDCx e+w, 4=BBCe+w ;
