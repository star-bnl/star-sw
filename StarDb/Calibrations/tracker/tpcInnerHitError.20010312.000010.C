...
//                                        hit errors are squared !
    row.coeff[0]	 = 0.0	      ;// u intrinsic
    row.coeff[1]	 = 0.000936669;// u cross
    row.coeff[2]	 = 0.000496741;// u drift
    row.coeff[3]	 = 0.00018648 ;// z intrinsic
    row.coeff[4]	 = 0.00507244 ;// z dip
    row.coeff[5]	 = 0.002654   ;// z drift
tableSet->AddAt(&row);
// ----------------- end of code ---------------
