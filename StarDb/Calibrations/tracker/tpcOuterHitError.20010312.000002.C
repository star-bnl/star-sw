...
//                                        hit errors are squared !
    row.coeff[0]	 =   0.016;    // u intrinsic;
    row.coeff[1]	 =   0.004;    // u cross;
    row.coeff[2]	 =   0.04;     // u drift;
    row.coeff[3]	 =   0.016;    // z intrinsic;
    row.coeff[4]	 =   0.032;    // z dip;
    row.coeff[5]	 =   0.09;     // z drift;
tableSet->AddAt(&row);
// ----------------- end of code ---------------
