TDataSet *CreateTable() {
        ...
        row.a[1]     = 0; // This is the offset of the linear correlation of the deltaZ vs. epdMaxTac;
        row.a[2]     = 0; // This is the slope of the linear correlation of the deltaZ vs. epdMaxTac;
        row.a[3]     =          0;
        row.a[4]     =          0;
        row.a[5]     =          0;
        row.a[6]     =          0;
        ...
        row.a[8]     =          0;
        row.a[9]     =          0;
        strcpy(row.comment,"FXT2020_31.2e");
        tableSet->AddAt(&row);
        // ----------------- end of code ---------------
