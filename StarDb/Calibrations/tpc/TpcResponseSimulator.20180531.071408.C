...
#if 0
  row.NoZC                  = 3;
  const Double_t ZC[12] = {// ~/work/Tpc/TpcRS/TpcRS_2018_3p85GeV_fixedTarget.B/dEdx/Fit/Z3CGFdEdx.root
    1.03374e-01, -2.46698e-03,  6.81752e-06, // FitP->Draw("mu:y","i&&j&&x>0 &&x <40.5&abs(mu)<0.5","prof"); htemp->Fit("pol2","er","",20,205)
    1.44904e-01, -3.47304e-03,  1.02403e-05, // FitP->Draw("mu:y","i&&j&&x>0 &&x >40.5&abs(mu)<0.5","prof");
   -8.80764e-02,  3.21187e-04, -2.41188e-06, // FitP->Draw("mu:y","i&&j&&x<0 &&x >-40.5&abs(mu)<0.5","prof")
   -6.96558e-02, -2.77831e-04, -2.56334e-07};// FitP->Draw("mu:y","i&&j&&x<0 &&x <-40.5&abs(mu)<0.5","prof")
  Float_t *d = &row.ZCIW[0];
