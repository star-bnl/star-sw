...
TDataSet *CreateTable() { 
  ...
  row.SecRowCorIW[0] = row.SecRowCorIE[0] = 4.39226e-01 + 2.61137e-01 + 1.90407e-02 + 2.51417e-01 + 4.41076e-02 + 1.57462e-02; //SecRow3CGFdEdx + Hijing.AuAu200.VMCE-bbc2/dEdx/SecRow3CGFdEdx
  row.SecRowCorIW[1] = row.SecRowCorIE[1] = 1.76094e-02 - 1.30348e-02; //
  row.SecRowCorOW[0] = row.SecRowCorOE[0] = 1.00611e+00 + 1.52493e-01 + 4.52381e-03 -2.04887e-02 -7.84267e-04 + 7.10599e-04; //
