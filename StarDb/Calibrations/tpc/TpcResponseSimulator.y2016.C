...
TDataSet *CreateTable() { 
  ...
  row.SecRowCorIW[0] = row.SecRowCorIE[0] = 6.99114715017355337e-01 -2.89902e-02;
  row.SecRowCorIW[1] = row.SecRowCorIE[1] = 3.78096e-03;
  row.SecRowCorOW[0] = row.SecRowCorOE[0] = 9.79357470004933006e-01+5.32347e-02;//
