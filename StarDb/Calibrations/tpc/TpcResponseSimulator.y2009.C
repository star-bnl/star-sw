// $Id: TpcResponseSimulator.y2009.C,v 1.8 2011/10/11 19:09:23 fisyak Exp $
...
TDataSet *CreateTable() { 
  ...
  row.tauCI                 =   0;  
  row.tauCO                 =   0;  
  row.SigmaJitterTI         = 0.0; //C: 0.5129;//0.0;//i 0.2; //g 0.0; //f  0.2;//ad  0.0;// b for Tpx inner 
  row.SigmaJitterTO         = 0.2; //C: 0.4446;// 0.2;//i 0.2; //g 0.0; //f  0.2;//ad  0.0;// b for Tpx outer 
  row.SigmaJitterXI         = 0.1998;
  row.SigmaJitterXO         = 0.0890;
...
/* E  */	0.298714-6.67437e-02,	-0.0026277,	0.281434+1.503243-02,	-0.000255795};
  ...
  row.T0offset   =  0.25+4.62419e-01 - 1.17813; //  TpcT->Draw("fRcHit.mMcl_t/64-3.0*0.055*Frequency-fMcHit.mMcl_t:fMcHit.mPosition.mX3>>T(210,-210,210,100,-2,3)","fNoMcHit==1&&fNoRcHit==1&&fRcHit.mQuality>90","colz")
  tableSet->AddAt(&row);
  // ----------------- end of code ---------------
