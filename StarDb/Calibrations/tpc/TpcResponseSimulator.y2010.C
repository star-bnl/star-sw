// $Id: TpcResponseSimulator.y2010.C,v 1.16 2018/12/09 23:21:53 fisyak Exp $
// $Log: TpcResponseSimulator.y2010.C,v $
// Revision 1.16  2018/12/09 23:21:53  fisyak
...
TDataSet *CreateTable() { 
  ...
  row.SecRowCorIW[0] = row.SecRowCorIE[0] = 1.03997021501735532e+00 -5.20617e-02 -2.66317e-01 +8.35970e-03;
  row.SecRowCorIW[1] = row.SecRowCorIE[1] = 1.18001e-03                          +4.18319e-03;
  row.SecRowCorOW[0] = row.SecRowCorOE[0] = 9.87120370004933023e-01 +9.46730e-03 -9.85233e-02 +1.28629e-02;
  row.SecRowCorOW[1] = row.SecRowCorOE[1] =                                                    7.53993e-04;
