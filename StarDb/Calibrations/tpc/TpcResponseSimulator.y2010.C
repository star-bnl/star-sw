// $Id: TpcResponseSimulator.y2010.C,v 1.10 2011/10/12 15:19:09 fisyak Exp $
// $Log: TpcResponseSimulator.y2010.C,v $
// Revision 1.10  2011/10/12 15:19:09  fisyak
// Step back with the parameter adjustments, it is not ready yet
//
