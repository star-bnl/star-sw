...
TDataSet *CreateTable() { 
  ...
  row.SecRowCorIW[0] = row.SecRowCorIE[0] = 4.39226e-01 + 2.61137e-01 + 1.90407e-02 + 2.51417e-01 + 4.41076e-02 + 1.57462e-02 -7.23038e-02 - 0.199; //SecRow3CGFdEdx + Hijing.AuAu200.VMCE-bbc2/dEdx/SecRow3CGFdEdx // IRAKLI : adding -0.199 to fix ~20% gap between I and O
