// $Id: TpcResponseSimulator.y2017.C,v 1.2 2018/12/03 22:42:18 fisyak Exp $
...
TDataSet *CreateTable() { 
  ...
  row.SecRowCorIW[0] = row.SecRowCorIE[0] = 6.99114715017355337e-01 + 3.64059e-02;//- TMath::Log(0.533*0.843485) -5.84129e-01 + 4.52885e-01 + 3.09117e-02;
  row.SecRowCorIW[1] = row.SecRowCorIE[1] =                           3.02959e-03;
  row.SecRowCorOW[0] = row.SecRowCorOE[0] = 9.79357470004933006e-01 + 8.13816e-02;//- TMath::Log(0.512*0.725267) -5.47141e-01 + 5.23937e-01 + 1.19154e-02;
