TDataSet *CreateTable() { 
  ...
  row.a[0]       =  1.64505e+00 +1.33977e-02;// FitP->Draw("mu:y>>I(100,23,207)","i&&j&&i<=13","prof")
  row.a[1]       = -7.33017e-02 -5.90723e-05;// I->Fit("pol6","e")
  row.a[2]       =  1.38702e-03 ;
  row.a[3]       = -1.38615e-05 ;
  row.a[4]       =  7.64845e-08 ;
  row.a[5]       = -2.21036e-10 ;
 ...
 tableSet->AddAt(&row);
  ...
  row.a[0]       =   2.08300e-01+1.31539e-02;// FitP->Draw("mu:y>>X(45,26,207)","i&&j&&i<=40","prof")
  row.a[1]       =  -6.91004e-03-2.47918e-05;// X->Fit("pol5","e")
  row.a[2]       =   1.11790e-04;
  row.a[3]       =  -9.28394e-07;
  row.a[4]       =   3.73387e-09;
  row.a[5]       =  -5.83606e-12;
