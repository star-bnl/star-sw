// $Id: TpcResponseSimulator.devTD.C,v 1.1 2013/01/15 23:06:09 fisyak Exp $
// $Log: TpcResponseSimulator.devTD.C,v $
...
TDataSet *CreateTable() { 
  ...
  row.SecRowCorIW[0] = row.SecRowCorIE[0] = 6.99114715017355337e-01 +1.14433e-01 -4.42836e-02;//- TMath::Log(0.533*0.843485) -5.84129e-01 + 4.52885e-01 + 3.09117e-02;
  row.SecRowCorOW[0] = row.SecRowCorOE[0] = 9.79357470004933006e-01 -6.15827e-02 +5.75781e-02;//- TMath::Log(0.512*0.725267) -5.47141e-01 + 5.23937e-01 + 1.19154e-02;
