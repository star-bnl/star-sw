// $Id: TpcPadCorrection.eStar2.C,v 1.1 2013/08/12 13:55:44 fisyak Exp $
TDataSet *CreateTable() { 
  ...
  for (Int_t i = 0; i < n; i++) {
    tableSet->AddAt(&row[i].HistName, i);
  }
  return (TDataSet *)tableSet;
}
// $Log: TpcPadCorrection.eStar2.C,v $
// Revision 1.1  2013/08/12 13:55:44  fisyak
// eStar2 parameters
//
