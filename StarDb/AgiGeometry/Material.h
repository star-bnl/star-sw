...
void Material() {
  ...
  TGeoMaterial *mat = 0;
  Int_t imat = 0;
mat = new TGeoMaterial("VACUUM",    1.E-16,1.E-16,       1.E-16); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("HYDROGEN",     1.01,     1,0.7080000E-01); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("DEUTERIUM",    2.01, 1,0.162); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("HELIUM",       4   , 2,0.125); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("LITHIUM",      6.94, 3,0.534); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("BERILLIUM",    9.01, 4,1.848); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("NITROGEN_GAS",14.01, 7,0.1164676E-02); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("OXIGEN_GAS",  16   , 8,0.1332389E-02); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("SILICON",     28.09,14,2.33); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("ARGON_GAS",   39.95,18,0.1658498E-02); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("LIQUID_ARGON",39.95,18,1.4); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("CARBON",    12.01, 6,2.265); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("NITROGEN",  14.01, 7,0.808); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("NEON",      20.18,10,1.207); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("ALUMINIUM", 26.98,13,2.7); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("IRON",      55.85,26,7.87); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("COPPER",    63.54,29,8.96); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("TUNGSTEN", 183.85,74,19.3); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("LEAD",     207.19,82,11.35); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("URANIUM",  238.03,92,18.95); mat->SetUniqueID(++imat);
//mat = new TGeoMaterial("AIR",14.61,7.3,0.1205000E-02); mat->SetUniqueID(++imat);
...
mat = new TGeoMaterial("PIPE",26.98,13,2.7); mat->SetUniqueID(++imat);
...
mix = new TGeoMixture("SVTT_CH2",2,  0.935000    );mix->SetUniqueID(++imat);
    mix->DefineElement(0,12,6,0.8571429);
    mix->DefineElement(1,1,1,0.1428571);
mat = new TGeoMaterial("SVTT_PYREX",20.719,10.307,2.23); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("SVTT_SENSITIVE",28.09,14,2.33); mat->SetUniqueID(++imat);
//mat = new TGeoMaterial("SVTT_SENSSI"   ,28.09,14,2.33); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("SVTT_NONSENSSILI",28.09,14,2.33); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("SVTT_NONSENSSI",28.09,14,2.33); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("SVTT_NONSENSSIL",28.09,14,2.33); mat->SetUniqueID(++imat);
...
mat = new TGeoMaterial("TPCE_SENSITIVE_GAS",38.69149,17.43617,0.1540534E-02); mat->SetUniqueID(++imat);
...
mat = new TGeoMaterial("FTPC_PYREX",20.719,10.307,2.23); mat->SetUniqueID(++imat);
...
mix = new TGeoMixture("VPDD_G10",5,   1.70000    );mix->SetUniqueID(++imat);
    ...
    mix->DefineElement(3,1,1,0.3218391E-01);
    mix->DefineElement(4,16,8,0.1471264);
mat = new TGeoMaterial("CALB_EALUMINIUM",26.98,13,2.7); mat->SetUniqueID(++imat);
...
mat = new TGeoMaterial("CALB_CPOLYSTYREN",11.15385,5.615385,1.032); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("CALB_CLEAD",207.19,82,11.35); mat->SetUniqueID(++imat);
mix = new TGeoMixture("CALB_G10",5,   1.70000    );mix->SetUniqueID(++imat);
    ...
    mix->DefineElement(3,1,1,0.3218391E-01);
    mix->DefineElement(4,16,8,0.1471264);
mat = new TGeoMaterial("CALB_CALUMINIUM",26.98,13,2.7); mat->SetUniqueID(++imat);
...
mat = new TGeoMaterial("RICH_CARBONIO",12.01,6,2.265); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("RICH_ANODE",63.54,29,8.96); mat->SetUniqueID(++imat);
...
mat = new TGeoMaterial("ECAL_CAIR",14.61,7.3,0.1205000E-02); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("ECAL_CLEAD",207.19,82,11.35); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("ECAL_CALUMINIUM",26.98,13,2.7); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("ECAL_CPOLYSTYREN",11.15385,5.615385,1.032); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("ECAL_AIR",55.85,26,7.87); mat->SetUniqueID(++imat);
...
mix = new TGeoMixture("BBCM_ALKAP",4,   1.43200    );mix->SetUniqueID(++imat);
    ...
    mix->DefineElement(2,16,8,0.3130644);
    mix->DefineElement(3,27,13,0.6080688E-01);
mat = new TGeoMaterial("BBCM_CPOLYSTYREN",11.15385,5.615385,1.032); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("FPDM_CAIR",14.61,7.3,0.1205000E-02); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("FPDM_CPOLYSTYREN",11.15385,5.615385,1.032); mat->SetUniqueID(++imat);
mix = new TGeoMixture("FPDM_G10",5,   1.70000    );mix->SetUniqueID(++imat);
    ...
    mix->DefineElement(3,1,1,0.3218391E-01);
    mix->DefineElement(4,16,8,0.1471264);
mat = new TGeoMaterial("FPDM_CLEAD",207.19,82,11.35); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("FPDM_CALUMINIUM",26.98,13,2.7); mat->SetUniqueID(++imat);
...
mat = new TGeoMaterial("ZCAL_DIRTY_LEAD",207.19,82,11.35); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("ZCAL_SCINTILLATOR",11.15385,5.615385,1.032); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("PIXL_SENSITIVE",28.09,14,2.33); mat->SetUniqueID(++imat);
...
mat = new TGeoMaterial("ISTB_SENSITIVE",28.09,14,2.33); mat->SetUniqueID(++imat);
...
mat = new TGeoMaterial("FSTD_SENSITIVE",28.09,14,2.33); mat->SetUniqueID(++imat);
...
mix = new TGeoMixture("FGTD_AR_MIX",3,  0.180150E-02);mix->SetUniqueID(++imat);
    ...
    mix->DefineElement(1,12.01,6,0.2728926E-01);
    mix->DefineElement(2,16,8,0.7271075E-01);
mat = new TGeoMaterial("FGTD_SENSITIVE",37.44611,8,0.1801500E-02); mat->SetUniqueID(++imat);
...
mix = new TGeoMixture("IGTD_AR_MIX",3,  0.180150E-02);mix->SetUniqueID(++imat);
    ...
    mix->DefineElement(1,12.01,6,0.2728926E-01);
    mix->DefineElement(2,16,8,0.7271075E-01);
mat = new TGeoMaterial("IGTD_SENSITIVE",37.44611,8,0.1801500E-02); mat->SetUniqueID(++imat);
mat = new TGeoMaterial("HPDT_SENSITIVE",28.09,14,2.33); mat->SetUniqueID(++imat);
