...
void tpcBuilder::initialize(int argc, char *argv[]) {
 ...
 extras.cl_tpx_chargeStep_s1 = new TH1D("cl_tpx_chargeStep_s1","iTPC adc vs time sector#1",512,0,512);
  ...
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s1);
  ...
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s18);
  ...
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s20);
  // plots[n]->logy = 1; plots[n]->logy = 1;
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s21);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s21);
  ...
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s1);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s2);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s2);
  ...
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s16);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s17);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s17);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s18);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s18);
