...
//
//   March 24
//   Added histogramf #bytes read out for RDO's 
//   Added some histogram since in 23 the clusterfinder for very low signals in time ~8-10
//   it spills over into negative time bins which it should not. These are recorded in histogram
//   that are showed in the charge steps plot. Occupancy is ~ 1:1o**3 for those low timebins
...
void tpcBuilder::initialize(int argc, char *argv[]) {
  ...
  contents.tpc_rdo_bytes = new TH1D("tpc_rdo_bytes","TPX Total bytes per RDO",
				    24*6,0.5,144.5);
  contents.itpc_rdo_bytes = new TH1D("itpc_rdo_bytes","iTPC Total bytes per RDO",
				    24*4,0.5,96.5);
  ...
  // tpx only
  //
  contents.h_tpx_chargeStep_s1 = new TH1D("h_tpx_chargeStep_s1","TPX adc vs time sector#1",512,0,512);
  contents.h_tpx_chargeStep_s2 = new TH1D("h_tpx_chargeStep_s2","TPX adc vs time sector#2",512,0,512);
  contents.h_tpx_chargeStep_s3 = new TH1D("h_tpx_chargeStep_s3","TPX adc vs time sector#3",512,0,512);
  contents.h_tpx_chargeStep_s4 = new TH1D("h_tpx_chargeStep_s4","TPX adc vs time sector#4",512,0,512);
  contents.h_tpx_chargeStep_s5 = new TH1D("h_tpx_chargeStep_s5","TPX adc vs time sector#5",512,0,512);
  contents.h_tpx_chargeStep_s6 = new TH1D("h_tpx_chargeStep_s6","TPX adc vs time sector#6",512,0,512);
  contents.h_tpx_chargeStep_s7 = new TH1D("h_tpx_chargeStep_s7","TPX adc vs time sector#7",512,0,512);
  contents.h_tpx_chargeStep_s8 = new TH1D("h_tpx_chargeStep_s8","TPX adc vs time sector#8",512,0,512);
  contents.h_tpx_chargeStep_s9 = new TH1D("h_tpx_chargeStep_s9","TPX adc vs time sector#9",512,0,512);
  contents.h_tpx_chargeStep_s10 = new TH1D("h_tpx_chargeStep_s10","TPX adc vs time sector#10",512,0,512);
  contents.h_tpx_chargeStep_s11 = new TH1D("h_tpx_chargeStep_s11","TPX adc vs time sector#11",512,0,512);
  contents.h_tpx_chargeStep_s12 = new TH1D("h_tpx_chargeStep_s12","TPX adc vs time sector#12",512,0,512);
  contents.h_tpx_chargeStep_s13 = new TH1D("h_tpx_chargeStep_s13","TPX adc vs time sector#13",512,0,512);
  contents.h_tpx_chargeStep_s14 = new TH1D("h_tpx_chargeStep_s14","TPX adc vs time sector#14",512,0,512);
  contents.h_tpx_chargeStep_s15 = new TH1D("h_tpx_chargeStep_s15","TPX adc vs time sector#15",512,0,512);
  contents.h_tpx_chargeStep_s16 = new TH1D("h_tpx_chargeStep_s16","TPX adc vs time sector#16",512,0,512);
  contents.h_tpx_chargeStep_s17 = new TH1D("h_tpx_chargeStep_s17","TPX adc vs time sector#17",512,0,512);
  contents.h_tpx_chargeStep_s18 = new TH1D("h_tpx_chargeStep_s18","TPX adc vs time sector#18",512,0,512);
  contents.h_tpx_chargeStep_s19 = new TH1D("h_tpx_chargeStep_s19","TPX adc vs time sector#19",512,0,512);
  contents.h_tpx_chargeStep_s20 = new TH1D("h_tpx_chargeStep_s20","TPX adc vs time sector#20",512,0,512);
  contents.h_tpx_chargeStep_s21 = new TH1D("h_tpx_chargeStep_s21","TPX adc vs time sector#21",512,0,512);
  contents.h_tpx_chargeStep_s22 = new TH1D("h_tpx_chargeStep_s22","TPX adc vs time sector#22",512,0,512);
  contents.h_tpx_chargeStep_s23 = new TH1D("h_tpx_chargeStep_s23","TPX adc vs time sector#23",512,0,512);
  ...
  extras.bad_cl_itpc_chargeStep_s1 = new TH1D("bad_cl_itpc_chargeStep_s1","iTPC adc vs time sector#1",512,0,512);
  extras.bad_cl_itpc_chargeStep_s2 = new TH1D("bad_cl_itpc_chargeStep_s2","iTPC adc vs time sector#2",512,0,512);
  extras.bad_cl_itpc_chargeStep_s3 = new TH1D("bad_cl_itpc_chargeStep_s3","iTPC adc vs time sector#3",512,0,512);
  extras.bad_cl_itpc_chargeStep_s4 = new TH1D("bad_cl_itpc_chargeStep_s4","iTPC adc vs time sector#4",512,0,512);
  extras.bad_cl_itpc_chargeStep_s5 = new TH1D("bad_cl_itpc_chargeStep_s5","iTPC adc vs time sector#5",512,0,512);
  extras.bad_cl_itpc_chargeStep_s6 = new TH1D("bad_cl_itpc_chargeStep_s6","iTPC adc vs time sector#6",512,0,512);
  extras.bad_cl_itpc_chargeStep_s7 = new TH1D("bad_cl_itpc_chargeStep_s7","iTPC adc vs time sector#7",512,0,512);
  extras.bad_cl_itpc_chargeStep_s8 = new TH1D("bad_cl_itpc_chargeStep_s8","iTPC adc vs time sector#8",512,0,512);
  extras.bad_cl_itpc_chargeStep_s9 = new TH1D("bad_cl_itpc_chargeStep_s9","iTPC adc vs time sector#9",512,0,512);
  extras.bad_cl_itpc_chargeStep_s10 = new TH1D("bad_cl_itpc_chargeStep_s10","iTPC adc vs time sector#10",512,0,512);
  extras.bad_cl_itpc_chargeStep_s11 = new TH1D("bad_cl_itpc_chargeStep_s11","iTPC adc vs time sector#11",512,0,512);
  extras.bad_cl_itpc_chargeStep_s12 = new TH1D("bad_cl_itpc_chargeStep_s12","iTPC adc vs time sector#12",512,0,512);
  extras.bad_cl_itpc_chargeStep_s13 = new TH1D("bad_cl_itpc_chargeStep_s13","iTPC adc vs time sector#13",512,0,512);
  extras.bad_cl_itpc_chargeStep_s14 = new TH1D("bad_cl_itpc_chargeStep_s14","iTPC adc vs time sector#14",512,0,512);
  extras.bad_cl_itpc_chargeStep_s15 = new TH1D("bad_cl_itpc_chargeStep_s15","iTPC adc vs time sector#15",512,0,512);
  extras.bad_cl_itpc_chargeStep_s16 = new TH1D("bad_cl_itpc_chargeStep_s16","iTPC adc vs time sector#16",512,0,512);
  extras.bad_cl_itpc_chargeStep_s17 = new TH1D("bad_cl_itpc_chargeStep_s17","iTPC adc vs time sector#17",512,0,512);
  extras.bad_cl_itpc_chargeStep_s18 = new TH1D("bad_cl_itpc_chargeStep_s18","iTPC adc vs time sector#18",512,0,512);
  extras.bad_cl_itpc_chargeStep_s19 = new TH1D("bad_cl_itpc_chargeStep_s19","iTPC adc vs time sector#19",512,0,512);
  extras.bad_cl_itpc_chargeStep_s20 = new TH1D("bad_cl_itpc_chargeStep_s20","iTPC adc vs time sector#20",512,0,512);
  extras.bad_cl_itpc_chargeStep_s21 = new TH1D("bad_cl_itpc_chargeStep_s21","iTPC adc vs time sector#21",512,0,512);
  extras.bad_cl_itpc_chargeStep_s22 = new TH1D("bad_cl_itpc_chargeStep_s22","iTPC adc vs time sector#22",512,0,512);
  extras.bad_cl_itpc_chargeStep_s23 = new TH1D("bad_cl_itpc_chargeStep_s23","iTPC adc vs time sector#23",512,0,512);
  extras.bad_cl_itpc_chargeStep_s24 = new TH1D("bad_cl_itpc_chargeStep_s24","iTPC adc vs time sector#24",512,0,512);

  extras.bad_cl_tpx_chargeStep_s1 = new TH1D("bad_cl_tpx_chargeStep_s1","TPX adc vs time sector#1",512,0,512);
  extras.bad_cl_tpx_chargeStep_s2 = new TH1D("bad_cl_tpx_chargeStep_s2","TPX adc vs time sector#2",512,0,512);
  extras.bad_cl_tpx_chargeStep_s3 = new TH1D("bad_cl_tpx_chargeStep_s3","TPX adc vs time sector#3",512,0,512);
  extras.bad_cl_tpx_chargeStep_s4 = new TH1D("bad_cl_tpx_chargeStep_s4","TPX adc vs time sector#4",512,0,512);
  extras.bad_cl_tpx_chargeStep_s5 = new TH1D("bad_cl_tpx_chargeStep_s5","TPX adc vs time sector#5",512,0,512);
  extras.bad_cl_tpx_chargeStep_s6 = new TH1D("bad_cl_tpx_chargeStep_s6","TPX adc vs time sector#6",512,0,512);
  extras.bad_cl_tpx_chargeStep_s7 = new TH1D("bad_cl_tpx_chargeStep_s7","TPX adc vs time sector#7",512,0,512);
  extras.bad_cl_tpx_chargeStep_s8 = new TH1D("bad_cl_tpx_chargeStep_s8","TPX adc vs time sector#8",512,0,512);
  extras.bad_cl_tpx_chargeStep_s9 = new TH1D("bad_cl_tpx_chargeStep_s9","TPX adc vs time sector#9",512,0,512);
  extras.bad_cl_tpx_chargeStep_s10 = new TH1D("bad_cl_tpx_chargeStep_s10","TPX adc vs time sector#10",512,0,512);
  extras.bad_cl_tpx_chargeStep_s11 = new TH1D("bad_cl_tpx_chargeStep_s11","TPX adc vs time sector#11",512,0,512);
  extras.bad_cl_tpx_chargeStep_s12 = new TH1D("bad_cl_tpx_chargeStep_s12","TPX adc vs time sector#12",512,0,512);
  extras.bad_cl_tpx_chargeStep_s13 = new TH1D("bad_cl_tpx_chargeStep_s13","TPX adc vs time sector#13",512,0,512);
  extras.bad_cl_tpx_chargeStep_s14 = new TH1D("bad_cl_tpx_chargeStep_s14","TPX adc vs time sector#14",512,0,512);
  extras.bad_cl_tpx_chargeStep_s15 = new TH1D("bad_cl_tpx_chargeStep_s15","TPX adc vs time sector#15",512,0,512);
  extras.bad_cl_tpx_chargeStep_s16 = new TH1D("bad_cl_tpx_chargeStep_s16","TPX adc vs time sector#16",512,0,512);
  extras.bad_cl_tpx_chargeStep_s17 = new TH1D("bad_cl_tpx_chargeStep_s17","TPX adc vs time sector#17",512,0,512);
  extras.bad_cl_tpx_chargeStep_s18 = new TH1D("bad_cl_tpx_chargeStep_s18","TPX adc vs time sector#18",512,0,512);
  extras.bad_cl_tpx_chargeStep_s19 = new TH1D("bad_cl_tpx_chargeStep_s19","TPX adc vs time sector#19",512,0,512);
  extras.bad_cl_tpx_chargeStep_s20 = new TH1D("bad_cl_tpx_chargeStep_s20","TPX adc vs time sector#20",512,0,512);
  extras.bad_cl_tpx_chargeStep_s21 = new TH1D("bad_cl_tpx_chargeStep_s21","TPX adc vs time sector#21",512,0,512);
  extras.bad_cl_tpx_chargeStep_s22 = new TH1D("bad_cl_tpx_chargeStep_s22","TPX adc vs time sector#22",512,0,512);
  extras.bad_cl_tpx_chargeStep_s23 = new TH1D("bad_cl_tpx_chargeStep_s23","TPX adc vs time sector#23",512,0,512);
  extras.bad_cl_tpx_chargeStep_s24 = new TH1D("bad_cl_tpx_chargeStep_s24","TPX adc vs time sector#24",512,0,512);

#endif

  extras.cl_tpx_chargeStep_s1 = new TH1D("cl_tpx_chargeStep_s1","TPX adc vs time sector#1",512,0,512);
  extras.cl_tpx_chargeStep_s2 = new TH1D("cl_tpx_chargeStep_s2","TPX adc vs time sector#2",512,0,512);
  extras.cl_tpx_chargeStep_s3 = new TH1D("cl_tpx_chargeStep_s3","TPX adc vs time sector#3",512,0,512);
  extras.cl_tpx_chargeStep_s4 = new TH1D("cl_tpx_chargeStep_s4","TPX adc vs time sector#4",512,0,512);
  extras.cl_tpx_chargeStep_s5 = new TH1D("cl_tpx_chargeStep_s5","TPX adc vs time sector#5",512,0,512);
  extras.cl_tpx_chargeStep_s6 = new TH1D("cl_tpx_chargeStep_s6","TPX adc vs time sector#6",512,0,512);
  extras.cl_tpx_chargeStep_s7 = new TH1D("cl_tpx_chargeStep_s7","TPX adc vs time sector#7",512,0,512);
  extras.cl_tpx_chargeStep_s8 = new TH1D("cl_tpx_chargeStep_s8","TPX adc vs time sector#8",512,0,512);
  extras.cl_tpx_chargeStep_s9 = new TH1D("cl_tpx_chargeStep_s9","TPX adc vs time sector#9",512,0,512);
  extras.cl_tpx_chargeStep_s10 = new TH1D("cl_tpx_chargeStep_s10","TPX adc vs time sector#10",512,0,512);
  extras.cl_tpx_chargeStep_s11 = new TH1D("cl_tpx_chargeStep_s11","TPX adc vs time sector#11",512,0,512);
  extras.cl_tpx_chargeStep_s12 = new TH1D("cl_tpx_chargeStep_s12","TPX adc vs time sector#12",512,0,512);
  extras.cl_tpx_chargeStep_s13 = new TH1D("cl_tpx_chargeStep_s13","TPX adc vs time sector#13",512,0,512);
  extras.cl_tpx_chargeStep_s14 = new TH1D("cl_tpx_chargeStep_s14","TPX adc vs time sector#14",512,0,512);
  extras.cl_tpx_chargeStep_s15 = new TH1D("cl_tpx_chargeStep_s15","TPX adc vs time sector#15",512,0,512);
  extras.cl_tpx_chargeStep_s16 = new TH1D("cl_tpx_chargeStep_s16","TPX adc vs time sector#16",512,0,512);
  extras.cl_tpx_chargeStep_s17 = new TH1D("cl_tpx_chargeStep_s17","TPX adc vs time sector#17",512,0,512);
  extras.cl_tpx_chargeStep_s18 = new TH1D("cl_tpx_chargeStep_s18","TPX adc vs time sector#18",512,0,512);
  extras.cl_tpx_chargeStep_s19 = new TH1D("cl_tpx_chargeStep_s19","TPX adc vs time sector#19",512,0,512);
  extras.cl_tpx_chargeStep_s20 = new TH1D("cl_tpx_chargeStep_s20","TPX adc vs time sector#20",512,0,512);
  extras.cl_tpx_chargeStep_s21 = new TH1D("cl_tpx_chargeStep_s21","TPX adc vs time sector#21",512,0,512);
  extras.cl_tpx_chargeStep_s22 = new TH1D("cl_tpx_chargeStep_s22","TPX adc vs time sector#22",512,0,512);
  extras.cl_tpx_chargeStep_s23 = new TH1D("cl_tpx_chargeStep_s23","TPX adc vs time sector#23",512,0,512);
  extras.cl_tpx_chargeStep_s24 = new TH1D("cl_tpx_chargeStep_s24","TPX adc vs time sector#24",512,0,512);
  ...
  //
  // Add the rdo bytes plots
  //
  plots[++n] = new JevpPlot(contents.tpc_rdo_bytes);
  plots[n]->optstat=0;
  plots[++n] = new JevpPlot(contents.itpc_rdo_bytes);
  plots[n]->optstat=0;
  ...
  //
#if fvd
  cout << "Add charge steps " << endl;
#endif
  int pl_qs_idx = n+1;
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s1);
  plots[n]->logy = 1; 
  plots[n]->addHisto(extras.cl_itpc_chargeStep_s1);
  plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s1);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s2);
  plots[n]->logy = 1; 
  plots[n]->addHisto(extras.cl_itpc_chargeStep_s2);
  plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s2);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s3);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s3);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s3);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s4);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s4);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s4);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s5);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s5);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s5);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s6);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s6);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s6);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s7);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s7);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s7);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s8);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s8);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s8);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s9);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s9);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s9);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s10);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s10);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s10);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s11);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s11);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s11);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s12);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s12);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s12);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s13);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s13);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s13);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s14);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s14);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s14);
  ...
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s16);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s16);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s17);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s17);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s17);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s18);
  plots[n]->addHisto(extras.cl_itpc_chargeStep_s18);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s18);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s19);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s19);
  plots[n]->logy = 1; plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s19);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s20);
  plots[n]->logy = 1; 
  plots[n]->addHisto(extras.cl_itpc_chargeStep_s20);
  plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s20);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s21);
  plots[n]->logy = 1; 
  plots[n]->addHisto(extras.cl_itpc_chargeStep_s21);
  plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s21);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s22);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s22);
  plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s22);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s23);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s23);
  plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s23);
  plots[++n] = new JevpPlot(contents.h_itpc_chargeStep_s24);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_itpc_chargeStep_s24);
  plots[n]->addHisto(extras.bad_cl_itpc_chargeStep_s24);

  cout << "creating tpx charge steps " << endl;
  int pl_qs_idx_tpx = n+1;
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s1);
  plots[n]->logy = 1; 
  plots[n]->addHisto(extras.cl_tpx_chargeStep_s1);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s1);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s2);
  plots[n]->logy = 1; 
  plots[n]->addHisto(extras.cl_tpx_chargeStep_s2);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s2);
  ...
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s4);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s4);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s5);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s5);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s5);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s6);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s6);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s6);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s7);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s7);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s7);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s8);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s8);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s8);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s9);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s9);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s9);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s10);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s10);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s10);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s11);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s11);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s11);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s12);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s12);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s12);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s13);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s13);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s13);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s14);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s14);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s14);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s15);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s15);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s15);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s16);
  plots[n]->logy = 1; 
  plots[n]->addHisto(extras.cl_tpx_chargeStep_s16);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s17);
  ...
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s18);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s19);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s19);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s19);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s20);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s20);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s20);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s21);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s21);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s21);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s22);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s22);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s22);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s23);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s23);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s23);
  plots[++n] = new JevpPlot(contents.h_tpx_chargeStep_s24);
  plots[n]->logy = 1; plots[n]->addHisto(extras.cl_tpx_chargeStep_s24);
  plots[n]->addHisto(extras.bad_cl_tpx_chargeStep_s24);
  ...
  //
  // indices for blocks into the contents and extras offsets
  // the plot_ offsets are updated during adding plots
  //
  //
  ...
  long bad_cl_qs_idx  = ((long)&extras.bad_cl_itpc_chargeStep_s1 - (long)extras.array) / (sizeof(TH1 *));
  ...
  long bad_cl_qs_idx_tpx  = ((long)&extras.bad_cl_tpx_chargeStep_s1 - (long)extras.array) / (sizeof(TH1 *));
  ...
  for(int i=0;i<24;i++) {
    ...
    plots[i+pl_qs_idx]->getHisto(2)->setLegText("bad clds");
    plots[i+pl_qs_idx]->getHisto(0)->setLegArgs("l");
    plots[i+pl_qs_idx]->getHisto(1)->setLegArgs("l");
    plots[i+pl_qs_idx]->getHisto(2)->setLegArgs("l");
...
void tpcBuilder::event(daqReader *rdr)
{
  ...
  double tb_bad_charge_counts_cl[512];
  ...
  for(int s=1;s<=24;s++) {
    ...
    daq_dta *ddr = rdr->det("tpx")->get("raw",s);
    while(ddr&&ddr->iterate()){
      //      cout << "sector " << s << "  rdo " << ddr->rdo << " " << ddr->ncontent << endl;
      contents.tpc_rdo_bytes->Fill((s-1)*6+ddr->rdo, ddr->ncontent);
    }
    
    daq_dta *ddi = rdr->det("itpc")->get("raw",s);
    while(ddi&&ddi->iterate()){
      //      cout << "sector " << s << "  rdo " << ddi->rdo << " " << ddi->ncontent << endl;
      contents.itpc_rdo_bytes->Fill((s-1)*4+ddi->rdo, ddi->ncontent);
    }
    ...
    memset(tb_charge_counts_cl, 0, sizeof(tb_charge_counts_cl));
    memset(tb_bad_charge_counts_cl, 0, sizeof(tb_bad_charge_counts_cl));
	...
	for(u_int i=0;i<dd->ncontent;i++) {
	  ...
	  if((dd->cld[i].flags==0) || (dd->cld[i].flags==2)) {
	    if((dd->cld[i].t2 - dd->cld[i].t1)*(dd->cld[i].p2 - dd->cld[i].p1) <0) {
#if fvd
	      cout << "negative pixel event no " << event_no << " iTPC sector "  << s << " row " << dd->row << endl;
	      cout << " time ( " << dd->cld[i].t2 << " " <<  dd->cld[i].t1 << " ) pads ( " << dd->cld[i].p2 << " , "  << dd->cld[i].p1 <<endl;	    
	      cout << " tb " << dd->cld[i].tb << " pad " << dd->cld[i].pad << endl;
#endif
	    tb_bad_charge_counts_cl[(int)dd->cld[i].tb] += dd->cld[i].charge;
	    ...
	    int tb_wd = dd->cld[i].t2 - dd->cld[i].t1;
	    if(tb_wd<0) tb_wd=0;
	    ((TH2D*)contents.cl_width_itpc_tb)->Fill(s,tb_wd);
	 ...
	 total_cluster += noClustiTPC;
    } // dd itpc

    if(has_cld) {
      for(int i=0;i<512;i++) {
	extras.array[s + cl_qs_idx - 1]->Fill(i,tb_charge_counts_cl[i]);
	extras.array[s + bad_cl_qs_idx - 1]->Fill(i,tb_bad_charge_counts_cl[i]);
      }
    }
    for(int i=1;i<Npads1;i++) {
      for(int j=1;j<41;j++) {
	...
	for(u_int i=0;i<dd->ncontent;i++) {
	  ...
	  if(((dd->cld[i].flags==0)) || (dd->cld[i].flags==2)) {
	    ...
	    if((dd->cld[i].t2 - dd->cld[i].t1)*(dd->cld[i].p2 - dd->cld[i].p1) <0) {
	      tb_bad_charge_counts_cl[(int)dd->cld[i].tb] += dd->cld[i].charge;
#if fvd
	      cout << "negative pixel event no " << event_no << " TPX sector "  << s << "row " << dd->row+27 << endl;
	      cout << " time ( " << dd->cld[i].t2 << " " <<  dd->cld[i].t1 << " ) pads ( " << dd->cld[i].p2 << " , "  << dd->cld[i].p1 <<endl;
	      cout << " tb " << dd->cld[i].tb << " pad " << dd->cld[i].pad << endl;
#endif
	    }
  ...
  case 4:
    ...
    extras.clusters_per_bx->Fill(bunch7bit, total_cluster);
