...
// $Id: StHelix3DPoints.h,v 1.1 2009/12/06 06:47:52 fine Exp $
// $Log: StHelix3DPoints.h,v $
// Revision 1.1  2009/12/06 06:47:52  fine
// Move the Online display package
//
// Revision 1.1.1.1  2007/03/16 16:50:59  fine
//
//
...
public:
        ...
        StHelix3DPoints(StHelix *trackHelix=0,Float_t step=4,Int_t lastPosition=50,Bool_t own = kTRUE);
