...
ClassImp(VPDHiHistogramGroup) ;

VPDHiHistogramGroup::VPDHiHistogramGroup() {
  // For ROOT I/O
...
VPDHiHistogramGroup::VPDHiHistogramGroup(const char* group, const char* subGroup, const char* trigger, const char* detector)
  ...
  h_vpd_cdb[3]->SetYTitle("Hi-Th TAC (west)");

  sprintf(tmpchr,"vpd_tac_east_vs_tac_west");
  h_vpd_tac_east_vs_tac_west = new TH2D(tmpchr,"VPD TAC East vs. TAC West", 400, -1.5, 4095.5, 400, -1.5, 4095.5);
  h_vpd_tac_east_vs_tac_west->SetXTitle("TAC West");
  h_vpd_tac_east_vs_tac_west->SetYTitle("TAC East");

  sprintf(tmpchr,"vpd_vertex_vs_l3_vertex");
...
void VPDHiHistogramGroup::draw(TCanvas* cc) {
...
bool VPDHiHistogramGroup::fill(evpReader* evp, char* datap) { 
