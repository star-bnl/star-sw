...
class L2UpsilonCountsHistogramGroup : public HistogramGroup {
 public:
  ...
  L2UpsilonCountsHistogramGroup(const char* group, const char* subGroup="counts", const char* trigger="ups", const char* detector="any");
  ~L2UpsilonCountsHistogramGroup();
  virtual void reset();
...
/*************************************************************************************
 $Id: L2UpsilonCountsHistogramGroup.h,v 1.2 2009/02/19 22:32:05 genevb Exp $
 *************************************************************************************
 $Log: L2UpsilonCountsHistogramGroup.h,v $
 Revision 1.2  2009/02/19 22:32:05  genevb
