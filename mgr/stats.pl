#!/opt/star/bin/perl
#
# $Id: stats.pl,v 1.1 1999/08/18 13:07:03 wenaus Exp $
#
# $Log: stats.pl,v $
...
print `cat /star/datapool/web/swstat-envlevel.txt`.
    "</pre></td>";

print "<td valign=top><h4>By version</h4><pre>\n";
print `cat /star/datapool/web/swstat-envver.txt`.
    "</pre></td>";

print "<td valign=top><h4>By site</h4><pre>\n";
print `cat /star/datapool/web/swstat-envsites.txt`.
    "</pre></td>";
...
print "<td valign=top><h4>By level</h4><pre>\n";
print `cat /star/datapool/web/swstat-rootlevel.txt`.
    "</pre></td>";

print "<td valign=top><h4>By version</h4><pre>\n";
print `cat /star/datapool/web/swstat-rootver.txt`.
    "</pre></td>";

print "<td valign=top><h4>By site</h4><pre>\n";
print `cat /star/datapool/web/swstat-rootsites.txt`.
    "</pre></td>";
...
print `cat /star/datapool/web/swguide-stats.txt`."</pre></blockquote>\n";
