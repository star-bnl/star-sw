...
CPPFLAGS += -DSTAF -DCERNLIB_DZDOC -DCERNLIB_HIGZ -DCERNLIB_TYPE -DCERNLIB_NONEWL -DCERNLIB_SHL -DCERNLIB_HADRON 
...
INCL  := $(INP_DIR) $(GST_DIR) $(STAF_SYS_INCS) $(CERN_ROOT)/include $(CERN_ROOT)/src/graflib/higz /usr/include
