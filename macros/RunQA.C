/* 
   FPE_OFF
   root.exe -q -b lBichsel.C dEdxFit.C+  'RunQA.C+("I/dEdx/2*.root")'
*/
#if !defined(__CINT__)
...
//________________________________________________________________________________
void RunQA(const Char_t *files = "/gpfs01/star/subsys-tpc/fisyak/kfp/2020/11p5GeV.C/I/dEdx/21042030_1.root"){
...
#endif
  TFile *fout = new TFile("RunQAN.root","recreate");
