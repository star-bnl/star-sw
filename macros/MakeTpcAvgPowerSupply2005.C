/* cd ~/work/Tpc/Current/2005
   root.exe -b -q  lmysql.C 'MakeTpcAvgPowerSupply2005.C+(2005)' >& MakeTpcAvgPowerSupply.`date +%m%d%y`.log &
   mv MakeTpcAvgPowerSupply.2005.root MakeTpcAvgPowerSupply.`date +%m%d%y`.root
   cd ../
   put2DB.pl 'StarDb/Calibrations/tpc/TpcAvg*.root' | tee 2005/put2DB.`date +%m%d%y`.log
...
//________________________________________________________________________________
void MakeTpcAvgPowerSupply2005(Int_t year = 2005) {
