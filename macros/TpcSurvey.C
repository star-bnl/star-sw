...
#if 0
	{{ 0, 0,   (229.71+1.7780+30.033), 0, 0, 0},  //0  Alexei: 30.033 cm
	 { 0, 0,  -(229.71+1.7780+30.033), 0, 0, 0}}, //0 
	{{ 0, 0,   (229.71+1.7780+27.007), 0, 0, 0},  //0  Alexei: 27.007 cm
	 { 0, 0,  -(229.71+1.7780+27.007), 0, 0, 0}}  //0 
#else
#if 0
	{{ 0, 0,   (229.71+1.7780+30.033+ 0.7784), 0, 0, 0},  //0  Alexei: 30.033 cm + 0.7784
	 { 0, 0,  -(229.71+1.7780+30.033+ 0.7784), 0, 0, 0}}, //0 
	{{ 0, 0,   (229.71+1.7780+27.007+ 0.7784), 0, 0, 0},  //0  Alexei: 27.007 cm
	 { 0, 0,  -(229.71+1.7780+27.007+ 0.7784), 0, 0, 0}}  //0 
#else
#if 0
	{{ 0, 0,   (229.71+1.7780+30.033+ 0.7784-0.0184), 0, 0, 0},  //0  Alexei: 30.033 cm + 0.7784
	 { 0, 0,  -(229.71+1.7780+30.033+ 0.7784-0.0184), 0, 0, 0}}, //0 
	{{ 0, 0,   (229.71+1.7780+27.007+ 0.7784-2.4063), 0, 0, 0},  //0  Alexei: 27.007 cm
	 { 0, 0,  -(229.71+1.7780+27.007+ 0.7784-2.4063), 0, 0, 0}}  //0 
#else
