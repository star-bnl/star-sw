...
class StIOMaker;
#endif
void FlowS(Int_t nevents=100000,
	  ...
	  const char* rootFile="flow_1241016.root")
{
  ...
  //#endif
  //  bfc(-1,"in dEdx event flow",MainFile,0,rootFile);
  //  bfc(-1,"in RichSpectra flow",MainFile,0,rootFile);
  bfc(-1,"in Y2001 flow",MainFile,0,rootFile);
  //  chain->SetDEBUG(1);
  //  StMaker *dEdx = chain->GetMaker("dEdx"); dEdx->SetMode(1);
