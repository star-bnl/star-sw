/*
  root.exe -q -b 'lana.C("StEvent/st_laser_adc_14044071_raw.ZF.Fit.g3.LandauIFreQ.event.root")'
  root.exe -q -b 'lana.C("StEvent/st_laser_adc_14046081_raw.F.Fit.g3.LandauIFreQ.event.root")'
  root.exe -q -b 'lana.C("StEvent/st_laser_adc_14072106_raw.RF.Fit.g3.LandauIFreQ.event.root")'
  root.exe -q -b 'lana.C("StEvent/st_laser_adc_14158028.raw.RF.Fit.g3.LandauIFreQ.event.root")'
  root.exe -q -b 'lana.C("StEvent/st_laser_adc_14161023.raw.ZF.Fit.g3.LandauIFreQ.event.root")'
 */
void lana(const Char_t *infile = "") {
  ...
  //  bfc(9999,"MakeEvent,in,TpxRaw,TpxClu,TpcHitMover,LaserIT,KFVertex,Lana,Analysis,NosvtIT,NossdIT,StiPulls,NoHistos,NoRunco,StiCA,CorrX",infile);
  bfc(999,"MakeEvent,in,TpxRaw,TpxClu,TpcHitMover,LaserIT,KFVertex,Lana,Analysis,NosvtIT,NossdIT,StiPulls,NoHistos,NoRunco,StiCA,CorrX",infile);
}
