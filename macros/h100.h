...
Int_t h100::GetEntry(Int_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t h100::LoadTree(Int_t entry)
{
