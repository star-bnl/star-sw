//////////////////////////////////////////////////////////////////////////
//
// $Id: bfcMixer_W_pileup.C,v 1.3 2013/06/24 23:40:00 fisyak Exp $
//
// $Log: bfcMixer_W_pileup.C,v $
// Revision 1.3  2013/06/24 23:40:00  fisyak
// Freeze
//
// Revision 1.2  2013/04/21 00:27:43  fisyak
// Freeze
//
...
void bfcMixer_W_pileup(Int_t First = 1, Int_t Last = 100, const Char_t *opt = "",
  ...
  chain1Opt += ",TpxRaw";
#endif
  TString chain2Opt(Form("useXgeom,pythiaEmbed,Wenu,gen_T,geomT,sim_T,TpcRS,fgtMc,nodefault,Rung.%i",ranseed));
  ...
  chain3Opt += ",NoHistos,NoRunco,EvOut,geantOut";
...
//________________________________________________________________________________
void bfcMixer_W_pileup(Int_t Last = 100, const Char_t *opt = "",
		     const Char_t* daqfile = "/star/data03/daq/2012/099/13099025/st_zerobias_adc_13099025_raw_1570001.daq",
		const Char_t* output  = 0, Int_t ranseed=1, const Char_t *geom = "y2012b") {
  bfcMixer_W_pileup(1,Last,opt,daqfile, output,ranseed,geom);
}
