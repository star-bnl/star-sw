...
const Double_t Masses[5] = {0.93827231,
				  0.493677,
				  0.13956995,
				  0.51099907e-3,
				  1.87561339};
const Char_t *Names[5] = {"p", "K","pi","e","d"};
const Int_t NF = 4;
const Char_t *FNames[5] = {"Girrf","Sirrf","Bz","B70","B60"};
const Int_t Nlog2dx = 5;
const Double_t log2dx[5] = {0,1,2,3,4};
...
void girrf() {
  ...
  for (Int_t dx = 0; dx < Nlog2dx; dx++) { 
    ...
    name += Form(" T_{max} = %7.1f keV",1e6*params[4]);
