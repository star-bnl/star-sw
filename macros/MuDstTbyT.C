...
#else
	       const Char_t *oldf="/star/subsys/tpc/fisyak/reco/2018/EastOff/st_physics_adc_19116021_raw_1000030.MuDst.root",
	       const Char_t *newf="/star/subsys/tpc/fisyak/reco/2018/WestOff/st_physics_adc_19116021_raw_1000030.MuDst.root",
#endif
	       const Char_t *out = "") {
  TString fileO(out);
  if (fileO == "") {
