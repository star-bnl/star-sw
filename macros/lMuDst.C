#include "Riostream.h"
void lMuDst(Int_t opt = -2, const Char_t *input = "", const Char_t *copt = "StEvent,RMuDst,mysql,tpcDb,magF,nodefault,CorrX,quiet",const Char_t *tfile =  0,const Char_t *ofile =  0) {
#if !defined(__CINT__)
