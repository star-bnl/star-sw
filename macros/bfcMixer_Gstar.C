//////////////////////////////////////////////////////////////////////////
//
// $Id: bfcMixer_Gstar.C,v 1.1 2016/01/31 19:10:18 fisyak Exp $
//
// $Log: bfcMixer_Gstar.C,v $
// Revision 1.1  2016/01/31 19:10:18  fisyak
// Freeze
//
// Revision 1.7  2014/11/04 20:22:13  fisyak
// Freeze
//
...
void bfcMixer_Gstar(Int_t First, Int_t Last, const Char_t *opt = "",
		     const Char_t* daqfile = "/star/data03/daq/2013/130/14130070/st_mtd_adc_14130070_raw_3400001.daq",
  ...
  else if (chain3Opt.Contains("y2013",TString::kIgnoreCase)) {chain3Opt += ",pp2013b";}
  else {
...
//________________________________________________________________________________
void bfcMixer_Gstar(Int_t Nevents = 100, const Char_t *opt = "",
		    const Char_t* daqfile = "/star/data03/daq/2013/130/14130070/st_mtd_adc_14130070_raw_3400001.daq",
		const Char_t* output = 0, Int_t ranseed=1,const Char_t *geom = "y2013_1d") {
  bfcMixer_Gstar(1,Nevents,opt,daqfile, output,ranseed,geom);
}
