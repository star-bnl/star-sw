// example by hand, run 11: root4star -b -q 'rdMuWana2013.C(500000,"./R12099030.lis",0,2,330801,330851,"","/star/institutions/iucf/stevens4/run12w/ana/run11long/jets/")'

class StChain;
StChain *chain=0;
 
int rdMuWana2013(// from rdMuWana2012.C
	     int nEve=1e6,
	     char* file    = "./R118.lis",
	     int isMC=0, // 0=data 35X=embedding
	     int useJetFinder = 1, // 0 - no jets=badWalgo; 1 generate jet trees; 2 read jet trees 
	     int idL2BWtrg=430229, //  offline Ids  needed for real data
	     int idL2EWtrg=430315, // run 9 L2EW
