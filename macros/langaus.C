...
void langaus(TH1 *hSNR = 0) {
  if (! hSNR) {
   ...
   hSNR = new TH1F("snr","Signal-to-noise",400,0,400);
   ...
   hSNR->GetXaxis()->SetRange(0,-1);
   fr[0]=0.1*hSNR->GetMean();
   fr[1]=10.0*hSNR->GetMean();

   pllo[0]=0.1; pllo[1]=1.0; pllo[2]=1.0; pllo[3]=0.1;
   plhi[0]=5.0; plhi[1]=50.0; plhi[2]=1000000.0; plhi[3]=5.0;
   sv[0]=0.1; sv[1]= hSNR->GetMean();sv[2]=50000.0; sv[3]=0.3;
