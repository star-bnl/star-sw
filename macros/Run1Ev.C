...
void Run1Ev(Int_t NEvents=1, Int_t iD = 5, 
	    Double_t pTlow=3,Double_t pThigh=3, // Double_t pTlow=1,Double_t pThigh=1,
	    Double_t Ylow=0, Double_t Yhigh=0,
#if 1
	    Double_t Philow=0, Double_t Phihigh=0,
	    Double_t Zlow=200, Double_t Zhigh=200.0, Int_t Npart = 1, const Char_t *opt = "G") 
#else
...
#else
void Run1Ev(Int_t NEvents=1, Int_t iD = 5, 
	    Double_t pTlow=5,Double_t pThigh=5,
