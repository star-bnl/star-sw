...
#   }
# }
my  @runs  = glob "/hlt/cephfs/daq/2020/???/* /net/l401/data/scratch1/daq/2020/???/*";#  print "runs = @runs\n" if ($debug);
#my  @runs  = glob "/hlt/cephfs/daq/2020/???/*";  print "runs = @runs\n" if ($debug);
#my  @runs  = glob "/gpfs01/star/daq/2020/???/*";  print "runs = @runs\n" if ($debug);
