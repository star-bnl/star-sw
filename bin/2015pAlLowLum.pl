...
my @list = `get_file_list.pl -delim '/' -keys 'path,filename' -cond 'magscale=ReversedFullField,filename~st_physics_16,filetype=online_daq,trgsetupname=production_pAl200_2015_lowlumi' -limit 0`;
