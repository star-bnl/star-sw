...
my $debug = 0;
my $day = $ARGV[0];
my $trigger = "AuAu11_production"; #"AuAu7_production";
...
#  if ($i%20 != 1) {next;}
  ...
  $basename =~ s#home/starreco/reco/AuAu11_production/ReversedFullField/P10ih/##;
  $basename =~ s#home/starlib/##;
#  print "$file = > $basename\n";
  my $found = 0;
  my $dir;
  my @dirs = qw( /gpfs02/eic/ayk/STAR/reco/2010AuAu11/MuDst /gpfs01/star/pwg/fisyak/MuDst );
  foreach $dir (@dirs) {
