...
my @list = `get_file_list.pl -delim '/' -keys 'path,filename' -cond 'filetype=online_daq,filename~st_physics_adc,tpx=1,sanity=1,events>10,trgsetupname=AuAu200_production' -limit 0`; 
my $i = 1;   
my $OldRun = 0;
