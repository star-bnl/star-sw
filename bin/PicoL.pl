...
if ($pwd =~ /dev/ or $pwd  =~ /DEV/ or $pwd =~ /P20/ or $pwd =~ /P21/) {
  ...
  elsif ($pwd =~ /2020\/9p2GeV_2020/)         {$glob = "/reco/production_9p2GeV_2020/ReversedFullField/P21ib_calib/2020";}
...
#  elsif ($pwd =~ /2019\/19GeV_2019_P21ib2/)   {$PICOPATH = "/gpfs01/star/data101"; $glob = "/reco/production_19GeV_2019/ReversedFullField/P21ib_calib/2019"; }
  ...
  elsif ($pwd =~ /2019\/3p85GeV_fixedTarget/) {$glob = "/reco/production_3p85GeV_fixedTarget_2019/ReversedFullField/P21id/2019/";}
  elsif ($pwd =~ /2019\/4p59GeV_fixedTarget/) {$glob = "/reco/production_4p59GeV_fixedTarget_2019/ReversedFullField/P21id/2019/";}
