...
my @list = `get_file_list.pl -delim '/' -keys 'path,filename' -cond 'filetype=online_daq,filename~st_physics_13116,tpx=1,sanity=1,events>10,trgsetupname=UU_production_2012,runnumber>=13116008,runnumber<=13116012' -limit 0`; 
my $i = 1;   
my $OldRun = 0;
