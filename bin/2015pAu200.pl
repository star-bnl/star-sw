...
my @list = `get_file_list.pl -delim '/' -keys 'path,filename' -cond 'magscale=ReversedFullField,filename~st_physics_16,filetype=online_daq,trgsetupname=production_pAu200_2015' -limit 100`;
