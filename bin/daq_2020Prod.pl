...
#		
my @glob = ();
if (-r "/gpfs01/star/daq/") {
  @globs = ("/gpfs01/star/daq/2019/" . $day . "/" . $run . "*/st_physics*.daq"); 
} elsif (-r "/hlt/cephfs/daq/2019/") {
  @globs = ("/hlt/cephfs/daq/2019/" . $day . "/" . $run . "*/hlt*.daq"); 
  $HLT = 1;
} 
#my @globs = qw(
...
#    my $step = 1000;
	...
	next;
      ...
      #    if (! $debug) {`touch $blaf`;}
#      my                       $chain = "P2020a,-hitfilt,mtd,btof,BEmcChkStat,CorrY,OSpaceZ2,OGridLeakFull,evout,NoHistos,noTags,noRunco,Stx,KFVertex,VFMinuitX,picoWrite,PicoVtxVpdOrDefault";
      my                       $chain = "P2020a,-hitfilt,mtd,btof,BEmcChkStat,CorrY,OSpaceZ2,OGridLeakFull,evout,NoHistos,noTags,noRunco,StiCA,picoWrite,PicoVtxVpdOrDefault";
#      if ($run == "20093001") {$chain = "P2020a,-hitfilt,mtd,btof,BEmcChkStat,CorrY,OSpaceZ2,OGridLeakFull,evout,NoHistos,noTags,noRunco,Stx,KFVertex,VFMinuitX,picoWrite,PicoVtxVpdOrDefault";}
      # Check failed 
