...
my @list = glob "/star/data03/daq/2015/???/*/st_cosmic*.daq /star/data03/daq/2015/???/*/st_gmt*.daq";
#my $FFirstRun  = 16021045;
#my $FFLastRun  = 16029052;
#my $RFirstRun  = 16031005;
#my $RFLastRun  = 16173033;
#if ($pwd =~ /FF/) {@list = glob "/star/data03/daq/2015/021/*/st_cosmic*.daq";}
#else              {@list = glob "/star/data03/daq/2015/031/*/st_cosmic*.daq";} # RF
foreach my $fullpath (@list) {
  my $file = $fullpath;
  $file =~ s#/star/data03/daq/2015/##;
