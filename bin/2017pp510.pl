...
my @list = `get_file_list.pl -delim '/' -keys 'path,filename' -cond 'filetype=online_daq,filename~st_physics_1,tpx=1,sanity=1,events>10,runnumber>=18075078' -limit 2000`; # print "@list\n";
my $i = 1;   
my $OldRun = 0;
