...
my @list = `get_file_list.pl -delim '/' -keys 'path,filename' -cond 'filetype=online_daq,runnumber>1508922,tpx=1,tof=1,sanity=1,trgsetupname=AuAu_200_Production_high_2014' -limit 0`;
