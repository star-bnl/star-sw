...
my @list = `get_file_list.pl -delim '/' -keys 'path,filename,events' -cond 'filetype=online_daq,trgsetupname=production_19GeV_2019,filename~st_physics_2,tpx=1,sanity=1,events>10' -limit 0`;
