...
#      set cmd = 'get_file_list.pl -keys path,filename -cond production=P17id,trgsetupname='${trig}',filename~st_physics,filetype=daq_reco_MuDst,daynumber='${day}',storage!=hpss -limit 0 | tee '$trig'_'${day}'.list';
      set cmd = 'get_file_list.pl -keys path,filename -cond production=P16id,trgsetupname='${trig}',filename~st_physics,filetype=daq_reco_MuDst,daynumber='${day}',storage!=hpss -limit 0 >&  '$trig'_'${day}'.list' ;
      echo "$cmd";
#      $cmd;
      @ d++ 
    end
