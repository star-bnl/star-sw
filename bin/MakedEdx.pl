...
$hist = "RunXIX_XXII_36"; $NEvents = 4000; $disk = "/hlt/cephfs/";  $RECO = "reco/20*/*F"; $Production = "/.DEV2"; $year = "/*GeV*/*/*/*"; $FILE = ""; $STAR_LEVEL = ".DEV2"; $select = "*";  $keep = 0; $Mode = 2; $macro = "dEdx";#  08/07/22  
my $Year = $year;
