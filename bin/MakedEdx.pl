...
$hist = "P21ic_calib_37"; $NEvents = 10000; $disk = "/hlt/cephfs/"; $RECO = "reco/*GeV_fixedTarget*/ReversedFullField";  $Production = "/P21ic_calib"; $year = "/20*/*/*/"; $FILE = "st_"; $STAR_LEVEL = ".DEV2"; $select = "*";  $keep = 0; $Mode = 2; $macro = "dEdx";# 010/09/21 use scheme with usedx2 TRUE with calib sample
