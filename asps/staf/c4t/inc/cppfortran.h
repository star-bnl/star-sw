/* A modified (see below) version of                                  */
/* cfortran.h */ /* 2.7 */            /* anonymous ftp: zebra.desy.de */
/* Burkhard Burow, burow@vxdesy.cern.ch, University of Toronto, 1993. */
/*  */
/* This version was modified by Paul Schenk (Casper), pschenk@hpopb1.cern.ch, */
/*   To support C++ calling fortran                                   */
/* This support of C++ has only been tested minimally                 */
/* I have used it on an HP 700 using gcc                              */
/* Please send me (Casper) any changes to the c++ macros so I can keep*/
/*  up with them                                                      */
/* Also let me know if it works for you somewhere else                */
/*                                                                    */
...
/* how to get external "C" type linkage */
#ifdef __cplusplus
...
/* Casper, change the prototypes for C++, they need to be done at file scope */
#define PROTOCCALLSFSUB0(UN,LN)         CEXTERN  void CFC_(UN,LN)();

#define PROTOCCALLSFSUB1( UN,LN,T1)         \
        PROTOCCALLSFSUB5 (UN,LN,T1,CF_0,CF_0,CF_0,CF_0)

#define PROTOCCALLSFSUB2( UN,LN,T1,T2)      \
        PROTOCCALLSFSUB5 (UN,LN,T1,T2,CF_0,CF_0,CF_0)

#define PROTOCCALLSFSUB3( UN,LN,T1,T2,T3)   \
        PROTOCCALLSFSUB5 (UN,LN,T1,T2,T3,CF_0,CF_0)

#define PROTOCCALLSFSUB4( UN,LN,T1,T2,T3,T4)\
        PROTOCCALLSFSUB5 (UN,LN,T1,T2,T3,T4,CF_0)

#define PROTOCCALLSFSUB5( UN,LN,T1,T2,T3,T4,T5)   \
        PROTOCCALLSFSUB10(UN,LN,T1,T2,T3,T4,T5,CF_0,CF_0,CF_0,CF_0,CF_0)
#define PROTOCCALLSFSUB6( UN,LN,T1,T2,T3,T4,T5,T6)       \
        PROTOCCALLSFSUB10(UN,LN,T1,T2,T3,T4,T5,T6,CF_0,CF_0,CF_0,CF_0)

#define PROTOCCALLSFSUB7( UN,LN,T1,T2,T3,T4,T5,T6,T7)    \
        PROTOCCALLSFSUB10(UN,LN,T1,T2,T3,T4,T5,T6,T7,CF_0,CF_0,CF_0)

#define PROTOCCALLSFSUB8( UN,LN,T1,T2,T3,T4,T5,T6,T7,T8) \
        PROTOCCALLSFSUB10(UN,LN,T1,T2,T3,T4,T5,T6,T7,T8,CF_0,CF_0)

#define PROTOCCALLSFSUB9( UN,LN,T1,T2,T3,T4,T5,T6,T7,T8,T9)\
        PROTOCCALLSFSUB10(UN,LN,T1,T2,T3,T4,T5,T6,T7,T8,T9,CF_0)
...
CEXTERN  void CFC_(UN,LN)(NCF(T1,1,0) NCF(T2,2,1) NCF(T3,3,1) NCF(T4,4,1)   \
...
#define PROTOCCALLSFSUB15(UN,LN,T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE,TF) \
        PROTOCCALLSFSUB16(UN,LN,T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE,TF,CF_0) 

#define PROTOCCALLSFSUB16(UN,LN,T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE,TF,TG) \
        PROTOCCALLSFSUB17(UN,LN,T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE,TF,TG,CF_0) 

#define PROTOCCALLSFSUB17(UN,LN,T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE,TF,TG,TH) \
        PROTOCCALLSFSUB18(UN,LN,T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE,TF,TG,TH,CF_0) 

#define PROTOCCALLSFSUB18(UN,LN,T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE,TF,TG,TH,TI) \
        PROTOCCALLSFSUB19(UN,LN,T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE,TF,TG,TH,TI,CF_0) 
...
/* for c++ we remove the prototype here */
#ifdef __cplusplus
...
do{VVCF(T1,A1,B1) VVCF(T2,A2,B2) VVCF(T3,A3,B3) VVCF(T4,A4,B4) VVCF(T5,A5,B5)  \
   VVCF(T6,A6,B6) VVCF(T7,A7,B7) VVCF(T8,A8,B8) VVCF(T9,A9,B9) VVCF(TA,AA,BA)  \
   VVCF(TB,AB,BB) VVCF(TC,AC,BC) VVCF(TD,AD,BD) VVCF(TE,AE,BE)                 \
   PPROTOCCALLSFSUB14(UN,LN,T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE)         \
   ACF(LN,T1,A1,1) ACF(LN,T2,A2,2) ACF(LN,T3,A3,3)                             \
   ACF(LN,T4,A4,4) ACF(LN,T5,A5,5) ACF(LN,T6,A6,6) ACF(LN,T7,A7,7)             \
   ACF(LN,T8,A8,8) ACF(LN,T9,A9,9) ACF(LN,TA,AA,A) ACF(LN,TB,AB,B)             \
   ACF(LN,TC,AC,C) ACF(LN,TD,AD,D) ACF(LN,TE,AE,E)                             \
...
#define PUBYTE(      A) CEXTERN INTEGER_BYTE     A
#define PUDOUBLE(    A) CEXTERN DOUBLE_PRECISION A
#ifndef sunFortran
#define PUFLOAT(     A) CEXTERN float   A
#else
#define PUFLOAT(     A) CEXTERN FLOATFUNCTIONTYPE   A
#endif
#define PUINT(       A) CEXTERN int     A
#define PULOGICAL(   A) CEXTERN int     A
#define PULONG(      A) CEXTERN long    A
#define PUSHORT(     A) CEXTERN short   A
#define PUSTRING(    A) CEXTERN char   *A 
#define PUVOID(      A) CEXTERN void    A
