...
Replace[LIST #;] with [ #1 _
 ...
 "tcgen  "   tlerr,tlpiv,tlres,tls,tlsc,tlsmsq,tlstep,tlswop,
	     tluk,traat,tral,tralt,tras,trasat,trata,trats,tratsa,
             trchlu,trchul,trinv,trla,trlta,trpck,trqsq,trsa,
 ...
 "higz"      iuwk,igend,iscan,hfnov,hddir,igwkty,
