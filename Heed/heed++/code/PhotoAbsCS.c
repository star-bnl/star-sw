...
double glin_integ_ar(DynLinArr<double> x, DynLinArr<double> y, 
                     long q, double x1, double x2, double threshold) {
  ...
  double s = t_integ_generic_point_ar<double, 
                                      DynLinArr<double>, 
...
/*
double glin_val_ar(DynLinArr<double> x, DynLinArr<double> y, long q, double ex, double threshold) {
  // fit table by a straight line and integrate the area below it.
...
double SimpleTablePhotoAbsCS::get_integral_CS(double energy1, double energy2) const {
  ...
  if (energy2 > ener[q - 1]) {
    ...
    if (energy2 == DBL_MAX) {
      ...
      double c = cs[q - 1] / (1.75 * pow(ener[q-1], -2.75)) * pow(energy1, -1.75);
...
PhenoPhotoAbsCS::PhenoPhotoAbsCS(const String& fname, int fZ, double fthreshold, double fpower) :
  ...
  check_econd11a(power , <= 2 , 
                 ...
                 mcerr);
  factor = pow(threshold, power - 1.) * Thomas_sum_rule_const_Mb * Z * (power - 1.);
}
...
double AtomPhotoAbsCS::get_TICS(double energy, double factual_minimal_threshold) const {
...
double AtomPhotoAbsCS::get_integral_TICS(double energy1, double energy2,
...
double AtomPhotoAbsCS::get_integral_TICS(int nshell, double energy1, double energy2,
                                         double factual_minimal_threshold) const {
...
void AtomPhotoAbsCS::get_escape_particles(int nshell, double energy,
  ...
  if (nshell == n_min) {
    ...
    { 
      ...
      for (long n = 0; n < q; ++n) {
        check_econd21(fphoton_energy[n], < 0 || , > get_threshold(nshell), mcerr);
...
double SimpleAtomPhotoAbsCS::get_integral_ACS(double energy1, double energy2) const {  
  mfunnamep("double SimpleAtomPhotoAbsCS::get_integral_ACS(double energy)const");
  double s = 0.0;
  for (int n = 0; n < qshell; ++n) {
    if (s_ignore_shell[n] == 0) {
      double t;
...
double SimpleAtomPhotoAbsCS::get_integral_ACS(int nshell, double energy1, double energy2) const {
  mfunname("double SimpleAtomPhotoAbsCS::get_integral_ACS(int nshell, double energy1, double energy2)");
  check_econd21(nshell , < 0 || , > qshell , mcerr);
  if (s_ignore_shell[nshell] == 0) {
...
double SimpleAtomPhotoAbsCS::get_integral_ICS(double energy1, double energy2) const {
  mfunname("double SimpleAtomPhotoAbsCS::get_integral_ICS(double energy1, double energy2) const");
  double s = 0.0;
  for (int n = 0; n < qshell; ++n) {
    if (s_ignore_shell[n] == 0) {
...
double SimpleAtomPhotoAbsCS::get_integral_ICS(int nshell, double energy1, double energy2) const {
  mfunname("double SimpleAtomPhotoAbsCS::get_integral_ICS(int nshell, double energy1, double energy2)");
  check_econd21(nshell , < 0 || , > qshell , mcerr);
  if (s_ignore_shell[nshell] == 0) {
    return acs[nshell]->get_integral_CS(energy1, energy2);
  }
...
ExAtomPhotoAbsCS::ExAtomPhotoAbsCS(int fZ, 
  ...
  minimal_threshold(fminimal_threshold)
{
  mfunnamep("ExAtomPhotoAbsCS::ExAtomPhotoAbsCS(int fZ, const String& fname, const String& fFitBT_file_name, int id, int id1, double fminimal_threshold)");
  check_econd11(fZ, < 1 , mcerr);
  check_econd21(id, < 1 || , > 2 , mcerr);
  Z = fZ;
  name = fname;
 ...
 double fminimal_threshold)
{
  ...
  *this = ExAtomPhotoAbsCS(fZ, 
  ...
  SimpleTablePhotoAbsCS* first_shell =  dynamic_cast<SimpleTablePhotoAbsCS*>(apacs);
  //mcout<<"first_shell:\n";
  ...
  // SimpleTablePhotoAbsCS* first_shell = dynamic_cast<SimpleTablePhotoAbsCS*>(&(acs[nsmin]->getver()));
...
double ExAtomPhotoAbsCS::get_integral_ICS(double energy1, double energy2) const {  
...
double ExAtomPhotoAbsCS::get_integral_ICS(int nshell, double energy1, double energy2) const {
  mfunname("double ExAtomPhotoAbsCS::get_integral_ICS(int nshell, double energy1, double energy2)");
  check_econd21(nshell , < 0 || , > qshell , mcerr);
  if (s_ignore_shell[nshell] == 0) {
    double shift = 0.0;
    const double t = acs[nshell]->get_threshold();
...
double ExAtomPhotoAbsCS::get_integral_ACS(double energy1, double energy2) const {
  mfunname("double ExAtomPhotoAbsCS::get_integral_ACS(double energy1, double energy2) const");
  double s = 0.0;
  for (int n = 0; n < qshell; ++n) {
    if (s_ignore_shell[n] == 0) {
      double shift = 0.0;
...
double ExAtomPhotoAbsCS::get_integral_ACS(int nshell, double energy1, double energy2) const {
  mfunname("double ExAtomPhotoAbsCS::get_integral_ACS(int nshell, double energy1, double energy2)");
  check_econd21(nshell , < 0 || , > qshell , mcerr);
  if (s_ignore_shell[nshell] == 0) {
    double shift = 0.0;
    const double t = acs[nshell]->get_threshold();
...
PhotoAbsorptionCS::PhotoAbsorptionCS(const String& ffile_name, PassivePtr< EnergyMesh > fenergy_mesh) {
