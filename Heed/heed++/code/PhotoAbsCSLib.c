...
ExAtomPhotoAbsCS Silicon_crystal_PACS(14, 
                                      ...
                                      pacs_table_dir_name + "Si.dat",
                                      "Si_crystal");
ExAtomPhotoAbsCS Silicon_G4_PACS(14, 
                                 shelllist_dir_name + 
                                 "shelllist_solid.dat", 
...
ExAtomPhotoAbsCS Caesium_PACS(55, 
                              shelllist_dir_name + "shelllist.dat",
                              pacs_table_dir_name + "Cs.dat");
ExAtomPhotoAbsCS Mercury_PACS(80, 
                              shelllist_dir_name + "shelllist.dat",
...
MolecPhotoAbsCS NH3_MPACS(Nitrogen_PACS, 1, 
                          Hydrogen_for_NH4_PACS, 3, 26.6e-6);
MolecPhotoAbsCS N2O_MPACS(Nitrogen_PACS, 2, 
                          Oxygen_PACS, 1, 34.8e-6);
...
MolecPhotoAbsCS C2H4_MPACS(Carbon_for_C2H4_PACS, 2, Hydrogen_for_H2_PACS, 4,
			   25.8e-6);
MolecPhotoAbsCS C2H6_MPACS(Carbon_for_C2H6_PACS, 2, 
...
MolecPhotoAbsCS CO_MPACS(Carbon_for_CO2_PACS, 1,
                         Oxygen_PACS, 1);
MolecPhotoAbsCS DME_MPACS(Carbon_for_Methylal_PACS, 4,
                          Hydrogen_for_H2_PACS, 10,
                          Oxygen_PACS, 2);
