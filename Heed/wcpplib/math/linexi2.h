...
{public:
  ...
  linexi2_coor(const linexi2_coor& lc): qlr(lc.qlr), ax(lc.ax),
      x_mean(lc.x_mean), Dx(lc.Dx) {;}  
  ...
  linexi2& operator=(linexi2& lx)
    {
      *((linexi2_coor*)this)=(linexi2_coor&)lx;
      ay=lx.ay; y_mean=lx.y_mean; xy_mean=lx.xy_mean; a = lx.a; b=lx.b;
      return *this;
    }
