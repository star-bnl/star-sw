...
{
  mfunname("DynLinArr<DoubleAc> operator*(const DynArr<DoubleAc>& mt, const DynLinArr<double>& vc)");
...
{
  mfunname("DynLinArr<DoubleAc> operator*(const DynArr<double>& mt, const DynLinArr<DoubleAc>& vc)");
...
{
  mfunname("DoubleAc operator*(const DynLinArr<DoubleAc>& vc1, const DynLinArr<double>& vc2)");
...
{
  mfunname("DoubleAc operator*(const DynLinArr<double>& vc1, const DynLinArr<DoubleAc>& vc2)");
...
{
  mfunname("DynArr<DoubleAc> operator+(const DynArr<DoubleAc>& mt1, const DynArr<double>& mt2)");
...
{
  mfunname("DynArr<DoubleAc> operator+(const DynArr<double>& mt1, const DynArr<DoubleAc>& mt2)");
  long qdim1=mt1.get_qdim();
  long qdim2=mt2.get_qdim();
  check_econd12(qdim1 , != , qdim2 , mcerr);
  const DynLinArr<long>& qe1=mt1.get_qel();
