...
{protected:
  ...
  vec dir;     // directionof normal, unit vector
               // 
public:
  point Gpiv(void) const {return piv;} //It should return one any point of line
...
public:
  ...
  int cross(const polyline &pll, point *crpt, int& qcrpt, 
