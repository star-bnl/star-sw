...
namespace {HelperForMcout __helper_for_mcout; }  // thanks to
...
{file<<indn<<#name<<"="<<noindent<<name<<yesindent; file.flush();}
#define Iprintn( file , name ) \
file<<indn<<#name<<"="<<noindent<<name<<'\n'<<yesindent;
#define Iprintnf( file , name ) \
{file<<indn<<#name<<"="<<noindent<<name<<'\n'<<yesindent; file.flush();}
...
file<<indn<<#name1<<"="<<noindent<<name1<<", "<<#name2<<"="<<noindent<<name2<<yesindent;
#define Iprint2n( file , name1, name2 ) \
file<<indn<<#name1<<"="<<noindent<<name1<<", "<<#name2<<"="<<noindent<<name2<<'\n'<<yesindent;
#define Iprint2nf( file , name1, name2 ) \
{file<<indn<<#name1<<"="<<noindent<<name1<<", "<<#name2<<"="<<noindent<<name2<<'\n'<<yesindent; file.flush();}
#define Iprint3( file , name1, name2, name3 ) \
file<<indn<<#name1<<"="<<noindent<<name1<<", "<<#name2<<"="<<noindent<<name2<<", "<<#name3<<"="<<noindent<<name3<<yesindent;
#define Iprint3n( file , name1, name2, name3 ) \
file<<indn<<#name1<<"="<<noindent<<name1<<", "<<#name2<<"="<<noindent<<name2<<", "<<#name3<<"="<<noindent<<name3<<'\n'<<yesindent;
#define Iprint3nf( file , name1, name2, name3 ) \
{file<<indn<<#name1<<"="<<noindent<<name1<<", "<<#name2<<"="<<noindent<<name2<<", "<<#name3<<"="<<noindent<<name3<<'\n'<<yesindent; file.flush();}
#define Iprint4n( file , name1, name2, name3, name4 ) \
file<<indn<<#name1<<"="<<noindent<<name1<<", "<<#name2<<"="<<noindent<<name2<<", "<<#name3<<"="<<noindent<<name3<<", "<<#name4<<"="<<noindent<<name4<<'\n'<<yesindent;
#define Iprint4nf( file , name1, name2, name3, name4 ) \
{file<<indn<<#name1<<"="<<noindent<<name1<<", "<<#name2<<"="<<noindent<<name2<<", "<<#name3<<"="<<noindent<<name3<<", "<<#name4<<"="<<noindent<<name4<<'\n'<<yesindent; file.flush();}
#define Iprint5n( file , name1, name2, name3, name4, name5 ) \
file<<indn<<#name1<<"="<<noindent<<name1<<", "<<#name2<<"="<<noindent<<name2<<", "<<#name3<<"="<<noindent<<name3<<", "<<#name4<<"="<<noindent<<name4<<", "<<#name5<<"="<<noindent<<name5<<'\n'<<yesindent;

#define Iprint_l( file , name , l ) {file<<indn<<#name<<"="<<noindent; \
name.print( file , l ); file<<yesindent; }
#define Iprint_al( file , name , l ) { file<<indn<<#name<<"="<<noindent; \
name->print( file , l ); file<<yesindent; }

#define Iprint_p( file , name ) {file<<indn<<#name<<"="<<noindent; \
name.print( file ); file<<yesindent; }
#define Iprint_ap( file , name ) { file<<indn<<#name<<"="<<noindent; \
name->print( file ); file<<yesindent; }
