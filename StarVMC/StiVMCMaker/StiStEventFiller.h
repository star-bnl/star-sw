...
/***************************************************************************
 *
 * $Id: StiStEventFiller.h,v 2.29 2009/08/19 19:56:40 fisyak Exp $
 *
 * Author: Manuel Calderon de la Barca Sanchez, Mar 2002
 ***************************************************************************
 *
 * $Log: StiStEventFiller.h,v $
 * Revision 2.29  2009/08/19 19:56:40  fisyak
 * Clean up
 *
 * Revision 2.28  2009/08/04 18:55:14  fisyak
 * Capitilize method names
 *
 * Revision 2.27  2009/08/02 19:05:36  fisyak
 * Add reference track
 *
 * Revision 2.26  2009/07/19 20:14:35  fisyak
 * remove abstract classes
 *
 * Revision 2.25  2009/05/26 21:57:24  fisyak
 ...
 * fillGeometry() - use node->NormalX(), as it should have been since the beginning
 ...
 * -possible points is currently set from MaxPointCount which returns the total, and it is not
...
public:
    ...
    void fillEvent(StEvent* e, StiKalmanTrackContainer* t);
    ...
    Double_t impactParameter(StiKalmanTrack* kTrack, StThreeVectorD &vertexPosition);
    Double_t impactParameter(StTrack* strack, StThreeVectorD &vertexPosition);
private:
 bool accept(StiKalmanTrack* kTrack);
 void FillStHitErr(StHit *hh,const StiKalmanTrackNode *node);
private:
    StEvent* mEvent;
    StiKalmanTrackContainer* mTrackStore;
    Int_t mGloPri;		//0=filing global,1=filing primary
    Int_t mTrackNumber;
