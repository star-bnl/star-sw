// $Id: StMCHits.cxx,v 1.1 2005/03/09 18:35:34 perev Exp $
//
//
// Class StMCHits
// ------------------
...
//_____________________________________________________________________________
StMCPath StMCHit::GetPath() const  
{
   StTGeant3 *g3 = (StTGeant3*)TVirtualMC::GetMC();
   g3->SetCurrentPath(fID);
   return g3->CurrentPath();
}
