...
//____________________________________________________________________________
TGeant3f77::TGeant3f77(const char *title, Int_t nwgeant) : TGeant3(title, nwgeant) {}
...
//_____________________________________________________________________________
void gfmate(Int_t &imat, char *name, Float_t &a, Float_t &z, Float_t &dens, Float_t &radl, Float_t &absl, Float_t *ubuf,
            Int_t &nbuf, const Int_t lname)
{
   //
...
//_____________________________________________________________________________
void gftmed(Int_t &numed, char *name, Int_t &nmat, Int_t &isvol, Int_t &ifield, Float_t &fieldm, Float_t &tmaxfd,
            Float_t &stemax, Float_t &deemax, Float_t &epsil, Float_t &stmin, Float_t * /*ubuf*/, Int_t * /*nbuf*/,
            const Int_t lname)
{
   //
   ...
   strncpy(vname, name, lname);
   vname[lname] = 0;
   geant3->Gftmed(numed, vname, nmat, isvol, ifield, fieldm, tmaxfd, stemax, deemax, epsil, stmin);
}

//_____________________________________________________________________________
void gftmat(Int_t &imate, Int_t &ipart, char *chmeca, Int_t &kdim, Float_t *tkin, Float_t *value, Float_t *pcut,
            Int_t &ixst)
{
   //
   // Return parameters for tracking medium NUMED
...
//_____________________________________________________________________________
void gsmixt(Int_t &imat, const char *name, Float_t *a, Float_t *z, Float_t &dens, Int_t &nlmat, Float_t *wmat,
            const Int_t lname)
{
   //
...
//_____________________________________________________________________________
void gspart(Int_t &ipart, const char *name, Int_t &itrtyp, Float_t &amass, Float_t &charge, Float_t &tlife,
            Float_t * /*ubuf*/, Int_t & /*nbuf*/, const Int_t lname)
{
   //
...
//_____________________________________________________________________________
void gstmed(Int_t &numed, const char *name, Int_t &nmat, Int_t &isvol, Int_t &ifield, Float_t &fieldm, Float_t &tmaxfd,
            Float_t &stemax, Float_t &deemax, Float_t &epsil, Float_t &stmin, Float_t * /*ubuf*/, Int_t & /*nbuf*/,
            const Int_t lname)
{
   //
   ...
   strncpy(vname, name, lname);
   vname[lname] = 0;
   geant3->Gstmed(numed, vname, nmat, isvol, ifield, fieldm, tmaxfd, stemax, deemax, epsil, stmin);
}
...
void gsdvn(const char *name, const char *mother, Int_t &ndiv, Int_t &iaxis, const Int_t lname, const Int_t lmother)
{
   ...
   vname[lname] = 0;
   char vmother[24];
   strncpy(vmother, mother, lmother);
   vmother[lmother] = 0;
   geant3->Gsdvn(vname, vmother, ndiv, iaxis);
}

//_____________________________________________________________________________
void gsdvn2(const char *name, const char *mother, Int_t &ndiv, Int_t &iaxis, Float_t &c0i, Int_t &numed,
            const Int_t lname, const Int_t lmother)
{
   //
   // Create a new volume by dividing an existing one
   //
...
//_____________________________________________________________________________
void gsdvs(const char *name, const char *mother, Float_t &step, Int_t &iaxis, Int_t &numed, const Int_t lname,
           const Int_t lmother)
{
   //
   // Create a new volume by dividing an existing one
...
//_____________________________________________________________________________
void gsdvt(const char *name, const char *mother, Float_t &step, Int_t &iaxis, Int_t &numed, Int_t &ndvmx,
           const Int_t lname, const Int_t lmother)
{
   //
   // Create a new volume by dividing an existing one
...
//_____________________________________________________________________________
void gsdvt2(const char *name, const char *mother, Float_t &step, Int_t &iaxis, Float_t &c0, Int_t &numed, Int_t &ndvmx,
            const Int_t lname, const Int_t lmother)
{
   //
   // Create a new volume by dividing an existing one
...
void gspos(const char *name, Int_t &nr, const char *mother, Float_t &x, Float_t &y, Float_t &z, Int_t &irot,
           const char *konly, const Int_t lname, const Int_t lmother, const Int_t lkonly)
{
   //
...
//_____________________________________________________________________________
void gsvolu(const char *name, const char *shape, Int_t &nmed, Float_t *upar, Int_t &npar, Int_t &ivolu,
            const Int_t lname, const Int_t lshape)
{
   //
   //  NAME   Volume name
   //  SHAPE  Volume type
...
void gdopt(const char *name, const char *value, const Int_t lname, const Int_t lvalue)
{
   ...
   vname[lname] = 0;
   char vvalue[24];
   strncpy(vvalue, value, lvalue);
   vvalue[lvalue] = 0;
   geant3->Gdopt(vname, vvalue);
}

//_____________________________________________________________________________
void gdraw(const char *name, Float_t &theta, Float_t &phi, Float_t &psi, Float_t &u0, Float_t &v0, Float_t &ul,
           Float_t &vl)
{
   //
   //  NAME   Volume name
...
//_____________________________________________________________________________
void gdrawx(const char *name, Float_t &cutthe, Float_t &cutphi, Float_t &cutval, Float_t &theta, Float_t &phi,
