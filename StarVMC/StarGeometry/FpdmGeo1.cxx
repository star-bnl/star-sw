#include "FpdmGeo1.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          Fmxg_t fmxg;     
          //     
          ///@addtogroup FpdmGeo1_vars     
          ///@{        
                Int_t chkvsim,imod,itype,type;        
                //        
                /// Int_t chkvsim,imod,itype,type        
          ///@}     
          ///@addtogroup FpdmGeo1_vars     
          ...
          ///@}     
       FpdmGeo1::FpdmGeo1()     
         : AgModule("FpdmGeo1"," is the Forward Pion Detector Modules GEOmetry ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
                ...
                ///@{           
                      ...
                      {              
                            ...
                            { AgPlacement place = AgPlacement("FSHM","FBOX");                 
                                  ...
                                  place.TranslateY(0);                 
                                  /// Translate y = 0                 
                                  place.TranslateZ(fbxd.smdoffset+ztotsmd-fbxd.depth/2);                 
                                  /// Translate z = fbxd.smdoffset+ztotsmd-fbxd.depth/2                 
          ...
          {         
                ...
                ///@{           
                      ...
                      {  AgShape shape = AgShape("Bbox");              
                            ...
                            shape.par("dy")=fmxg.g10height/2;              
                            shape.par("dz")=ztotsmd;              
                            /// Shape Bbox dx=fmxg.g10width/2 dy=fmxg.g10height/2 dz=ztotsmd               
                            _same_shape &= _stacker->SearchVolume( shape, _attribute );              
                            _shape = shape;              
          ...
          {         
                ...
                ///@{           
                      ...
                      {  AgShape shape = AgShape("Bbox");              
                            ...
                            /// Shape Bbox dx=fmxg.g10width/2 dy=fmxg.g10height/2 dz=fmxg.g10thick/2               
                            _same_shape &= _stacker->SearchVolume( shape, _attribute );              
                            _shape = shape;              
          ...
          {         
                ...
                ///@{           
                      ...
                      {  AgShape shape = AgShape("Trd1");              
                            ...
                            /// Shape Trd1 dx1=0 dx2=fmxg.sbase/2 dy=fmxg.g10height/2 dz=fmxg.sapex/2               
                            _same_shape &= _stacker->SearchVolume( shape, _attribute );              
                            _shape = shape;              
    ...
    // ----------------------------------------------------------------------- geoctr
       void FpdmGeo1::ConstructGeometry( const Char_t *dummy )     
       {        
             ///@addtogroup FpdmGeo1_revision        
             ///@{           
                   /// Created:    12 Nov 2003            
             ///@}        
             ///@addtogroup FpdmGeo1_revision        
             ...
             ///@{           
                   ++fmcg._index;           
                   fmcg . version = 6.0; //  Geometry version             
                   /// fmcg . version = 6.0; //  Geometry version             
             ...
             ///@{           
                   ...
                   /// fpos . imod = 1; //  Module# (EN=1, ES=2, ET=3, EB=4, WN=5...)            
                   fpos . itype = 1; //  Type (1=7*7+SMD+PreShower, 2=5*5)            
                   /// fpos . itype = 1; //  Type (1=7*7+SMD+PreShower, 2=5*5)            
                   fpos . x = -28.1; //  X distance from beam to edge of detector            
                   /// fpos . x = -28.1; //  X distance from beam to edge of detector            
                   fpos . y = 0.0; //  Y distance from beam to edge of detector            
                   /// fpos . y = 0.0; //  Y distance from beam to edge of detector            
                   fpos . z = -751.8; //  Z distance from IP to surface of detector            
                   /// fpos . z = -751.8; //  Z distance from IP to surface of detector            
             ...
             ///@{           
                   ...
                   fpos . y = 0.0; //  Y distance from beam to edge of detector            
                   /// fpos . y = 0.0; //  Y distance from beam to edge of detector            
                   fpos . z = -752.4; //  Z distance from IP to surface of detector            
                   /// fpos . z = -752.4; //  Z distance from IP to surface of detector            
                   fpos . ay = 180; //  Angle aroound Y (0 for west, 180 for east)            
                   /// fpos . ay = 180; //  Angle aroound Y (0 for west, 180 for east)            
                   //           
             ...
             ///@{           
                   ...
                   /// fpos . imod = 3; //  Module# (EN=1, ES=2, ET=3, EB=4, WN=5...)            
                   fpos . itype = 2; //  Type (1=7*7+SMD+PreShower, 2=5*5)            
                   /// fpos . itype = 2; //  Type (1=7*7+SMD+PreShower, 2=5*5)            
             ...
             ///@{           
                   ++fbxd._index;           
                   fbxd . type = 1; //  Type (1=7*7+SMD+PreShower, 2=5*5)            
                   /// fbxd . type = 1; //  Type (1=7*7+SMD+PreShower, 2=5*5)            
                   ...
                   /// fbxd . psoffset = 2.0; //  PreShower z offset from box edge to PbG edge            
                   fbxd . smdoffset = 8.0; //  SMD V-plane z offset from box edge            
                   /// fbxd . smdoffset = 8.0; //  SMD V-plane z offset from box edge            
                   //           
                   fbxd.fill();           
             ///@}        
             ...
             ///@{           
                   ++fbxd._index;           
                   fbxd . type = 2; //  Type (1=7*7+SMD+PreShower, 2=5*5)            
                   /// fbxd . type = 2; //  Type (1=7*7+SMD+PreShower, 2=5*5)            
                   ...
                   /// fbxd . psoffset = 0; //  PreShower z offset from box edge to PbG edge            
                   fbxd . smdoffset = 0.0; //  SMD z offset from box edg            
                   /// fbxd . smdoffset = 0.0; //  SMD z offset from box edg            
                   //           
                   fbxd.fill();           
             ///@}        
             ...
             ///@{           
                   ...
                   /// fmxg . g10width = 27.0; //  G10 plate width            
                   fmxg . g10height = 27.0; //  G10 plate height            
                   /// fmxg . g10height = 27.0; //  G10 plate height            
