...
{ 
   ...
   ///@defgroup STLI_doc 
   ///@class STLI 
   ///@brief is the wafer pack container 
   class STLI : public AgBlock 
   {  public: 
      STLI() : AgBlock("STLI","is the wafer pack container"){ }; 
      ~STLI(){ }; 
      virtual void Block( AgCreate c ); 
      virtual void End(){ }; 
      ClassDef(STLI,1); 
   ...
   ///@defgroup SSID_doc 
   ///@class SSID 
   ///@brief is a non-sensitive left-right border of the wafer 
   class SSID : public AgBlock 
   {  public: 
      SSID() : AgBlock("SSID","is a non-sensitive left-right border of the wafer"){ }; 
      ~SSID(){ }; 
      virtual void Block( AgCreate c ); 
      virtual void End(){ }; 
      ClassDef(SSID,1); 
   ...
   ///@defgroup SSIR_doc 
   ///@class SSIR 
   ///@brief is a non-sensitive up-down border of the wafer 
   class SSIR : public AgBlock 
   {  public: 
      SSIR() : AgBlock("SSIR","is a non-sensitive up-down border of the wafer"){ }; 
      ~SSIR(){ }; 
      virtual void Block( AgCreate c ); 
      virtual void End(){ }; 
      ClassDef(SSIR,1); 
   ...
   ///@defgroup STRA_doc 
   ///@class STRA 
   ///@brief is a trapezoid of triangular shape 
   class STRA : public AgBlock 
   {  public: 
      STRA() : AgBlock("STRA","is a trapezoid of triangular shape"){ }; 
      ~STRA(){ }; 
      virtual void Block( AgCreate c ); 
      virtual void End(){ }; 
      ClassDef(STRA,1); 
   ...
   /// \class SvttGeo6 
   /// \brief   is the SVT: corrected wafers and sensitive volumes  
   class SvttGeo6 : public AgModule 
   { 
      public: 
      SvttGeo6(); 
