#ifndef __SvttGeo10__ 
#define __SvttGeo10__ 
...
{ 
   ...
   ///@defgroup SBER_doc 
   ///@class SBER 
   ///@brief are the Carbon wafer carrier rails 
   class SBER : public AgBlock 
   {  public: 
      SBER() : AgBlock("SBER","are the Carbon wafer carrier rails"){ }; 
      ~SBER(){ }; 
      virtual void Block( AgCreate c ); 
      virtual void End(){ }; 
      ClassDef(SBER,1); 
   ...
   ///@defgroup STAB_doc 
   ///@class STAB 
   ///@brief are the Carbon wafer carrier end tabs 
   class STAB : public AgBlock 
   {  public: 
      STAB() : AgBlock("STAB","are the Carbon wafer carrier end tabs"){ }; 
      ~STAB(){ }; 
      virtual void Block( AgCreate c ); 
      virtual void End(){ }; 
      ClassDef(STAB,1); 
   ...
   ///@defgroup STRU_doc 
   ///@class STRU 
   ///@brief are the Carbon struts between the wafer carrier rails 
   class STRU : public AgBlock 
   {  public: 
      STRU() : AgBlock("STRU","are the Carbon struts between the wafer carrier rails"){ }; 
      ~STRU(){ }; 
      virtual void Block( AgCreate c ); 
      virtual void End(){ }; 
      ClassDef(STRU,1); 
   ...
   /// \class SvttGeo10 
   /// \brief  is evolution of svttgeo6 with carbon replacing Be as per Dave Lynn:   
   class SvttGeo10 : public AgModule 
   { 
      public: 
      SvttGeo10(); 
      virtual void ConstructGeometry( const Char_t *dummy="" ); 
      ~SvttGeo10(){ }; 
      ClassDef(SvttGeo10,1); 
      public: 
   }; 
