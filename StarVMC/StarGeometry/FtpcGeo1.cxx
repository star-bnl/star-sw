#include "FtpcGeo1.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@}     
       FtpcGeo1::FtpcGeo1()     
         : AgModule("FtpcGeo1","  is the Forward TPC in STAR with corrected GAS ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
          ...
          {         
                ...
                ///@{           
                      ...
                      {  AgMaterial &mix = AgMaterial::Get("Ar_co2");              
                            mix.Component("Ar",40,18,.5);              
                            mix.Component("C",12,6,.5*12/44.);              
                            mix.Component("O",16,8,.5*32/44.);              
                            mix.par("dens")=0.001879;              
                            mix.lock();              
                            _material = mix;              
                            _material.lock();              
                      }           
    ...
    // ----------------------------------------------------------------------- geoctr
       ...
       {        
             ...
             ///@{           
                   ...
                   /// ftpg . version = 1; //  geometry Version            
                   ftpg . rinnerms = 7.40; //  innermost radius of envelope            
                   /// ftpg . rinnerms = 7.40; //  innermost radius of envelope            
                   ...
                   /// ftpg . hitlay = 10; //  # of padrows in one FTPC : 10            
                   ftpg . drinall1 = 0.01; //  thickness of inner Al-Layer of inner Tube            
                   /// ftpg . drinall1 = 0.01; //  thickness of inner Al-Layer of inner Tube            
                   ftpg . drinall2 = 0.01; //  thickness of outer Al-Layer of inner Tube            
                   /// ftpg . drinall2 = 0.01; //  thickness of outer Al-Layer of inner Tube            
                   ftpg . drinisol = 0.3; //  thickness of plastic insulation of inner tube            
                   /// ftpg . drinisol = 0.3; //  thickness of plastic insulation of inner tube            
