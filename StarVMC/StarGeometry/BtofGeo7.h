...
{ 
   ...
   { 
      ...
      { 
         ...
         posit2=0; 
         posit3=0; 
         posit4 = Array_t<Float_t>(5); 
         dphi1 = Array_t<Float_t>(5); 
         posit5 = Array_t<Float_t>(120); 
         _index=0; 
      } 
      ~ Btog_t(){ /* nada */ }; 
   }; 
   ...
   { 
      ...
      { 
         ...
         slatlen=0; 
         slat5z=0; 
         slatz = Array_t<Float_t>(10); 
         slatx = Array_t<Float_t>(10); 
         slatay = Array_t<Float_t>(10); 
         slatthck=0; 
         slatwid=0; 
         slatang=0; 
         pmtlen=0; 
   ...
   class Mod5_t : public AgStructure 
   { 
      ClassDef(Mod5_t,1); 
      public: 
      Float_t height; 
      ...
      Float_t ngap; 
      Float_t trayedgez; 
      Mod5_t() : AgStructure("Mod5_t","User-defined AgML structure") 
      { 
         height=0; 
         width=0; 
         length=0; 
   ...
   class Mod7_t : public AgStructure 
   { 
      ClassDef(Mod7_t,1); 
      public: 
      Float_t height; 
      ...
      Float_t ngap; 
      Float_t trayedgez; 
      Mod7_t() : AgStructure("Mod7_t","User-defined AgML structure") 
      { 
         height=0; 
         width=0; 
         length=0; 
   ...
   ///@defgroup BUPC_doc 
   ///@class BUPC 
   ///@brief is the upper cover of tofr 
   class BUPC : public AgBlock 
   {  public: 
      BUPC() : AgBlock("BUPC","is the upper cover of tofr"){ }; 
      ~BUPC(){ }; 
      virtual void Block( AgCreate c ); 
      virtual void End(){ }; 
      ClassDef(BUPC,1); 
   ...
   ///@defgroup BTFE_doc 
   ///@class BTFE 
   ///@brief is the TINO/TDIG boards 
   class BTFE : public AgBlock 
   {  public: 
      BTFE() : AgBlock("BTFE","is the TINO/TDIG boards"){ }; 
      ~BTFE(){ }; 
      virtual void Block( AgCreate c ); 
      virtual void End(){ }; 
      ClassDef(BTFE,1); 
   ...
   {  public: 
      BLEM() : AgBlock("BLEM","is a Lemo connector on the FEE boards"){ }; 
      ~BLEM(){ }; 
      virtual void Block( AgCreate c ); 
      virtual void End(){ }; 
      ClassDef(BLEM,1); 
