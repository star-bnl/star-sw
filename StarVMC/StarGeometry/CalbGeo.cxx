#include "CalbGeo.h"  
 ...
 {     
       ...
       // ---------------------------------------------------------------------------------------------------     
          ...
          ///@addtogroup CalbGeo_vars     
          ///@{        
                Float_t current_depth,current,tan_theta,smd_width,smd_width1,smd_width2,smd_width3,cut_length,cut_radius,future_depth,c_dep,c_lead_dep,eta_lenght,current_csda,h_eta1,h_eta2,h_phi1,h_phi2,sh_eta1,sh_eta2,sh_phi1,sh_phi2,rmax,hleng,deta,dphitot,dphimod,dphit,r1,r2,r3,r4;        
                //        
                /// Float_t current_depth,current,tan_theta,smd_width,smd_width1,smd_width2,smd_width3,cut_length,cut_radius,future_depth,c_dep,c_lead_dep,eta_lenght,current_csda,h_eta1,h_eta2,h_phi1,h_phi2,sh_eta1,sh_eta2,sh_phi1,sh_phi2,rmax,hleng,deta,dphitot,dphimod,dphit,r1,r2,r3,r4        
          ...
          ///@addtogroup CalbGeo_vars     
          ///@{        
                Int_t layer,super,sub,i,j,ii,nn;        
                //        
                /// Int_t layer,super,sub,i,j,ii,nn        
          ///@}     
       CalbGeo::CalbGeo()     
         : AgModule("CalbGeo"," is the geometry of the Barrel EM Calorimeter in (aG)STAR     * ")     
       {        
       }     
          // ---------------------------------------------------------------------------------------------------     
          ...
          {         
                ...
                ///@{           
                      ...
                      {  AgShape shape = AgShape("Division");              
                            shape     .Inherit( AgBlock::previous() );              
                            create     .SetParameters(shape);              
                            shape.par("ndiv")=calg.nmodule(ii);              
                            shape.par("iaxis")=2;              
                            /// Shape Division ndiv=calg.nmodule(ii) iaxis=2               
                            _same_shape &= _stacker->SearchVolume( shape, _attribute );              
                            _shape = shape;              
          ...
          {         
                ...
                ///@{           
                      ...
                      { AgMaterial &mat = AgMaterial::Get("Ealuminium");              
                            mat.par("isvol")=1;              
                            _material = mat;              
                      }           
