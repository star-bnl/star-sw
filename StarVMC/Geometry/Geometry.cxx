...
Bool_t Geometry::IstdInit() // Probably breaks config=-1 scheme
{
  ...
  istdGeom.select="ISTD02";  istdGeom.config=2;  istdGeom.module="IstdGeo1a";  istdGeom.fill(); 
  return true;
}
// ----------------------------------------------------------------------------
...
Bool_t Geometry::SisdInit()
{
  ...
  sisdGeom.select="SISD85"; sisdGeom.config=85; sisdGeom.module="SisdGeo7a"; sisdGeom.fill();
...
Bool_t Geometry::IdsmInit()
{
  ...
  idsmGeom.select="IDSM02"; idsmGeom.module="IdsmGeo2a"; idsmGeom.config=2; idsmGeom.fill();
  idsmGeom.select="IDSM14"; idsmGeom.module="IdsmGeo2a"; idsmGeom.config=14;idsmGeom.fill();
  return true;
}
// ----------------------------------------------------------------------
