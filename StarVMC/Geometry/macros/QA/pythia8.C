...
// ----------------------------------------------------------------------------
// ----------------------------------------------------------------------------
void Pythia8( TString config="pp:minbias" )
{
...
// ----------------------------------------------------------------------------
// ----------------------------------------------------------------------------
void pythia8( Int_t nevents=100, Int_t rngSeed=1234 )
{ 

  gROOT->ProcessLine(".L bfc.C");
  {
    TString simple = "fwdref0 geant gstar usexgeom agml ";
    bfc(0, simple );
  }
...
//   }
  ...
  _primary->SetSigma( 0.1, 0.1, 15.0 );
