...
echo " Size and date of file st_physics_16148020_raw_4000024.hist.root:  $histsize,  $histdate "
 ...
 if(  $histsize > 100000 && $histdate == $today ) then
 ...
 root4star -b -q bfcread_hist_to_ps.C\(\"st_physics_16148020_raw_4000024.hist.root\",\"EventQA\",\"bfcTree\",\"QA_hist_pAu200.2015.pdf\",\"QA\ plots\ for\ pAu\ 200GeV\ run\ 2015\ for\ ${today}\",\"/star/u/starreco/devtest/devQAhists.lis\",2,3\)
 ...
 echo "Size of hist file less then 100000 or file is old "
 endif
 else
...
root4star -b -q bfcread_hist_to_ps.C\(\"st_physics_16060046_raw_5000015.hist.root\",\"EventQA\",\"bfcTree\",\"QA_hist_pp200.2015.pdf\",\"QA\ plots\ for\ pp\ 200GeV\ run\ 2015\ for\ ${today}\",\"/star/u/starreco/devtest/devQAhists.lis\",2,3\)
...
root4star -b -q bfcread_hist_to_ps.C\(\"st_physics_15164004_raw_2000022.hist.root\",\"EventQA\",\"bfcTree\",\"QA_hist_AuAu200.2014.pdf\",\"QA\ plots\ for\ AuAu\ 200GeV\ run\ 2014\ for\ ${today}\",\"/star/u/starreco/devtest/devQAhists.lis\",2,3\)
